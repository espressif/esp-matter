...
function(get_supported_cluster_dirs source_dirs)
	...
	if(CONFIG_SUPPORT_GROUPCAST_CLUSTER)
		list(APPEND temp_list "${MATTER_SDK_PATH}/src/app/clusters/groupcast")
	endif()
	if(CONFIG_SUPPORT_HUMIDISTAT_CLUSTER)
		list(APPEND temp_list "${MATTER_SDK_PATH}/src/app/clusters/humidistat-server")
	endif()
	if(CONFIG_SUPPORT_MEDIA_FILE_MANAGEMENT_CLUSTER)
		list(APPEND temp_list "${MATTER_SDK_PATH}/src/app/clusters/media-file-management-server")
	endif()
	...
	if(CONFIG_SUPPORT_FLOW_MEASUREMENT_CLUSTER)
		list(APPEND temp_list "${MATTER_SDK_PATH}/src/app/clusters/flow-measurement-server")
	endif()
	...
	if(CONFIG_SUPPORT_ILLUMINANCE_MEASUREMENT_CLUSTER)
		list(APPEND temp_list "${MATTER_SDK_PATH}/src/app/clusters/illuminance-measurement-server")
	endif()
	...
	if(CONFIG_SUPPORT_NETWORK_IDENTITY_MANAGEMENT_CLUSTER)
		list(APPEND temp_list "${MATTER_SDK_PATH}/src/app/clusters/network-identity-management-server")
	endif()
	if(CONFIG_SUPPORT_NITROGEN_DIOXIDE_CONCENTRATION_MEASUREMENT_CLUSTER)
		list(APPEND temp_list "${MATTER_SDK_PATH}/src/app/clusters/concentration-measurement-server")
	endif()
	if(CONFIG_SUPPORT_PROXIMITY_RANGING_CLUSTER)
		list(APPEND temp_list "${MATTER_SDK_PATH}/src/app/clusters/proximity-ranging-server")
	endif()
	...
	if(CONFIG_SUPPORT_PRESSURE_MEASUREMENT_CLUSTER)
		list(APPEND temp_list "${MATTER_SDK_PATH}/src/app/clusters/pressure-measurement-server")
	endif()
	...
	if(CONFIG_SUPPORT_RELATIVE_HUMIDITY_MEASUREMENT_CLUSTER)
		list(APPEND temp_list "${MATTER_SDK_PATH}/src/app/clusters/relative-humidity-measurement-server")
	endif()
	...
	if(CONFIG_SUPPORT_TEMPERATURE_MEASUREMENT_CLUSTER)
		list(APPEND temp_list "${MATTER_SDK_PATH}/src/app/clusters/temperature-measurement-server")
	endif()
...
function(get_supported_esp_matter_cluster_dirs source_dirs)
	set(temp_list )
	if(CONFIG_SUPPORT_ACCESS_CONTROL_CLUSTER)
		list(APPEND temp_list "data_model_provider/clusters/access_control")
	endif()
	if(CONFIG_SUPPORT_ADMINISTRATOR_COMMISSIONING_CLUSTER)
		list(APPEND temp_list "data_model_provider/clusters/administrator_commissioning")
	endif()
	if(CONFIG_SUPPORT_AIR_QUALITY_CLUSTER)
		list(APPEND temp_list "data_model_provider/clusters/air_quality")
	endif()
	if(CONFIG_SUPPORT_BASIC_INFORMATION_CLUSTER)
		list(APPEND temp_list "data_model_provider/clusters/basic_information")
	endif()
	if(CONFIG_SUPPORT_BINDING_CLUSTER)
		list(APPEND temp_list "data_model_provider/clusters/binding")
	endif()
	if(CONFIG_SUPPORT_BOOLEAN_STATE_CLUSTER)
		list(APPEND temp_list "data_model_provider/clusters/boolean_state")
	endif()
	if(CONFIG_SUPPORT_BOOLEAN_STATE_CONFIGURATION_CLUSTER)
		list(APPEND temp_list "data_model_provider/clusters/boolean_state_configuration")
	endif()
	if(CONFIG_SUPPORT_BRIDGED_DEVICE_BASIC_INFORMATION_CLUSTER)
		list(APPEND temp_list "data_model_provider/clusters/bridged_device_basic_information")
	endif()
	if(CONFIG_SUPPORT_CAMERA_AV_STREAM_MANAGEMENT_CLUSTER)
		list(APPEND temp_list "data_model_provider/clusters/camera_av_stream_management")
	endif()
	if(CONFIG_SUPPORT_CHIME_CLUSTER)
		list(APPEND temp_list "data_model_provider/clusters/chime")
	endif()
	if(CONFIG_SUPPORT_CLOSURE_CONTROL_CLUSTER)
		list(APPEND temp_list "data_model_provider/clusters/closure_control")
	endif()
	if(CONFIG_SUPPORT_CLOSURE_DIMENSION_CLUSTER)
		list(APPEND temp_list "data_model_provider/clusters/closure_dimension")
	endif()
	if(CONFIG_SUPPORT_COMMISSIONER_CONTROL_CLUSTER)
		list(APPEND temp_list "data_model_provider/clusters/commissioner_control")
	endif()
	if(CONFIG_SUPPORT_DESCRIPTOR_CLUSTER)
		list(APPEND temp_list "data_model_provider/clusters/descriptor")
	endif()
	if(CONFIG_SUPPORT_DEVICE_ENERGY_MANAGEMENT_CLUSTER)
		list(APPEND temp_list "data_model_provider/clusters/device_energy_management")
	endif()
	if(CONFIG_SUPPORT_DIAGNOSTIC_LOGS_CLUSTER)
		list(APPEND temp_list "data_model_provider/clusters/diagnostic_logs")
	endif()
	if(CONFIG_SUPPORT_ELECTRICAL_ENERGY_MEASUREMENT_CLUSTER)
		list(APPEND temp_list "data_model_provider/clusters/electrical_energy_measurement")
	endif()
	if(CONFIG_SUPPORT_ELECTRICAL_POWER_MEASUREMENT_CLUSTER)
		list(APPEND temp_list "data_model_provider/clusters/electrical_power_measurement")
	endif()
	if(CONFIG_SUPPORT_ENERGY_EVSE_CLUSTER)
		list(APPEND temp_list "data_model_provider/clusters/energy_evse")
	endif()
	if(CONFIG_SUPPORT_ETHERNET_NETWORK_DIAGNOSTICS_CLUSTER)
		list(APPEND temp_list "data_model_provider/clusters/ethernet_network_diagnostics")
	endif()
	if(CONFIG_SUPPORT_FAN_CONTROL_CLUSTER)
		list(APPEND temp_list "data_model_provider/clusters/fan_control")
	endif()
	if(CONFIG_SUPPORT_FIXED_LABEL_CLUSTER)
		list(APPEND temp_list "data_model_provider/clusters/fixed_label")
	endif()
	if(CONFIG_SUPPORT_FLOW_MEASUREMENT_CLUSTER)
		list(APPEND temp_list "data_model_provider/clusters/flow_measurement")
	endif()
	if(CONFIG_SUPPORT_GENERAL_COMMISSIONING_CLUSTER)
		list(APPEND temp_list "data_model_provider/clusters/general_commissioning")
	endif()
	if(CONFIG_SUPPORT_GENERAL_DIAGNOSTICS_CLUSTER)
		list(APPEND temp_list "data_model_provider/clusters/general_diagnostics")
	endif()
	if(CONFIG_SUPPORT_GROUP_KEY_MANAGEMENT_CLUSTER)
		list(APPEND temp_list "data_model_provider/clusters/group_key_management")
	endif()
	if(CONFIG_SUPPORT_GROUPCAST_CLUSTER)
		list(APPEND temp_list "data_model_provider/clusters/groupcast")
	endif()
	if(CONFIG_SUPPORT_GROUPS_CLUSTER)
		list(APPEND temp_list "data_model_provider/clusters/groups")
	endif()
	if(CONFIG_SUPPORT_HUMIDISTAT_CLUSTER)
		list(APPEND temp_list "data_model_provider/clusters/humidistat")
	endif()
	if(CONFIG_SUPPORT_ICD_MANAGEMENT_CLUSTER)
		list(APPEND temp_list "data_model_provider/clusters/icd_management")
	endif()
	if(CONFIG_SUPPORT_IDENTIFY_CLUSTER)
		list(APPEND temp_list "data_model_provider/clusters/identify")
	endif()
	if(CONFIG_SUPPORT_ILLUMINANCE_MEASUREMENT_CLUSTER)
		list(APPEND temp_list "data_model_provider/clusters/illuminance_measurement")
	endif()
	if(CONFIG_SUPPORT_LAUNDRY_WASHER_CONTROLS_CLUSTER)
		list(APPEND temp_list "data_model_provider/clusters/laundry_washer_controls")
	endif()
	if(CONFIG_SUPPORT_LOCALIZATION_CONFIGURATION_CLUSTER)
		list(APPEND temp_list "data_model_provider/clusters/localization_configuration")
	endif()
	if(CONFIG_SUPPORT_MICROWAVE_OVEN_CONTROL_CLUSTER)
	...
	if(CONFIG_SUPPORT_NETWORK_IDENTITY_MANAGEMENT_CLUSTER)
		list(APPEND temp_list "data_model_provider/clusters/network_identity_management")
	endif()
	if(CONFIG_SUPPORT_OCCUPANCY_SENSING_CLUSTER)
		list(APPEND temp_list "data_model_provider/clusters/occupancy_sensing")
	endif()
	if(CONFIG_SUPPORT_OPERATIONAL_CREDENTIALS_CLUSTER)
	...
	if(CONFIG_SUPPORT_OTA_SOFTWARE_UPDATE_REQUESTOR_CLUSTER)
		list(APPEND temp_list "data_model_provider/clusters/ota_software_update_requestor")
	endif()
	if(CONFIG_SUPPORT_POWER_SOURCE_CLUSTER)
		list(APPEND temp_list "data_model_provider/clusters/power_source")
	endif()
	if(CONFIG_SUPPORT_POWER_TOPOLOGY_CLUSTER)
		list(APPEND temp_list "data_model_provider/clusters/power_topology")
	endif()
	if(CONFIG_SUPPORT_PRESSURE_MEASUREMENT_CLUSTER)
		list(APPEND temp_list "data_model_provider/clusters/pressure_measurement")
	endif()
	if(CONFIG_SUPPORT_PUSH_AV_STREAM_TRANSPORT_CLUSTER)
		list(APPEND temp_list "data_model_provider/clusters/push_av_stream_transport")
	endif()
	if(CONFIG_SUPPORT_RELATIVE_HUMIDITY_MEASUREMENT_CLUSTER)
	...
	if(CONFIG_SUPPORT_SCENES_CLUSTER)
		list(APPEND temp_list "data_model_provider/clusters/scenes_management")
	endif()
	if(CONFIG_SUPPORT_SMOKE_CO_ALARM_CLUSTER)
		list(APPEND temp_list "data_model_provider/clusters/smoke_co_alarm")
	endif()
	if(CONFIG_SUPPORT_SOFTWARE_DIAGNOSTICS_CLUSTER)
		list(APPEND temp_list "data_model_provider/clusters/software_diagnostics")
	endif()
	if(CONFIG_SUPPORT_SOIL_MEASUREMENT_CLUSTER)
		list(APPEND temp_list "data_model_provider/clusters/soil_measurement")
	endif()
	if(CONFIG_SUPPORT_SWITCH_CLUSTER)
		list(APPEND temp_list "data_model_provider/clusters/switch_cluster")
	endif()
	if(CONFIG_SUPPORT_TEMPERATURE_CONTROL_CLUSTER)
		list(APPEND temp_list "data_model_provider/clusters/temperature_control")
	endif()
	if(CONFIG_SUPPORT_TEMPERATURE_MEASUREMENT_CLUSTER)
		list(APPEND temp_list "data_model_provider/clusters/temperature_measurement")
	endif()
	if(CONFIG_SUPPORT_THREAD_BORDER_ROUTER_MANAGEMENT_CLUSTER)
		list(APPEND temp_list "data_model_provider/clusters/thread_border_router_management")
	endif()
	if(CONFIG_SUPPORT_THREAD_NETWORK_DIAGNOSTICS_CLUSTER)
		list(APPEND temp_list "data_model_provider/clusters/thread_network_diagnostics")
	endif()
	if(CONFIG_SUPPORT_THREAD_NETWORK_DIRECTORY_CLUSTER)
		list(APPEND temp_list "data_model_provider/clusters/thread_network_directory")
	endif()
	if(CONFIG_SUPPORT_TIME_FORMAT_LOCALIZATION_CLUSTER)
		list(APPEND temp_list "data_model_provider/clusters/time_format_localization")
	endif()
	if(CONFIG_SUPPORT_TIME_SYNCHRONIZATION_CLUSTER)
		list(APPEND temp_list "data_model_provider/clusters/time_synchronization")
	endif()
	if(CONFIG_SUPPORT_TLS_CERTIFICATE_MANAGEMENT_CLUSTER)
		list(APPEND temp_list "data_model_provider/clusters/tls_certificate_management")
	endif()
	if(CONFIG_SUPPORT_TLS_CLIENT_MANAGEMENT_CLUSTER)
		list(APPEND temp_list "data_model_provider/clusters/tls_client_management")
	endif()
	if(CONFIG_SUPPORT_UNIT_LOCALIZATION_CLUSTER)
		list(APPEND temp_list "data_model_provider/clusters/unit_localization")
	endif()
	if(CONFIG_SUPPORT_USER_LABEL_CLUSTER)
		list(APPEND temp_list "data_model_provider/clusters/user_label")
	endif()
	if(CONFIG_SUPPORT_VALVE_CONFIGURATION_AND_CONTROL_CLUSTER)
		list(APPEND temp_list "data_model_provider/clusters/valve_configuration_and_control")
	endif()
	if(CONFIG_SUPPORT_WATER_HEATER_MANAGEMENT_CLUSTER)
		list(APPEND temp_list "data_model_provider/clusters/water_heater_management")
	endif()
	if(CONFIG_SUPPORT_WEB_RTC_TRANSPORT_PROVIDER_CLUSTER)
		list(APPEND temp_list "data_model_provider/clusters/webrtc_transport_provider")
	endif()
	if(CONFIG_SUPPORT_WEB_RTC_TRANSPORT_REQUESTOR_CLUSTER)
		list(APPEND temp_list "data_model_provider/clusters/webrtc_transport_requestor")
	endif()
	if(CONFIG_SUPPORT_WIFI_NETWORK_DIAGNOSTICS_CLUSTER)
		list(APPEND temp_list "data_model_provider/clusters/wifi_network_diagnostic")
	endif()
	if(CONFIG_SUPPORT_ZONE_MANAGEMENT_CLUSTER)
		list(APPEND temp_list "data_model_provider/clusters/zone_management")
	endif()
	set(${source_dirs} ${temp_list} PARENT_SCOPE)
endfunction()
