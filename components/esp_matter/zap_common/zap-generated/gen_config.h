...
#define MATTER_DM_ACTIONS_CLUSTER_SERVER_ENDPOINT_COUNT FIXED_ENDPOINT_COUNT           // used in actions
...
#define MATTER_DM_MEDIA_FILE_MANAGEMENT_CLUSTER_SERVER_ENDPOINT_COUNT FIXED_ENDPOINT_COUNT // used in media file management
