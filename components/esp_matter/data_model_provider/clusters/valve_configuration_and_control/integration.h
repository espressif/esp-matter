...
/// Registers the application delegate for the given endpoint (nullptr to unbind)
void SetDefaultDelegate(EndpointId endpointId, Delegate * delegate);

/// Convenience helpers mirroring the upstream CodegenIntegration API
...
/// Updates AutoCloseTime on every registered valve cluster instance
