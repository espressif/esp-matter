...
{
    return esp_matter::attribute::create(cluster, Breadcrumb::Id, ATTRIBUTE_FLAG_WRITABLE, esp_matter_attr_val(value));
}
...
attribute_t *create_regulatory_config(cluster_t *cluster, uint8_t value)
{
    ...
    esp_matter::attribute::add_bounds(attribute, esp_matter_attr_val(static_cast<uint8_t>(RegulatoryConfig::Min), esp_matter_attr_val::uint_sub_type::k_enum), esp_matter_attr_val(static_cast<uint8_t>(RegulatoryConfig::Max), esp_matter_attr_val::uint_sub_type::k_enum));
    return attribute;
}
...
attribute_t *create_location_capability(cluster_t *cluster, uint8_t value)
{
    ...
    esp_matter::attribute::add_bounds(attribute, esp_matter_attr_val(static_cast<uint8_t>(LocationCapability::Min), esp_matter_attr_val::uint_sub_type::k_enum), esp_matter_attr_val(static_cast<uint8_t>(LocationCapability::Max), esp_matter_attr_val::uint_sub_type::k_enum));
    return attribute;
}
...
attribute_t *create_tc_accepted_version(cluster_t *cluster, uint16_t value)
{
    ...
    return esp_matter::attribute::create(cluster, TCAcceptedVersion::Id, ATTRIBUTE_FLAG_NONVOLATILE, esp_matter_attr_val(value));
}
...
attribute_t *create_tc_min_required_version(cluster_t *cluster, uint16_t value)
{
    uint32_t feature_map = get_feature_map_value(cluster);
    VerifyOrReturnValue(has_feature(terms_and_conditions), NULL);
    return esp_matter::attribute::create(cluster, TCMinRequiredVersion::Id, ATTRIBUTE_FLAG_NONVOLATILE, esp_matter_attr_val(value));
}
