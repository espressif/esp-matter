...
#include <dish_washer_mode_ids.h>
#include <binding.h>
...
{
    cluster_t *cluster = esp_matter::cluster::create(endpoint, dish_washer_mode::Id, flags);
    VerifyOrReturnValue(cluster, NULL, ESP_LOGE(TAG, "Could not create cluster. cluster_id: 0x%08" PRIX32, dish_washer_mode::Id));
    if (flags & CLUSTER_FLAG_SERVER) {
        ...
        static const auto plugin_server_init_cb = CALL_ONCE(MatterDishwasherModePluginServerInitCallback);
