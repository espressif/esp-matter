...
{
    cluster_t *cluster = esp_matter::cluster::create(endpoint, temperature_measurement::Id, flags);
    VerifyOrReturnValue(cluster, NULL, ESP_LOGE(TAG, "Could not create cluster. cluster_id: 0x%08" PRIX32, temperature_measurement::Id));
