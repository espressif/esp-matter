...
{
    cluster_t *cluster = esp_matter::cluster::create(endpoint, rvc_run_mode::Id, flags);
    VerifyOrReturnValue(cluster, NULL, ESP_LOGE(TAG, "Could not create cluster. cluster_id: 0x%08" PRIX32, rvc_run_mode::Id));
    if (flags & CLUSTER_FLAG_SERVER) {
        ...
        static const auto plugin_server_init_cb = CALL_ONCE(MatterRvcRunModePluginServerInitCallback);
        ...
        cluster::set_init_and_shutdown_callbacks(cluster, ESPMatterRvcRunModeClusterServerInitCallback,
                                                 ESPMatterRvcRunModeClusterServerShutdownCallback);
    }
