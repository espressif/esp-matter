...
{
    VerifyOrReturnValue(length <= k_max_active_locale_length + 1, NULL, ESP_LOGE(TAG, "Could not create attribute, string length out of bound. cluster_id: 0x%08" PRIX32, localization_configuration::Id));
