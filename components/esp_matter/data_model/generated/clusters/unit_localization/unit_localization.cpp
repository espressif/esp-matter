...
attribute_t *create_temperature_unit(cluster_t *cluster, uint8_t value)
{
    ...
    esp_matter::attribute::add_bounds(attribute, esp_matter_attr_val(static_cast<uint8_t>(TemperatureUnit::Min), esp_matter_attr_val::uint_sub_type::k_enum), esp_matter_attr_val(static_cast<uint8_t>(TemperatureUnit::Max), esp_matter_attr_val::uint_sub_type::k_enum));
    return attribute;
}
