...
static const char *TAG = "fixed_label_cluster";
...
{
    return esp_matter::attribute::create(cluster, LabelList::Id, ATTRIBUTE_FLAG_MANAGED_INTERNALLY | ATTRIBUTE_FLAG_NONVOLATILE, esp_matter_attr_val(value, length, count));
}
...
{
    cluster_t *cluster = esp_matter::cluster::create(endpoint, fixed_label::Id, flags);
    VerifyOrReturnValue(cluster, NULL, ESP_LOGE(TAG, "Could not create cluster. cluster_id: 0x%08" PRIX32, fixed_label::Id));
