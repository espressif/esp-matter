...
attribute_t *create_light_sensor_type(cluster_t *cluster, nullable<uint8_t> value)
{
    ...
    esp_matter::attribute::add_bounds(attribute, esp_matter_attr_val(nullable<uint8_t>(LightSensorType::Min), esp_matter_attr_val::uint_sub_type::k_enum), esp_matter_attr_val(nullable<uint8_t>(LightSensorType::Max), esp_matter_attr_val::uint_sub_type::k_enum));
    return attribute;
}
