...
{
    return esp_matter::attribute::create(cluster, CurrentLevel::Id, ATTRIBUTE_FLAG_NULLABLE | ATTRIBUTE_FLAG_NONVOLATILE, esp_matter_attr_val(value));
}
...
attribute_t *create_remaining_time(cluster_t *cluster, uint16_t value)
{
    ...
    return esp_matter::attribute::create(cluster, RemainingTime::Id, ATTRIBUTE_FLAG_NONE, esp_matter_attr_val(value));
}
...
attribute_t *create_min_level(cluster_t *cluster, uint8_t value)
{
    ...
    esp_matter::attribute::add_bounds(attribute, esp_matter_attr_val(static_cast<uint8_t>(MinLevel::Min)), esp_matter_attr_val(static_cast<uint8_t>(MinLevel::Max)));
    return attribute;
}
...
attribute_t *create_max_level(cluster_t *cluster, uint8_t value)
{
    ...
    esp_matter::attribute::add_bounds(attribute, esp_matter_attr_val(static_cast<uint8_t>(MaxLevel::Min)), esp_matter_attr_val(static_cast<uint8_t>(MaxLevel::Max)));
    return attribute;
}
...
{
    return esp_matter::attribute::create(cluster, OnOffTransitionTime::Id, ATTRIBUTE_FLAG_WRITABLE, esp_matter_attr_val(value));
}

attribute_t *create_on_level(cluster_t *cluster, nullable<uint8_t> value)
{
    return esp_matter::attribute::create(cluster, OnLevel::Id, ATTRIBUTE_FLAG_WRITABLE | ATTRIBUTE_FLAG_NULLABLE, esp_matter_attr_val(value));
}

attribute_t *create_on_transition_time(cluster_t *cluster, nullable<uint16_t> value)
{
    return esp_matter::attribute::create(cluster, OnTransitionTime::Id, ATTRIBUTE_FLAG_WRITABLE | ATTRIBUTE_FLAG_NULLABLE, esp_matter_attr_val(value));
}

attribute_t *create_off_transition_time(cluster_t *cluster, nullable<uint16_t> value)
{
    return esp_matter::attribute::create(cluster, OffTransitionTime::Id, ATTRIBUTE_FLAG_WRITABLE | ATTRIBUTE_FLAG_NULLABLE, esp_matter_attr_val(value));
}
...
attribute_t *create_default_move_rate(cluster_t *cluster, nullable<uint8_t> value)
{
    ...
    esp_matter::attribute::add_bounds(attribute, esp_matter_attr_val(nullable<uint8_t>(DefaultMoveRate::Min)), esp_matter_attr_val(nullable<uint8_t>(DefaultMoveRate::Max)));
    return attribute;
}
...
attribute_t *create_start_up_current_level(cluster_t *cluster, nullable<uint8_t> value)
{
    uint32_t feature_map = get_feature_map_value(cluster);
    VerifyOrReturnValue(has_feature(lighting), NULL);
    return esp_matter::attribute::create(cluster, StartUpCurrentLevel::Id, ATTRIBUTE_FLAG_WRITABLE | ATTRIBUTE_FLAG_NULLABLE | ATTRIBUTE_FLAG_NONVOLATILE, esp_matter_attr_val(value));
}
