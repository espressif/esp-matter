...
{
    return esp_matter::attribute::create(cluster, Channel::Id, ATTRIBUTE_FLAG_NULLABLE, esp_matter_attr_val(value));
}
...
attribute_t *create_routing_role(cluster_t *cluster, nullable<uint8_t> value)
{
    ...
    esp_matter::attribute::add_bounds(attribute, esp_matter_attr_val(nullable<uint8_t>(RoutingRole::Min), esp_matter_attr_val::uint_sub_type::k_enum), esp_matter_attr_val(nullable<uint8_t>(RoutingRole::Max), esp_matter_attr_val::uint_sub_type::k_enum));
    return attribute;
}
...
{
    return esp_matter::attribute::create(cluster, PanId::Id, ATTRIBUTE_FLAG_NULLABLE, esp_matter_attr_val(value));
}

attribute_t *create_extended_pan_id(cluster_t *cluster, nullable<uint64_t> value)
{
    return esp_matter::attribute::create(cluster, ExtendedPanId::Id, ATTRIBUTE_FLAG_NULLABLE, esp_matter_attr_val(value));
}
...
{
    return esp_matter::attribute::create(cluster, PartitionId::Id, ATTRIBUTE_FLAG_NULLABLE, esp_matter_attr_val(value));
}
...
attribute_t *create_weighting(cluster_t *cluster, nullable<uint16_t> value)
{
    ...
    esp_matter::attribute::add_bounds(attribute, esp_matter_attr_val(nullable<uint16_t>(Weighting::Min)), esp_matter_attr_val(nullable<uint16_t>(Weighting::Max)));
    return attribute;
}
...
attribute_t *create_data_version(cluster_t *cluster, nullable<uint16_t> value)
{
    ...
    esp_matter::attribute::add_bounds(attribute, esp_matter_attr_val(nullable<uint16_t>(DataVersion::Min)), esp_matter_attr_val(nullable<uint16_t>(DataVersion::Max)));
    return attribute;
}
...
attribute_t *create_stable_data_version(cluster_t *cluster, nullable<uint16_t> value)
{
    ...
    esp_matter::attribute::add_bounds(attribute, esp_matter_attr_val(nullable<uint16_t>(StableDataVersion::Min)), esp_matter_attr_val(nullable<uint16_t>(StableDataVersion::Max)));
    return attribute;
}
...
attribute_t *create_leader_router_id(cluster_t *cluster, nullable<uint8_t> value)
{
    ...
    esp_matter::attribute::add_bounds(attribute, esp_matter_attr_val(nullable<uint8_t>(LeaderRouterId::Min)), esp_matter_attr_val(nullable<uint8_t>(LeaderRouterId::Max)));
    return attribute;
}

attribute_t *create_detached_role_count(cluster_t *cluster, uint16_t value)
{
    return esp_matter::attribute::create(cluster, DetachedRoleCount::Id, ATTRIBUTE_FLAG_NONE, esp_matter_attr_val(value));
}

attribute_t *create_child_role_count(cluster_t *cluster, uint16_t value)
{
    return esp_matter::attribute::create(cluster, ChildRoleCount::Id, ATTRIBUTE_FLAG_NONE, esp_matter_attr_val(value));
}

attribute_t *create_router_role_count(cluster_t *cluster, uint16_t value)
{
    return esp_matter::attribute::create(cluster, RouterRoleCount::Id, ATTRIBUTE_FLAG_NONE, esp_matter_attr_val(value));
}

attribute_t *create_leader_role_count(cluster_t *cluster, uint16_t value)
{
    return esp_matter::attribute::create(cluster, LeaderRoleCount::Id, ATTRIBUTE_FLAG_NONE, esp_matter_attr_val(value));
}

attribute_t *create_attach_attempt_count(cluster_t *cluster, uint16_t value)
{
    return esp_matter::attribute::create(cluster, AttachAttemptCount::Id, ATTRIBUTE_FLAG_NONE, esp_matter_attr_val(value));
}

attribute_t *create_partition_id_change_count(cluster_t *cluster, uint16_t value)
{
    return esp_matter::attribute::create(cluster, PartitionIdChangeCount::Id, ATTRIBUTE_FLAG_NONE, esp_matter_attr_val(value));
}

attribute_t *create_better_partition_attach_attempt_count(cluster_t *cluster, uint16_t value)
{
    return esp_matter::attribute::create(cluster, BetterPartitionAttachAttemptCount::Id, ATTRIBUTE_FLAG_NONE, esp_matter_attr_val(value));
}

attribute_t *create_parent_change_count(cluster_t *cluster, uint16_t value)
{
    return esp_matter::attribute::create(cluster, ParentChangeCount::Id, ATTRIBUTE_FLAG_NONE, esp_matter_attr_val(value));
}

attribute_t *create_tx_total_count(cluster_t *cluster, uint32_t value)
{
    return esp_matter::attribute::create(cluster, TxTotalCount::Id, ATTRIBUTE_FLAG_NONE, esp_matter_attr_val(value));
}

attribute_t *create_tx_unicast_count(cluster_t *cluster, uint32_t value)
{
    return esp_matter::attribute::create(cluster, TxUnicastCount::Id, ATTRIBUTE_FLAG_NONE, esp_matter_attr_val(value));
}

attribute_t *create_tx_broadcast_count(cluster_t *cluster, uint32_t value)
{
    return esp_matter::attribute::create(cluster, TxBroadcastCount::Id, ATTRIBUTE_FLAG_NONE, esp_matter_attr_val(value));
}

attribute_t *create_tx_ack_requested_count(cluster_t *cluster, uint32_t value)
{
    return esp_matter::attribute::create(cluster, TxAckRequestedCount::Id, ATTRIBUTE_FLAG_NONE, esp_matter_attr_val(value));
}

attribute_t *create_tx_acked_count(cluster_t *cluster, uint32_t value)
{
    return esp_matter::attribute::create(cluster, TxAckedCount::Id, ATTRIBUTE_FLAG_NONE, esp_matter_attr_val(value));
}

attribute_t *create_tx_no_ack_requested_count(cluster_t *cluster, uint32_t value)
{
    return esp_matter::attribute::create(cluster, TxNoAckRequestedCount::Id, ATTRIBUTE_FLAG_NONE, esp_matter_attr_val(value));
}

attribute_t *create_tx_data_count(cluster_t *cluster, uint32_t value)
{
    return esp_matter::attribute::create(cluster, TxDataCount::Id, ATTRIBUTE_FLAG_NONE, esp_matter_attr_val(value));
}

attribute_t *create_tx_data_poll_count(cluster_t *cluster, uint32_t value)
{
    return esp_matter::attribute::create(cluster, TxDataPollCount::Id, ATTRIBUTE_FLAG_NONE, esp_matter_attr_val(value));
}

attribute_t *create_tx_beacon_count(cluster_t *cluster, uint32_t value)
{
    return esp_matter::attribute::create(cluster, TxBeaconCount::Id, ATTRIBUTE_FLAG_NONE, esp_matter_attr_val(value));
}

attribute_t *create_tx_beacon_request_count(cluster_t *cluster, uint32_t value)
{
    return esp_matter::attribute::create(cluster, TxBeaconRequestCount::Id, ATTRIBUTE_FLAG_NONE, esp_matter_attr_val(value));
}

attribute_t *create_tx_other_count(cluster_t *cluster, uint32_t value)
{
    return esp_matter::attribute::create(cluster, TxOtherCount::Id, ATTRIBUTE_FLAG_NONE, esp_matter_attr_val(value));
}

attribute_t *create_tx_retry_count(cluster_t *cluster, uint32_t value)
{
    return esp_matter::attribute::create(cluster, TxRetryCount::Id, ATTRIBUTE_FLAG_NONE, esp_matter_attr_val(value));
}

attribute_t *create_tx_direct_max_retry_expiry_count(cluster_t *cluster, uint32_t value)
{
    return esp_matter::attribute::create(cluster, TxDirectMaxRetryExpiryCount::Id, ATTRIBUTE_FLAG_NONE, esp_matter_attr_val(value));
}

attribute_t *create_tx_indirect_max_retry_expiry_count(cluster_t *cluster, uint32_t value)
{
    return esp_matter::attribute::create(cluster, TxIndirectMaxRetryExpiryCount::Id, ATTRIBUTE_FLAG_NONE, esp_matter_attr_val(value));
}

attribute_t *create_tx_err_cca_count(cluster_t *cluster, uint32_t value)
{
    return esp_matter::attribute::create(cluster, TxErrCcaCount::Id, ATTRIBUTE_FLAG_NONE, esp_matter_attr_val(value));
}

attribute_t *create_tx_err_abort_count(cluster_t *cluster, uint32_t value)
{
    return esp_matter::attribute::create(cluster, TxErrAbortCount::Id, ATTRIBUTE_FLAG_NONE, esp_matter_attr_val(value));
}

attribute_t *create_tx_err_busy_channel_count(cluster_t *cluster, uint32_t value)
{
    return esp_matter::attribute::create(cluster, TxErrBusyChannelCount::Id, ATTRIBUTE_FLAG_NONE, esp_matter_attr_val(value));
}

attribute_t *create_rx_total_count(cluster_t *cluster, uint32_t value)
{
    return esp_matter::attribute::create(cluster, RxTotalCount::Id, ATTRIBUTE_FLAG_NONE, esp_matter_attr_val(value));
}

attribute_t *create_rx_unicast_count(cluster_t *cluster, uint32_t value)
{
    return esp_matter::attribute::create(cluster, RxUnicastCount::Id, ATTRIBUTE_FLAG_NONE, esp_matter_attr_val(value));
}

attribute_t *create_rx_broadcast_count(cluster_t *cluster, uint32_t value)
{
    return esp_matter::attribute::create(cluster, RxBroadcastCount::Id, ATTRIBUTE_FLAG_NONE, esp_matter_attr_val(value));
}

attribute_t *create_rx_data_count(cluster_t *cluster, uint32_t value)
{
    return esp_matter::attribute::create(cluster, RxDataCount::Id, ATTRIBUTE_FLAG_NONE, esp_matter_attr_val(value));
}

attribute_t *create_rx_data_poll_count(cluster_t *cluster, uint32_t value)
{
    return esp_matter::attribute::create(cluster, RxDataPollCount::Id, ATTRIBUTE_FLAG_NONE, esp_matter_attr_val(value));
}

attribute_t *create_rx_beacon_count(cluster_t *cluster, uint32_t value)
{
    return esp_matter::attribute::create(cluster, RxBeaconCount::Id, ATTRIBUTE_FLAG_NONE, esp_matter_attr_val(value));
}

attribute_t *create_rx_beacon_request_count(cluster_t *cluster, uint32_t value)
{
    return esp_matter::attribute::create(cluster, RxBeaconRequestCount::Id, ATTRIBUTE_FLAG_NONE, esp_matter_attr_val(value));
}

attribute_t *create_rx_other_count(cluster_t *cluster, uint32_t value)
{
    return esp_matter::attribute::create(cluster, RxOtherCount::Id, ATTRIBUTE_FLAG_NONE, esp_matter_attr_val(value));
}

attribute_t *create_rx_address_filtered_count(cluster_t *cluster, uint32_t value)
{
    return esp_matter::attribute::create(cluster, RxAddressFilteredCount::Id, ATTRIBUTE_FLAG_NONE, esp_matter_attr_val(value));
}

attribute_t *create_rx_dest_addr_filtered_count(cluster_t *cluster, uint32_t value)
{
    return esp_matter::attribute::create(cluster, RxDestAddrFilteredCount::Id, ATTRIBUTE_FLAG_NONE, esp_matter_attr_val(value));
}

attribute_t *create_rx_duplicated_count(cluster_t *cluster, uint32_t value)
{
    return esp_matter::attribute::create(cluster, RxDuplicatedCount::Id, ATTRIBUTE_FLAG_NONE, esp_matter_attr_val(value));
}

attribute_t *create_rx_err_no_frame_count(cluster_t *cluster, uint32_t value)
{
    return esp_matter::attribute::create(cluster, RxErrNoFrameCount::Id, ATTRIBUTE_FLAG_NONE, esp_matter_attr_val(value));
}

attribute_t *create_rx_err_unknown_neighbor_count(cluster_t *cluster, uint32_t value)
{
    return esp_matter::attribute::create(cluster, RxErrUnknownNeighborCount::Id, ATTRIBUTE_FLAG_NONE, esp_matter_attr_val(value));
}

attribute_t *create_rx_err_invalid_src_addr_count(cluster_t *cluster, uint32_t value)
{
    return esp_matter::attribute::create(cluster, RxErrInvalidSrcAddrCount::Id, ATTRIBUTE_FLAG_NONE, esp_matter_attr_val(value));
}

attribute_t *create_rx_err_sec_count(cluster_t *cluster, uint32_t value)
{
    return esp_matter::attribute::create(cluster, RxErrSecCount::Id, ATTRIBUTE_FLAG_NONE, esp_matter_attr_val(value));
}

attribute_t *create_rx_err_fcs_count(cluster_t *cluster, uint32_t value)
{
    return esp_matter::attribute::create(cluster, RxErrFcsCount::Id, ATTRIBUTE_FLAG_NONE, esp_matter_attr_val(value));
}

attribute_t *create_rx_err_other_count(cluster_t *cluster, uint32_t value)
{
    return esp_matter::attribute::create(cluster, RxErrOtherCount::Id, ATTRIBUTE_FLAG_NONE, esp_matter_attr_val(value));
}

attribute_t *create_active_timestamp(cluster_t *cluster, nullable<uint64_t> value)
{
    return esp_matter::attribute::create(cluster, ActiveTimestamp::Id, ATTRIBUTE_FLAG_NULLABLE, esp_matter_attr_val(value));
}

attribute_t *create_pending_timestamp(cluster_t *cluster, nullable<uint64_t> value)
{
    return esp_matter::attribute::create(cluster, PendingTimestamp::Id, ATTRIBUTE_FLAG_NULLABLE, esp_matter_attr_val(value));
}

attribute_t *create_delay(cluster_t *cluster, nullable<uint32_t> value)
{
    return esp_matter::attribute::create(cluster, Delay::Id, ATTRIBUTE_FLAG_NULLABLE, esp_matter_attr_val(value));
}
