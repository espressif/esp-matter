...
#include <pm1_concentration_measurement_ids.h>
#include <binding.h>
...
{
    cluster_t *cluster = esp_matter::cluster::create(endpoint, pm1_concentration_measurement::Id, flags);
    VerifyOrReturnValue(cluster, NULL, ESP_LOGE(TAG, "Could not create cluster. cluster_id: 0x%08" PRIX32, pm1_concentration_measurement::Id));
