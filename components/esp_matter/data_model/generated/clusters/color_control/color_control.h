...
typedef struct config {
    ...
    config() : color_mode(1), options(0), number_of_primaries(), enhanced_color_mode(1), color_capabilities(0), primary_1_x(0), primary_1_y(0), primary_1_intensity(), primary_2_x(0), primary_2_y(0), primary_2_intensity(), primary_3_x(0), primary_3_y(0), primary_3_intensity(), primary_4_x(0), primary_4_y(0), primary_4_intensity(), primary_5_x(0), primary_5_y(0), primary_5_intensity(), primary_6_x(0), primary_6_y(0), primary_6_intensity() {}
} config_t;
