...
esp_err_t add(endpoint_t *endpoint, config_t *config)
{
    ...
    VerifyOrReturnValue(rvc_operational_state != NULL, ESP_FAIL, ESP_LOGE(TAG, "Failed to create cluster: rvc_operational_state. device_type_id: 0x%08" PRIX32, get_device_type_id()));
