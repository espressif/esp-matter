...
{
    return ESP_MATTER_CASTING_VIDEO_CLIENT_DEVICE_TYPE_ID;
}

uint8_t get_device_type_version()
{
    return ESP_MATTER_CASTING_VIDEO_CLIENT_DEVICE_TYPE_VERSION;
}
...
esp_err_t add(endpoint_t *endpoint, config_t *config)
{
    ...
    cluster::keypad_input::create(endpoint, NULL, CLUSTER_FLAG_CLIENT);
    cluster::content_launcher::create(endpoint, NULL, CLUSTER_FLAG_CLIENT);
    cluster::application_basic::create(endpoint, NULL, CLUSTER_FLAG_CLIENT);
    return ESP_OK;
}
