...
esp_err_t add(endpoint_t *endpoint, config_t *config)
{
    ...
    cluster::identify::create(endpoint, NULL, CLUSTER_FLAG_CLIENT);
    cluster::on_off::create(endpoint, NULL, CLUSTER_FLAG_CLIENT);
    cluster::level_control::create(endpoint, NULL, CLUSTER_FLAG_CLIENT);
    cluster::color_control::create(endpoint, NULL, CLUSTER_FLAG_CLIENT);
    return ESP_OK;
}
