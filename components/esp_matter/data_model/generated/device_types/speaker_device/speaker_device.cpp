...
{
    return ESP_MATTER_SPEAKER_DEVICE_TYPE_ID;
}

uint8_t get_device_type_version()
{
    return ESP_MATTER_SPEAKER_DEVICE_TYPE_VERSION;
}
...
esp_err_t add(endpoint_t *endpoint, config_t *config)
{
    ...
    cluster::level_control::create(endpoint, &(config->level_control), CLUSTER_FLAG_SERVER);
    return ESP_OK;
}
