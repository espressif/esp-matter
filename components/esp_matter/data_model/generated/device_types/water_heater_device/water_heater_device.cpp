...
esp_err_t add(endpoint_t *endpoint, config_t *config)
{
    ...
    cluster::water_heater_management::create(endpoint, &(config->water_heater_management), CLUSTER_FLAG_SERVER);
    cluster::water_heater_mode::create(endpoint, &(config->water_heater_mode), CLUSTER_FLAG_SERVER);
