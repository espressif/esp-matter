...
esp_err_t add(endpoint_t *endpoint, config_t *config)
{
    ...
    cluster::bridged_device_basic_information::create(endpoint, &(config->bridged_device_basic_information), CLUSTER_FLAG_SERVER);
    return ESP_OK;
}
