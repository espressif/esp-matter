...
esp_err_t add(endpoint_t *endpoint, config_t *config)
{
    ...
    cluster::ota_software_update_provider::create(endpoint, NULL, CLUSTER_FLAG_CLIENT);
    cluster::ota_software_update_requestor::create(endpoint, &(config->ota_software_update_requestor), CLUSTER_FLAG_SERVER);
    return ESP_OK;
}
