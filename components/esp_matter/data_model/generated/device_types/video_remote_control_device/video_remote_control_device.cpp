...
{
    return ESP_MATTER_VIDEO_REMOTE_CONTROL_DEVICE_TYPE_ID;
}

uint8_t get_device_type_version()
{
    return ESP_MATTER_VIDEO_REMOTE_CONTROL_DEVICE_TYPE_VERSION;
}
...
esp_err_t add(endpoint_t *endpoint, config_t *config)
{
    ...
    cluster::media_playback::create(endpoint, NULL, CLUSTER_FLAG_CLIENT);
