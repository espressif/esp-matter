...
/*! \brief HCI direct event callback type.
 *
 *  This callback function sends command complete events
 *  not handled by Stack directly from HCI to Application.
 *
 *  \paran  opCode      Event opcode.
 *  \param  status      status of the command.
 *  \param  pEvent      Pointer to HCI event parameters.
 *
 *  \return None.
 */
typedef void (*hciUnhandledCmdComplEvtCback_t)(uint16_t opCode, uint8_t status, void *param);
...
/*************************************************************************************************/
/*!
 *  \brief  Register a callback for Command Complete events not handled by Stack.
 *
 *  \param  unhandledCmdComplEvtCback  Callback function.
 *
 *  \return None.
 */
/*************************************************************************************************/
...
/*************************************************************************************************/
/*!
 *  \brief  HCI Host Buffer Size Command.
 *
 *  \return None.
 */
/*************************************************************************************************/
void HciHostBufferSizeCmd(uint16_t hostAclDataPacketLength, uint8_t hostSynDataPacketLength, uint16_t hostTotalNumAclDataPackets, uint16_t hostTotalNumSynDataPackets);
...
void HciVsdEnableControlledBandwidthModeByDefault(bool_t enable);
