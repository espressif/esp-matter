...
/*************************************************************************************************/
/*!
 *  \brief  Verify whether a buffer is available to allocate an ATT message buffer to be sent
 *          with the ATT attribute protocol zero-copy APIs.
 *
 *  \param  len         Message length in bytes.
 *  \param  opcode      Opcode for ATT message.
 *
 ...
 */
/*************************************************************************************************/
bool_t CheckAttMsgAlloc(uint16_t len, uint8_t opcode);
 ...
 *  \param  cback   Client callback function.
 *
 *  \return Offset  (first index allocated) in CCC descriptor handle table.
 */
/*************************************************************************************************/
uint8_t AttsCccRegister(uint8_t setLen, attsCccSet_t *pSet, attsCccCback_t cback);
 ...
 *  \param  pucValue    Read data.
 *  \param  xLen        Length read data.
 *
 *  \return None.
 *
 ...
 */
/*************************************************************************************************/
void AttsContinueReadReq(dmConnId_t connId, uint16_t handle, uint8_t status, uint8_t *pValue, uint16_t len);

/*************************************************************************************************/
/*!
 *  \brief  Send a response to a pending read blob request.  For use with ATT_RSP_PENDING.
 *
 *  \param  connId      Connection ID.
 *  \param  handle      Attribute handle.
 *  \param  status      Status of the read request.
 ...
 */
/*************************************************************************************************/
void AttsContinueReadBlobReq(dmConnId_t connId, uint16_t handle, uint8_t status, uint16_t offset, uint8_t *pValue, uint16_t len);
 ...
 *  \param  handle      Attribute handle.
 *  \param  status      Status of the write request.
 *  \param  offset      offset of the data in the service.
 *  \param  pValue      Data do be written
 ...
 */
/*************************************************************************************************/
void AttsContinuePrepWriteReq(dmConnId_t connId, uint16_t handle, uint8_t status, uint8_t offset, uint8_t *pValue, uint16_t len);

/*************************************************************************************************/
/*!
 *  \brief  Send a response to a pending execute write request.  For use with ATT_RSP_PENDING.
 *
 *  \param  connId      Connection ID.
 *  \param  status      Status of the write request.
 *
 ...
 */
/*************************************************************************************************/
void AttsContinueExecWriteReq(dmConnId_t connId, uint8_t status);
/*************************************************************************************************/
/*!
