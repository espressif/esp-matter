...
#ifndef BA431_CONFIG_H_
#define BA431_CONFIG_H_

#if defined(GP_DIVERSITY_ROM_CODE)
#include "ba431_config_RomCode.h"
...
/**
* @brief Structure that represent the register map of the BA431 IP
*/
...
/** @brief mask for ::BA431Regs_t.StatusReg adaptive proportion test (64-sample window)
 * interrupt status */
#define BA431_STAT_MASK_PROP1_FAIL        0x00000020
/** @brief mask for ::BA431Regs_t.StatusReg adaptive proportion test (4096-sample window)
 * interrupt status */
#define BA431_STAT_MASK_PROP2_FAIL        0x00000040
 ...
 * proportion test failure (64-sample window)*/
#define BA431_CTRL_INT_PROP1_EN           0x00000020
/** @brief value of ::BA431Regs_t.ControlReg to enable interrupt for adaptive
 * proportion test failure (4096-sample window)*/
#define BA431_CTRL_INT_PROP2_EN           0x00000040
...
#include "silexCryptoSoc_CodeJumpTableFlash_Defs_ba431_config.h"
#include "silexCryptoSoc_CodeJumpTableRom_Defs_ba431_config.h"
