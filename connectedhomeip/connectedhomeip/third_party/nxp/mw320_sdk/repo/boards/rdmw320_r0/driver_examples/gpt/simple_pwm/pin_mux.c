...
void BOARD_InitPins(void) {                                /*!< Function assigned for the core: Cortex-M4[cm4] */
    ...
    PINMUX_PinMuxSet(BOARD_AMBER_LED_PIN, BOARD_AMBER_LED_PIN_FUNCTION_ID | PINMUX_MODE_DEFAULT);
    PINMUX_PinMuxSet(BOARD_GPT0_CH1_PIN, BOARD_GPT0_CH1_PIN_FUNCTION_ID | PINMUX_MODE_DEFAULT);
}
