...
The example demostrate how to use ssp peripheral driver to simulate i2s protocol and transmit/receive data through ssp dma driver.
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
SSP i2s dma loopback Driver example

SSP i2s dma loopback success
