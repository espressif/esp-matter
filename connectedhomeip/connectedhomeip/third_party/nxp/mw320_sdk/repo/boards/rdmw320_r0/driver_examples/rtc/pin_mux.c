...
void BOARD_InitPins(void) {                                /*!< Function assigned for the core: Cortex-M4[cm4] */
    ...
    PINMUX_PinMuxSet(BOARD_XTAL32K_IN_PIN, BOARD_XTAL32K_IN_PIN_FUNCTION_ID | PINMUX_MODE_DEFAULT);
    PINMUX_PinMuxSet(BOARD_XTAL32K_OUT_PIN, BOARD_XTAL32K_OUT_PIN_FUNCTION_ID | PINMUX_MODE_DEFAULT);
}
