...
On boards that have an LED connected to the GPT pin, the user will see a change in LED brightness.
...
Board settings
==============
Connect IO_01 with IO_40 to allow PWM wave to drive the LED.
...
You will see a change in LED brightness if an LED is connected to the GPT pin
If no LED is connected to the GPT pin, then probe the signal using an oscilloscope
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
- Amber led will change brightness.
