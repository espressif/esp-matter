...
#define _FUNC_ATTR_EXPAND(_section_prefix, _postfix)         __attribute__ ((__section__(_section_prefix _postfix),noinline))
#define _QUOTE(_name) #_name
#define _EXPAND(_str) _QUOTE(_str)

#define ATTR_TEXT_IN_TCM                             __attribute__ ((__section__(".tcm_code"),noinline))
...
#define ATTR_RWDATA_IN_TCM_SEC_SHM                   __attribute__ ((__section__(".tcm_sec_shm"),used))
#else
#define ATTR_RWDATA_IN_TCM_SEC_SHM                   __attribute__ ((__section__(".tcm_rwdata")))
#endif

#define ATTR_TEXT_IN_RAM                             __attribute__ ((__section__(".ram_code"),noinline))
...
#define ATTR_ZIDATA_IN_NON_INIT_RAM                  __attribute__ ((__section__(".non_init_ram_zidata")))

#define ATTR_TEXT_IN_NONCACHED_RAM                   __attribute__ ((__section__(".noncached_ram_code"),noinline))
...
#define ATTR_TEXT_IN_SYSRAM                          __attribute__ ((__section__(".sysram_code"),noinline))
...
#define ATTR_ZIDATA_IN_NON_INIT_SYSRAM               __attribute__ ((__section__(".non_init_sysram_zidata"))) 

#define ATTR_TEXT_IN_NONCACHED_SYSRAM                __attribute__ ((__section__(".noncached_sysram_code"),noinline))
...
#ifdef MTK_XIP_ENABLE
#define ATTR_TEXT_IN_RAM_MODE_SUSPEND_RESUME
#else
...
#define ATTR_USED                                    __attribute__ ((used))
  ...
  #error "LTO is not supproted in KEIL Compiler. Please contact MTK for support."
#endif
...
#define ATTR_ZIDATA_IN_TCM                           __attribute__ ((__section__(".tcm_zidata")))
#ifdef MTK_TFM_ENABLE
#define ATTR_RWDATA_IN_TCM_SEC_SHM                   __attribute__ ((__section__(".tcm_sec_shm")))
#else
#define ATTR_RWDATA_IN_TCM_SEC_SHM                   __attribute__ ((__section__(".tcm_rwdata")))
#endif
...
#if defined(MTK_GCC_LTO_ENABLE)
  #error "LTO is not supproted in IAR Compiler. Please contact MTK for support."
#endif
...
#ifdef MTK_TFM_ENABLE
#define ATTR_RWDATA_IN_TCM_SEC_SHM                   _Pragma("location=\".tcm_sec_shm\"")
#else
#define ATTR_RWDATA_IN_TCM_SEC_SHM                   _Pragma("location=\".tcm_rwdata\"")
#endif
...
#define ATTR_ZIDATA_IN_NON_INIT_RAM                  _Pragma("location=\".non_init_ram_zidata")
...
#define ATTR_ZIDATA_IN_NON_INIT_SYSRAM               _Pragma("location=\".non_init_sysram_zidata\"") 
