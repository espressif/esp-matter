...
#if !defined(MTK_HAL_PLAIN_LOG_ENABLE) && !defined(MTK_HAL_NO_LOG_ENABLE) && !defined (MTK_DEBUG_LEVEL_NONE)
#include "syslog.h"
#else /* #if !defined(MTK_HAL_PLAIN_LOG_ENABLE) && !defined(MTK_HAL_NO_LOG_ENABLE) && !defined (MTK_DEBUG_LEVEL_NONE) */
#include "stdio.h"
#endif /* #if !defined(MTK_HAL_PLAIN_LOG_ENABLE) && !defined(MTK_HAL_NO_LOG_ENABLE) && !defined (MTK_DEBUG_LEVEL_NONE) */
...
extern void log_hal_debug_internal(const char *func, int line, const char *message, ...);
...
#define log_hal_debug(_message,...)                //log_hal_debug_internal(__FUNCTION__, __LINE__, (_message),##__VA_ARGS__)
...
#if !defined(MTK_HAL_PLAIN_LOG_ENABLE) && !defined(MTK_HAL_NO_LOG_ENABLE) && !defined (MTK_DEBUG_LEVEL_NONE)
#define log_hal_msgid_error(_message,arg_cnt,...)                LOG_E(hal,_message,##__VA_ARGS__)
#define log_hal_msgid_warning(_message,arg_cnt,...)              LOG_W(hal,_message,##__VA_ARGS__)
#define log_hal_msgid_info(_message,arg_cnt,...)                 LOG_I(hal,_message,##__VA_ARGS__)
