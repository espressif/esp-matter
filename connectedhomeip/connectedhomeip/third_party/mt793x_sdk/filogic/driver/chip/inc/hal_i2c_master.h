 ...
 *
 *  Note:  \n
 *       It is required to use the pull-up resistors on the SCL and SDA of the I2C interface. Please refer to related HDK user guide for more details.
 *
...
/** @brief This structure defines the configuration settings for send_to_receive transaction format. */
typedef struct {
 ...
 *  extended DMA mode in @ref HAL_I2C_Features_Chapter chapter.
 *  Note, not all I2C masters support DMA mode. For more details about DMA mode, see #hal_i2c_port_t.
