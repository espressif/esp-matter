 ...
 *   \if MT7933
 *   - Step1: Call hal_adc_get_data_polling() to retrieve sample data for a channel.
 *   \else
 ...
 *       hal_gpio_set_analog(HAL_GPIO_17, true);//set gpio17 pin as adc analog function.
 *       hal_adc_get_data_polling(HAL_ADC_CHANNEL_0, &adc_data);//Retrieve ADC data for channel 0.
 *       hal_gpio_set_analog(HAL_GPIO_17, false);//clear gpio17 pin as adc analog function.
