 ...
 * |\b PMU                  | Power Management Unit
 * |\b PSRAM                | Pseudostatic RAM(a type of DRAM)
 ...
 *
 * - \b Introduction \n
 *   Mediatek IoT SDK hardware abstraction layer (HAL) driver is embedded software ensuring maximized portability across IoT portfolio designed for Mediatek IoT SDK for RTOS development platform.\n
 ...
 *    - Driver/board: The driver files that are associated with the board, such as Lowpower CLI.\n
