...
*  - sample code:
*    \include spi_master_pin_driving.dox
* @}
* @}
*/
#endif
...
typedef struct {
    uint32_t clock_frequency;                                   /**< SPI master clock frequency setting, the unit of frequency is Hz. */
