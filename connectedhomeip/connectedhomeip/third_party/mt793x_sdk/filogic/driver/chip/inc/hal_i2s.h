...
typedef struct {
    ...
    uint32_t                        msb_offset;          /**< The number of bits delay between frame sync and first data bit of the I2S link. The user can set msb_offset from 0 to 127 on TDM mode.\n*/
...
typedef struct {
    ...
    hal_i2s_tx_mode_t            tx_mode;            /**< Enable or disable the I2S TX to send the same data on right and left channels. Enable this funtion is not allowed when the channel number of I2S TX is set to HAL_I2S_STEREO.*/
#endif
} hal_i2s_config_t;
