...
/**
 * @brief Set the mode of the WDT. For more information on reset and interrupt modes, please refer to @ref HAL_WDT_Features_Chapter
 *        in overview.
 * @param[in] the mode to set to WDT.
 * @sa   #hal_wdt_init().
 * @par       Example
 * @code
 *       hal_wdt_set_mode(HAL_WDT_MODE_RESET);
 * @endcode
 */
