 ...
 * @return      Indicates whether this function call is successful.
 *              #HAL_DISPLAY_DSI_STATUS_OK, the operation completed successfully.
 *              #HAL_DISPLAY_DSI_STATUS_COMMAND_QUEUE_FAILED, the BTA command cannot be received.
 *              #HAL_DISPLAY_DSI_STATUS_ERROR, the operation has failed.
 */
hal_display_dsi_status_t hal_dsiplay_dsi_start_bta_transfer(uint32_t command);
 ...
 *              #HAL_DISPLAY_DSI_STATUS_ERROR, the operation has failed.
 */
hal_display_dsi_status_t hal_display_dsi_start_bta_transfer(uint32_t command);
