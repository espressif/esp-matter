 ...
 * @}
 */
#else /* #ifdef HAL_GPT_FEATURE_US_TIMER */
/**
 * @addtogroup HAL
 * @{
 * @addtogroup GPT
 ...
 *    For 7933, HAL_GPT_0/HAL_GPT_3/HAL_GPT_4/HAL_GPT_5 have been used, So only HAL_GPT_1/HAL_GPT_2 can be used to setup hw timers; We also provide a series of sw timer functions,
 *    which based on HAL_GPT_3 and can support max 32 sw timers; See "Using software timer" for more infomation.
 ...
 *            This callback can not be null and will be called when the timer expires.
 * @param[in] user_data is the pointer to the user defined data to pass to the callback function.
 * @return    #HAL_GPT_STATUS_OK, if the operation is successful.\n
 *            #HAL_GPT_STATUS_ERROR_PORT, if the gpt_port value is wrong.\n
 ...
 * @param[in] gpt_port is the port number.
 * @param[in] timeout_time_ms is the expiration time[max 130150523ms] in milliseconds,.
 ...
 * @param[in]  timeout_time_ms is the timeout[max 130150523ms] value in milliseconds.
...
* @}
*/
#endif /* #if defined(HAL_GPT_MODULE_ENABLED) */
#endif /* #ifndef __HAL_GPT_H__ */
