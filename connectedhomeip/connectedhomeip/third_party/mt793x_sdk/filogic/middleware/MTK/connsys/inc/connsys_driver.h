...
#else /* #ifdef MTK_HIF_GDMA_ENABLE */
#define CFG_WIFI_HIF_GDMA_EN                 0
#endif /* #ifdef MTK_HIF_GDMA_ENABLE */
...
#endif /* #if (PRODUCT_VERSION == 5932 || PRODUCT_VERSION == 7682 || PRODUCT_VERSION == 7686) */
#if (PRODUCT_VERSION == 5932 || PRODUCT_VERSION == 7682 || PRODUCT_VERSION == 7686)
#define WF_PSE_TOP_BASE 0xD0000000
#else /* #if (PRODUCT_VERSION == 5932 || PRODUCT_VERSION == 7682 || PRODUCT_VERSION == 7686) */
...
#endif /* #if (CFG_CONNSYS_POLLING_IRQ_EN == 1) */
...
#endif /* #ifdef MTK_MINICLI_ENABLE */
...
#endif /* #if (CFG_CONNSYS_MEASURE_INT_TIME_EN == 1) */
...
#endif /* #if (CFG_WIFI_HIF_GDMA_EN == 1) */
...
#endif /* #ifndef __CONNSYS_DRIVER_H__ */
