...
#include "bt_type.h"
#endif /* #if defined(MTK_BLE_BQB_CLI_ENABLE) || defined(MTK_BLE_CLI_ENABLE) */
...
#ifdef MTK_BLE_CLI_ENABLE
#define BLE_CLI_ENTRY { "ble", "bluetooth ble related cmd", bt_cli_ble , NULL},
...
#ifdef MTK_BLE_BQB_CLI_ENABLE
#define BLE_BQB_CLI_ENTRY { "bqb", "bluetooth bqb related cmd", bt_cli_bqb, NULL },
