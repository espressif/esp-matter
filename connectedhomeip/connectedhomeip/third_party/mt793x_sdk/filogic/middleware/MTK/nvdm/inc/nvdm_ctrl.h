...
/**
 * @file wifi_nvdm_ctrl.h
 *
 */

#ifndef __NVDM_CTRL_H__
#define __NVDM_CTRL_H__
...
#define USER_DATA_MAX_ITEM 32
#define NVDM_DATA_ITEM(X,Y) {X,NVDM_DATA_ITEM_TYPE_STRING,Y,sizeof(Y)}
#define NVDM_RAW_DATA_ITEM(X,Y,Z) {X,NVDM_DATA_ITEM_TYPE_RAW_DATA,Y,Z}
...
void nvdm_ctrl_init(void);
void nvdm_ctrl_check_default(void);
