...
#define NVDM_LOG_NOTICE(message, ...)   nvdm_port_log_notice(message, ##__VA_ARGS__)
#define NVDM_LOG_INFO(message, ...)     nvdm_port_log_info(message, ##__VA_ARGS__)
#define NVDM_LOG_ERROR(message, ...)    nvdm_port_log_error(message, ##__VA_ARGS__)
#else
#define NVDM_LOG_NOTICE(message, ...)
#define NVDM_LOG_INFO(message, ...)
#define NVDM_LOG_ERROR(message, ...)    assert(0)
#endif
