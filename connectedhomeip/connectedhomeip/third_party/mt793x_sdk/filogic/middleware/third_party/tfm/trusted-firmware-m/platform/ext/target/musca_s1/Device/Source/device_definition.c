...
#ifdef MPC_MRAM_S
static const struct mpc_sie200_dev_cfg_t MPC_MRAM_DEV_CFG_S = {
    .base = MUSCA_S1_MRAM_MPC_S_BASE};
static struct mpc_sie200_dev_data_t MPC_MRAM_DEV_DATA_S = {
    .range_list = 0,
    .nbr_of_ranges = 0,
    .state = 0,
    .reserved = 0};
struct mpc_sie200_dev_t MPC_MRAM_DEV_S = {
    &(MPC_MRAM_DEV_CFG_S),
    &(MPC_MRAM_DEV_DATA_S)};
#endif

#ifdef MPC_MRAM_NS
static const struct mpc_sie200_dev_cfg_t MPC_MRAM_DEV_CFG_NS = {
    .base = MUSCA_S1_MRAM_MPC_NS_BASE};
static struct mpc_sie200_dev_data_t MPC_MRAM_DEV_DATA_NS = {
    .range_list = 0,
    .nbr_of_ranges = 0,
    .state = 0,
    .reserved = 0};
struct mpc_sie200_dev_t MPC_MRAM_DEV_NS = {
    &(MPC_MRAM_DEV_CFG_NS),
