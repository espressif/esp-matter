...
#ifdef MPC_ISRAM0_S
extern struct smpu_dev_t MPC_ISRAM0_DEV_S;
#endif

#ifdef MPC_ISRAM1_S
extern struct smpu_dev_t MPC_ISRAM1_DEV_S;
#endif

#ifdef MPC_ISRAM2_S
extern struct smpu_dev_t MPC_ISRAM2_DEV_S;
#endif

#ifdef MPC_ISRAM3_S
extern struct smpu_dev_t MPC_ISRAM3_DEV_S;
#endif

#ifdef MPC_CODE_SRAM1_S
extern struct smpu_dev_t MPC_CODE_SRAM1_DEV_S;
#endif

#ifdef MPC_CODE_SRAM2_S
extern struct smpu_dev_t MPC_CODE_SRAM2_DEV_S;
#endif

#ifdef MPC_CODE_SRAM3_S
extern struct smpu_dev_t MPC_CODE_SRAM3_DEV_S;
#endif
