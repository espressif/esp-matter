...
/******** TFM_SP_PLATFORM_MTK ********/
#define TFM_SP_PLATFORM_MTK_HW_ACCELERATOR_SID                     (0x00000040U)
#define TFM_SP_PLATFORM_MTK_HW_ACCELERATOR_VERSION                 (1U)

/******** TFM_MTK_CI_TEST ********/
#define TFM_CI_MTK_CI_TEST_SID                                     (0x0000F200U)
#define TFM_CI_MTK_CI_TEST_VERSION                                 (1U)
