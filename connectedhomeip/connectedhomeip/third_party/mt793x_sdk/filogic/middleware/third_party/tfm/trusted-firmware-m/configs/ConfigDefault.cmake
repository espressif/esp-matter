...
elseif(EXISTS "${TFM_ROOT_DIR}/platform/ext/${TARGET_PLATFORM}.cmake")
	set(PLATFORM_CMAKE_FILE "${TFM_ROOT_DIR}/platform/ext/${TARGET_PLATFORM}.cmake")
elseif(${TARGET_PLATFORM} MATCHES "mt7933*")
	set(PLATFORM_CMAKE_FILE "${TFM_ROOT_DIR}/platform/ext/mt7933_hdk.cmake")
else()
