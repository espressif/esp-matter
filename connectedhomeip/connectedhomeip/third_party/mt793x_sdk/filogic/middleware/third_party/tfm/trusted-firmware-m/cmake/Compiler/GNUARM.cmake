...
macro(__compiler_gnuarm lang)
  if(NOT CMAKE_${lang}_FLAGS_SET)
    ...
    set(CMAKE_${lang}_LINK_EXECUTABLE      "<CMAKE_LINKER> <CMAKE_${lang}_LINK_FLAGS> <LINK_FLAGS> <OBJECTS> -Wl,-start-group <LINK_LIBRARIES> -Wl,-end-group -o <TARGET> -Xlinker -Map=<TARGET_BASE>.map")
