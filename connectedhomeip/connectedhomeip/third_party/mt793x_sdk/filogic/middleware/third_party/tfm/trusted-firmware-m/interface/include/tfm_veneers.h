...
psa_status_t tfm_platform_slp_internal_sys_init_veneer(psa_invec *in_vec, size_t in_len, psa_outvec *out_vec, size_t out_len);
psa_status_t tfm_platform_slp_platform_sys_init_veneer(psa_invec *in_vec, size_t in_len, psa_outvec *out_vec, size_t out_len);
psa_status_t tfm_platform_slp_conn_bus_backup_veneer(psa_invec *in_vec, size_t in_len, psa_outvec *out_vec, size_t out_len);
psa_status_t tfm_platform_slp_system_sleep_wakeup_veneer(psa_invec *in_vec, size_t in_len, psa_outvec *out_vec, size_t out_len);
psa_status_t tfm_platform_slp_conn_bus_suspend_veneer(psa_invec *in_vec, size_t in_len, psa_outvec *out_vec, size_t out_len);
psa_status_t tfm_platform_slp_conn_bus_resume_veneer(psa_invec *in_vec, size_t in_len, psa_outvec *out_vec, size_t out_len);
psa_status_t tfm_platform_slp_enter_wfi_sys_veneer(psa_invec *in_vec, size_t in_len, psa_outvec *out_vec, size_t out_len);
psa_status_t tfm_platform_spm_spm_suspend_module_lock_veneer(psa_invec *in_vec, size_t in_len, psa_outvec *out_vec, size_t out_len);
psa_status_t tfm_platform_spm_spm_ctrl_veneer(psa_invec *in_vec, size_t in_len, psa_outvec *out_vec, size_t out_len);
psa_status_t tfm_platform_spm_spm_mtcmos_veneer(psa_invec *in_vec, size_t in_len, psa_outvec *out_vec, size_t out_len);
psa_status_t tfm_platform_spm_hal_spm_init_veneer(psa_invec *in_vec, size_t in_len, psa_outvec *out_vec, size_t out_len);
...
/******** TFM_SP_PLATFORM_MTK ********/
psa_status_t tfm_tfm_hal_aes_ecb_encrypt_veneer(psa_invec *in_vec, size_t in_len, psa_outvec *out_vec, size_t out_len);
psa_status_t tfm_tfm_hal_trng_random_generate_veneer(psa_invec *in_vec, size_t in_len, psa_outvec *out_vec, size_t out_len);
#endif /* MTK_HW_ACCELERATOR_WO_MBEDTLS */

#ifdef MTK_CI_TEST
/******** TFM_MTK_CI_TEST ********/
psa_status_t tfm_tfm_ci_exception_handle_test_veneer(psa_invec *in_vec, size_t in_len, psa_outvec *out_vec, size_t out_len);
psa_status_t tfm_tfm_ci_platform_isolation_test_veneer(psa_invec *in_vec, size_t in_len, psa_outvec *out_vec, size_t out_len);
#endif /* MTK_CI_TEST */
