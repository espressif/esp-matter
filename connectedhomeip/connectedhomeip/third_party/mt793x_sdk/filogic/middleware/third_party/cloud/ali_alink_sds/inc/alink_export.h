...
enum ALINK_WIFI_CALLBACK {
    ...
    /**
     * void callback_read_device_status(const char *params)
     * @n@nuccessfully
     */
    ALINK_GET_DEVICE_STATUS,

    /**
     * int callback_write_device_status(const char *params)
     */
    ...
    /**
     * int callback_write_device_rawdata(const char *params)
     */
