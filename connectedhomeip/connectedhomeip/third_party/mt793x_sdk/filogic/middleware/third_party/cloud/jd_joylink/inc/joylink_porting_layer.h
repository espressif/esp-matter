...
extern int joylink_get_wlan24g(char *buf, unsigned int buf_sz);
extern int joylink_set_wlan24g(const char *json_in);
extern int joylink_get_subdev(char *buf, unsigned int buf_sz);
extern int joylink_set_subdev(const char *json_in);
extern int joylink_get_wlanspeed(char *buf, unsigned int buf_sz);
extern int joylink_set_wlanspeed(const char *json_in);
extern int joylink_get_uuid(char *buf, unsigned int buf_sz);
extern int joylink_set_uuid(const char *json_in);
...
extern int joylink_get_server_st(char *buf, unsigned int buf_sz);
extern int joylink_set_server_st(const char *json_in);
extern int joylink_get_macaddr(char *buf, unsigned int buf_sz);
extern int joylink_set_macaddr(const char *json_in);
...
extern int joylink_get_serverinfo(char *buf, unsigned int buf_sz);
extern int joylink_set_serverinfo(const char *json_in);
...
//extern int32_t joylink_fota_http_retrieve_get(char* buf, uint32_t len);
