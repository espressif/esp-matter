...
/* Platform options */
/*#define MBEDTLS_PLATFORM_STD_CALLOC        TestCalloc / **< Default allocator to use, can be undefined * / */
/*#define MBEDTLS_PLATFORM_STD_FREE            TestFree / **< Default free to use, can be undefined * / */
...
#define MBEDTLS_PLATFORM_CALLOC_MACRO    mock_osal_calloc     /**< Default allocator macro to use, can be undefined */
#define MBEDTLS_PLATFORM_FREE_MACRO      mock_osal_free       /**< Default free macro to use, can be undefined */
