...
mDNSlocal void mDNS_StatusCallback(mDNS *const m, mStatus result)
{
    ...
    else if (result == mStatus_GrowCache)
    {
        ...
        CacheEntity *storage = os_malloc(sizeof(CacheEntity) * RR_CACHE_SIZE);
...
//                    mDNS_StatusCallback, mDNS_Init_NoInitCallbackContext);
	...
	err = mDNS_Init(&mDNSStorage, &PlatformStorage, NULL, 0, mDNS_Init_AdvertiseLocalAddresses, 
                                        NULL , mDNS_Init_NoInitCallbackContext);
