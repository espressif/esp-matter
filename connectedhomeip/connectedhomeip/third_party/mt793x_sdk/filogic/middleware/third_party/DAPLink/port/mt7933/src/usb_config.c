...
#define USBD_CDC_ACM_MULTIPLE_ENABLE //Eason +
#ifdef USBD_CDC_ACM_MULTIPLE_ENABLE
  #define USBD_CDC_ACM_NUM          3
  #define USBD_CDC_ACM_EP_INTIN     3, 5, 7
  #define USBD_CDC_ACM_EP_BULKIN    4, 6, 8
  #define USBD_CDC_ACM_EP_BULKOUT   4, 6, 8
  #define USBD_CDC_ACM_CIF_STRDESC        L"mbed Serial Port"
  #define USBD_CDC_ACM_DIF_STRDESC        L"mbed Serial Port"
  #define USBD_CDC_ACM_CIF_STRDESC1        L"mbed Serial Port1"
  #define USBD_CDC_ACM_DIF_STRDESC1        L"mbed Serial Port1"
  #define USBD_CDC_ACM_CIF_STRDESC2        L"mbed Serial Port2"
  #define USBD_CDC_ACM_DIF_STRDESC2        L"mbed Serial Port2"
  #define USBD_CDC_ACM_CIF_STRDESC3        L"mbed Serial Port3"
  #define USBD_CDC_ACM_DIF_STRDESC3        L"mbed Serial Port3"
#else
  #define USBD_CDC_ACM_NUM          1
  #define USBD_CDC_ACM_EP_INTIN     3
  #define USBD_CDC_ACM_EP_BULKIN    4
  #define USBD_CDC_ACM_EP_BULKOUT   4
  #define USBD_CDC_ACM_CIF_STRDESC        L"mbed Serial Port"
  #define USBD_CDC_ACM_DIF_STRDESC        L"mbed Serial Port"
#endif /* USBD_CDC_ACM_MULTIPLE_ENABLE */

#define USBD_CDC_ACM_EP_INTIN_STACK     0
#define USBD_CDC_ACM_WMAXPACKETSIZE     128
#define USBD_CDC_ACM_BINTERVAL          32
#define USBD_CDC_ACM_HS_ENABLE          1
#define USBD_CDC_ACM_HS_WMAXPACKETSIZE  128
#define USBD_CDC_ACM_HS_BINTERVAL       2
#define USBD_CDC_ACM_EP_BULKIN_STACK    0
#define USBD_CDC_ACM_WMAXPACKETSIZE1    128
...
#define USBD_BULK_EP_BULKIN_SWO      10 // useless? assign an dummy EP number
#define USBD_BULK_WMAXPACKETSIZE     256
...
#define USBD_IF_NUM_MAX             (USBD_BULK_ENABLE+USBD_WEBUSB_ENABLE+USBD_HID_ENABLE+USBD_MSC_ENABLE+(USBD_ADC_ENABLE*2)+(USBD_CDC_ACM_ENABLE*(2*USBD_CDC_ACM_NUM))+USBD_CLS_ENABLE)
...
#define USBD_HID_IF_STR_NUM        (3+USBD_STRDESC_SER_ENABLE+USBD_ADC_ENABLE*3+USBD_CDC_ACM_ENABLE*(2*USBD_CDC_ACM_NUM))
#define USBD_WEBUSB_IF_STR_NUM     (3+USBD_STRDESC_SER_ENABLE+USBD_ADC_ENABLE*3+USBD_CDC_ACM_ENABLE*(2*USBD_CDC_ACM_NUM)+USBD_HID_ENABLE)
#define USBD_MSC_IF_STR_NUM        (3+USBD_STRDESC_SER_ENABLE+USBD_ADC_ENABLE*3+USBD_CDC_ACM_ENABLE*(2*USBD_CDC_ACM_NUM)+USBD_HID_ENABLE+USBD_WEBUSB_ENABLE)
#define USBD_BULK_IF_STR_NUM       (3+USBD_STRDESC_SER_ENABLE+USBD_ADC_ENABLE*3+USBD_CDC_ACM_ENABLE*(2*USBD_CDC_ACM_NUM)+USBD_HID_ENABLE+USBD_WEBUSB_ENABLE+USBD_MSC_ENABLE)
