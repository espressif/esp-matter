...
extern int32_t uart_write_free(uint32_t fd);
extern int32_t uart_write_data(uint32_t fd, uint8_t *data, uint16_t size);
extern int32_t uart_read_data(uint32_t fd, uint8_t *data, uint16_t size);
