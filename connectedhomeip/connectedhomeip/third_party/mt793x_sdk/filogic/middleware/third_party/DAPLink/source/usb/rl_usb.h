...
extern int32_t  USBD_CDC_ACM_DataSend(uint32_t fd, const uint8_t *buf, int32_t len);
extern int32_t  USBD_CDC_ACM_DataFree(uint32_t fd);
extern int32_t  USBD_CDC_ACM_PutChar(uint32_t fd, const uint8_t  ch);
extern int32_t  USBD_CDC_ACM_DataRead(uint32_t fd, uint8_t *buf, int32_t len);
extern int32_t  USBD_CDC_ACM_GetChar(uint32_t fd);
extern int32_t  USBD_CDC_ACM_DataAvailable(uint32_t fd);
extern int32_t  USBD_CDC_ACM_Notify(uint32_t fd, uint16_t stat);
