...
/*
 * Support entity converter or not
 */

#define MXML_SUPPORT_ENTITY 1


/*
 * Support get functions or not
 */

#define MXML_SUPPORT_GET_FUNCTIONS 1


/*
 * Support set functions or not
 */

#define MXML_SUPPORT_SET_FUNCTIONS 1


/*
 * Support index or not
 */

#define MXML_SUPPORT_INDEX 1
