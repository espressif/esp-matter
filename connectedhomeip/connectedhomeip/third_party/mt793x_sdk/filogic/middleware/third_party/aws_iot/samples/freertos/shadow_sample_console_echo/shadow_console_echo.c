...
static uint8_t shadowConsoleEchoPubs = 5;
static uint8_t shadowConsoleEchoAccepted = 0;
static uint8_t shadowConsoleEchoUpdated = 0;


//int main(int argc, char** argv) {
int shadow_sample_console_echo_main(void) {
...
*/
	...
	//IOT_INFO("\nShadow Console Echo....AWS IoT SDK Version %d.%d.%d-%s\n", VERSION_MAJOR, VERSION_MINOR, VERSION_PATCH, VERSION_TAG);


	// initialize the mqtt client
	AWS_IoT_Client* mqttClient = pvPortCalloc(1, sizeof(AWS_IoT_Client));

   if (mqttClient == NULL) {     
        IOT_ERROR("shadow_sample_console_echo_main memory alloc fail");
        return -1;
    }
	...
	sp.pClientCRT = AWS_IOT_DEVICE_CERT;
	sp.pClientKey = AWS_IOT_PRIVATE_KEY;
	sp.pRootCA = AWS_IOT_ROOT_CA_CERT;
    ...
    IOT_INFO("..................................................................");
    IOT_INFO("..            Start To Send Message From AWS Console           ...");
    IOT_INFO("..................................................................");
	...
	while (NETWORK_ATTEMPTING_RECONNECT == rc || NETWORK_RECONNECTED == rc || SUCCESS == rc) {
        ...
        if (shadowConsoleEchoPubs <= shadowConsoleEchoUpdated) {
            break;
        }
	}
    ...
    IOT_DEBUG("Shadow Console Echo Accepted : %d, Published : %d", shadowConsoleEchoAccepted, shadowConsoleEchoPubs);
    if (shadowConsoleEchoAccepted == shadowConsoleEchoPubs) {
        return SUCCESS;
    }
...
void UpdateStatusCallback(const char *pThingName, ShadowActions_t action, Shadow_Ack_Status_t status,
	...
	if(SHADOW_ACK_TIMEOUT == status) {
        ...
        shadowConsoleEchoAccepted ++;
	}
    shadowConsoleEchoUpdated ++;
}
