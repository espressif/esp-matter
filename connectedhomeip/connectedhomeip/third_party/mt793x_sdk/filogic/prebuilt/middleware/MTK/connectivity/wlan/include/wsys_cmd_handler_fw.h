...
#define CMD_WOW_UDP_TCP_PORT 20
	uint16_t ausIPv4UdpPort[CMD_WOW_UDP_TCP_PORT];
	uint16_t ausIPv4TcpPort[CMD_WOW_UDP_TCP_PORT];
	uint16_t ausIPv6UdpPort[CMD_WOW_UDP_TCP_PORT];
	uint16_t ausIPv6TcpPort[CMD_WOW_UDP_TCP_PORT];
};
