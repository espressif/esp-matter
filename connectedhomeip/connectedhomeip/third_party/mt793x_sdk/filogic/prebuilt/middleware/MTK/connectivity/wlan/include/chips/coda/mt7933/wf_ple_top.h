/* [File] : wf_ple_top.h */
/* [Revision time] : Fri Nov 22 13:11:30 2019 */
...
* DIS_PLE_DYN_CKG[18] - (RW) Disable control of wf_ple_top dynamic clock gating
function
...
* Set the total page before release PLE logic reset, and must not be changed
* after release logic reset.
* RESERVED12[16..12] - (RO) Reserved bits
* PBUF_OFFSET[25..17] - (RW) Packet buffer offset
* Set up the buffer offset before releasing PLE logic reset; it should not be
* changed after logic reset is released.
* RESERVED26[30..26] - (RO) Reserved bits
* PAGE_SIZE_CFG[31] - (RW) Configures page size
* Set up the page size before releasing PLE logic reset; it should not be
* changed after logic reset is released.
*/
...
* Set start page before release PLE logic reset, and must not be changed after
* release logic reset.
* RESERVED12[15..12] - (RO) Reserved bits
* FREEPG_END[27..16] - (RW) End page for free page list
* Set end page before release PLE logic reset, and must not be changed after
* release logic reset.
...
* Set the quota before release PLE logic reset ,and must not be changed after
* release logic reset.
* RESERVED12[15..12] - (RO) Reserved bits
* HIF_MAX_QUOTA[27..16] - (RW) Max. quota of HIF group
* Set up the quota before releasing PLE logic reset; it should not be changed
...
* DBDC1_SEARCH_RULE[20] - (RW) Priority for HW search if internal collision
occurs
* DBDC0_SEARCH_RULE[21] - (RW) Priority for HW search if internal collision
occcurs
* RESERVED22[25..22] - (RO) Reserved bits
* DRR_LOGIC_RESET[26] - (RW) DRR logic reset control
* DIS_WTBL_PS_IGNORE[27] - (RW) Disable control of the function that STA with
* WTBL PS ignore in TXQ busy
...
* UMAC_MBIST_DIAG_SEL[20] - (RW) Selection register for UMAC mbist_diag_scan_out
* (PLE or PSE)
* RESERVED21[23..21] - (RO) Reserved bits
* G1_MBIST_SLEEP_TEST[24] - (RW) Control register for sleep_test of group 1
MBIST
...
* G2_MBIST_SLEEP_TEST[28] - (RW) Control register for sleep_test of group 2
MBIST
...
* RESERVED4[15..4] - (RO) Reserved bits
* EN_TOGGLE_INT[16] - (RW) Enable control of interrupt for data toggle of N9
...
interrupt
* EN_DBDC0_EMPTY_INT[25] - (RW) Enable control of DBDC0 queue empty raise
interrupt
...
* EN_Q_CMD_ERR_P0[0] - (RW) Enables queue command error interrupt status of port
0
* EN_Q_CMD_ERR_P1[1] - (RW) Enables queue command error interrupt status of port
1
* EN_Q_CMD_ERR_P2[2] - (RW) Enables queue command error interrupt status of port
2
...
* EN_DRR_STA_WLANID_ERR[30] - (RW) Enable DRR wlanid error when add/remove sta
interrupt.
* EN_DRR_STA_WMMID_ERR[31] - (RW) Enable DRR wmmid error when add/remove sta
interrupt.
*/
...
* EN_MDP_RDP_WB_HANG_ERR[10] - (RW) Enables MDP RDP Wait buffer FSM hang error
interrupt
...
#define WF_PLE_TOP_INT_N9_ERR_MASK_1_EN_UWTBL_HANG_ERR_MASK \
	0x00000800 /* EN_UWTBL_HANG_ERR[11] */
...
#define WF_PLE_TOP_INT_N9_ERR_MASK_1_EN_MDP_RDP_WB_HANG_ERR_MASK \
	0x00000400 /* EN_MDP_RDP_WB_HANG_ERR[10] */
...
* HOST_RPT_VER0_EN[2] - (RW) Enable control for host report roll back to Version
* 2(MT7915 E1 used).
* HOST_RPT_TX_LATENCY[3] - (RW) Enable host report TX latency
* WMCPU_MSDU_ID_NUM[5..4] - (RW) Configuration of WMCPU MSDU ID usage.
* RESERVED6[7..6] - (RO) Reserved bits
* HOST_RPT_PACK_TH[15..8] - (RW) The buffer threshold for packing host report.
* The buffer size less then the MSDU numbers of a MPDU, would let MSDU_ID lose.
...
* DIS_FL_DYN_CKG[0] - (RW) Disable control of PLE frame link module dynamic
* clock gating function
* DIS_PL_DYN_CKG[1] - (RW) Disable control of PLE page link module dynamic clock
* gating function
* DIS_CPU_PORT_DYN_CKG[2] - (RW) Disable control of PLE CPU port module dynamic
* clock gating function
* DIS_HIF_PORT_DYN_CKG[3] - (RW) Disable control of PLE HIF port module dynamic
* clock gating function
* DIS_WF_PORT_DYN_CKG[4] - (RW) Disable control of PLE LMAC module dynamic clock
* gating function
* DIS_RLS_DYN_CKG[5] - (RW) Disable control of PLE release module dynamic clock
* gating function
* DIS_RL_DYN_CKG[6] - (RW) Disable control of PLE relay information module
* dynamic clock gating function
* DIS_MACTX_DYN_CKG[7] - (RW) Disable control of PLE MACTX module dynamic clock
* gating function
* DIS_PSEPORT_DYN_CKG[8] - (RW) Disable control of PLE PSE port module dynamic
* clock gating function
* DIS_CSR_DYN_CKG[9] - (RW) Disable control of PLE CR module dynamic clock
* gating function
* DIS_CPU_WRAP_DYN_CKG[10] - (RW) Disable control of PLE CPU_WRAP module dynamic
* clock gating function
* DIS_DBG_DYN_CKG[11] - (RW) Disable control of PLE debug module dynamic clock
* gating function
* DIS_AMSDU_PORT_DYN_CKG[12] - (RW) Disable control of PLE AMSDU port module
* dynamic clock gating function
* RESERVED13[15..13] - (RO) Reserved bits
* DIS_UWTBL_DYN_CKG[16] - (RW) Disable control of UWTBL module dynamic clock
* gating function
* DIS_MDP_DYN_CKG[17] - (RW) Disable control of MDP module dynamic clock gating
function
* DIS_SEC_DYN_CKG[18] - (RW) Disable control of SEC module dynamic clock gating
function
* DIS_PF_DYN_CKG[19] - (RW) Disable control of PF module dynamic clock gating
function
* DIS_MUCOP_DYN_CKG[20] - (RW) Disable control of MUCOP module dynamic clock
* gating function
...
#define WF_PLE_TOP_PLE_MODULE_CKG_DIS_DIS_MUCOP_DYN_CKG_MASK \
	0x00100000 /* DIS_MUCOP_DYN_CKG[20] */
...
#define WF_PLE_TOP_PLE_MODULE_CKG_DIS_DIS_UWTBL_DYN_CKG_MASK \
	0x00010000 /* DIS_UWTBL_DYN_CKG[16] */
...
#define WF_PLE_TOP_PLE_MODULE_CKG_DIS_DIS_AMSDU_PORT_DYN_CKG_MASK \
	0x00001000 /* DIS_AMSDU_PORT_DYN_CKG[12] */
...
* DELAY_TX_PAGE_TH[11..0] - (RW) Delay TX function is used to delay TXD be LMAC
* used. If the total pages of TXD large than page threshold, the delay TX would
* be released. LMAC would use TXD to TX.
* RESERVED12[15..12] - (RO) Reserved bits
* DELAY_TX_TIMEOUT_TH[23..16] - (RW) Delay TX function is used to delay TXD be
* LMAC used. IF no more enqueue event in the time out threshold, the delay TX
...
* STA_REDIR_PASUE_TXD[8] - (RW) Pause TXD download for avoid race condition,
* when station redirection function turn off.
...
* not returning to IDLE
* PORT_IDLE_WD_TO_TH[23..16] - (RW) Watchdog timeout threshold for port oper FSM
* not returning to IDLE
...
* EN_FL_IDLE_WD_TO[0] - (RW) Enables watchdog for frame link FSM not returning
* to IDLE
* EN_PL_IDLE_WD_TO[1] - (RW) Enables watchdog for page link FSM not returning to
IDLE
* EN_CPU_PORT_IDLE_WD_TO[2] - (RW) Enables watchdog for CPU port oper FSM not
* returning to IDLE
* EN_HIF_PORT_IDLE_WD_TO[3] - (RW) Enables watchdog for HIF port oper FSM not
* returning to IDLE
* EN_LMAC_PORT_IDLE_WD_TO[4] - (RW) Enables watchdog for LMAC port oper FSM not
* returning to IDLE
...
* returning to IDLE
* RESERVED7[7] - (RO) Reserved bits
* EN_MACTX0_IDLE_WD_TO[8] - (RW) Enables watchdog for MACTX 0 FSM not returning
* to IDLE
* EN_MACTX2_IDLE_WD_TO[9] - (RW) Enables watchdog for MACTX 1 FSM not returning
* to IDLE
* EN_MACTX1_IDLE_WD_TO[10] - (RW) Enables watchdog for MACTX 2 FSM not returning
* to IDLE
* EN_MACTX3_IDLE_WD_TO[11] - (RW) Enables watchdog for MACTX 3 FSM not returning
* to IDLE
* EN_MDP_IDLE_WD_TO[12] - (RW) Enables watchdog for MDP port oper FSM not
* returning to IDLE
* EN_PREDL_ARB_IDLE_WD_TO[13] - (RW) Enables watchdog for Predl arbitrator FSM
* not returning to IDLE
...
* MDP_IDLE_WD_TO_TH[7..0] - (RW) Watchdog timeout threshold for MDP FSM not
* returning to IDLE
* (Including MDP TDP/RDP/TIOC/RIOC)
* PF_IDLE_WD_TO_TH[15..8] - (RW) Watchdog timeout threshold for PF FSM not
* returning to IDLE
* SEC_IDLE_WD_TO_TH[23..16] - (RW) Watchdog timeout threshold for SEC FSM not
* returning to IDLE
* (Including SEC0/SEC1)
* MDP_RDP_WB_IDLE_WD_TO_TH[31..24] - (RW) Watchdog timeout threshold for MDP RDP
* Wait buffer allocate FSM not returning to IDLE
*/
...
#define WF_PLE_TOP_FSM_IDLE_WD_CTRL_1_MDP_RDP_WB_IDLE_WD_TO_TH_MASK \
	0xFF000000 /* MDP_RDP_WB_IDLE_WD_TO_TH[31..24] */
...
* EN_BN0_MDP_TDP_IDLE_WD_TO[0] - (RW) Enables watchdog for Band0 MDP TDP FSM not
* returning to IDLE
* EN_MDP_RDP_IDLE_WD_TO[1] - (RW) Enables watchdog for MDP RDP FSM not returning
* to IDLE
...
* EN_SEC0_IDLE_WD_TO[5] - (RW) Enables watchdog for SEC0 FSM not returning to
IDLE
* RESERVED6[9..6] - (RO) Reserved bits
* EN_MDP_RDP_WB_IDLE_WD_TO[10] - (RW) Enables watchdog for MDP RDP Wait buffer
* allocate FSM not returning to IDLE
* EN_UWTBL_IDLE_WD_TO[11] - (RW) Enables watchdog for UWTBL FSM not returning to
IDLE
* RESERVED12[15..12] - (RO) Reserved bits
* UWTBL_IDLE_WD_TO_TH[23..16] - (RW) Watchdog timeout threshold for UWTBL FSM
* not returning to IDLE
* RESERVED24[31..24] - (RO) Reserved bits
*/
...
#define WF_PLE_TOP_FSM_IDLE_WD_EN_1_UWTBL_IDLE_WD_TO_TH_MASK \
	0x00FF0000 /* UWTBL_IDLE_WD_TO_TH[23..16] */
...
#define WF_PLE_TOP_FSM_IDLE_WD_EN_1_EN_UWTBL_IDLE_WD_TO_MASK \
	0x00000800 /* EN_UWTBL_IDLE_WD_TO[11] */
...
#define WF_PLE_TOP_FSM_IDLE_WD_EN_1_EN_MDP_RDP_WB_IDLE_WD_TO_MASK \
	0x00000400 /* EN_MDP_RDP_WB_IDLE_WD_TO[10] */
...
* STATION_PAUSE_0[7..0] - (RW) SW can stop station TX by this setting for
STA0~STA7.
...
#define WF_PLE_TOP_STATION_PAUSE0_STATION_PAUSE_0_MASK \
	0x000000FF /* STATION_PAUSE_0[7..0] */
...
#define WF_PLE_TOP_DIS_STA_MAP0_DIS_STA_MAP_0_MASK \
	0x000000FF /* DIS_STA_MAP_0[7..0] */
#define WF_PLE_TOP_DIS_STA_MAP0_DIS_STA_MAP_0_SHFT             0

/*
* ---STATION_REDIR0 (0x820C0000 + 0x180)---
* STATION_REDIR_0[7..0] - (RW) SW can redirection to designed port/queue by this
* setting for STA0~STA7.
* RESERVED8[31..8] - (RO) Reserved bits
*/
...
#define WF_PLE_TOP_STATION_REDIR0_STATION_REDIR_0_MASK \
	0x000000FF /* STATION_REDIR_0[7..0] */
...
* RESERVED0[0] - (RO) Reserved bits
* EN_BSSID_CHECK[1] - (RW) Enable control of check BSSID's trap state in search
station
* EN_LOCK_STA[2] - (RW) Lock mode for RTS retry same sta until RTS drop
* RESERVED3[7..3] - (RO) Reserved bits
* DIS_BSSID0_TRAP_IGNORE[8] - (RW) Disable control of the function that STA with
* BSSID0 trap ignore in TXQ busy
* DIS_BSSID1_TRAP_IGNORE[9] - (RW) Disable control of the function that STA with
* BSSID1 trap ignore in TXQ busy
...
* Bit[2] : report active
* Bit[3] : RX NAV countdown less threshold & TXD in Queue & ARB TX start & not
* pause condition
...
* MACTX_REQ_DEASSERT[0] - (RW) Enable of DeAsser MACTX REQ.(Normal operation
* must be zero.)
* MACTX_ABORT_DEASSERT[1] - (RW) Enable of DeAsser MACTX ABORT.(Normal operation
* must be zero.)
...
* RESERVED7[7] - (RO) Reserved bits
* MACTX_REQ_ASSERT[8] - (RW) Enable of Asser MACTX REQ.(Normal operation must be
zero.)
* MACTX_ABORT_ASSERT[9] - (RW) Enable of Asser MACTX ABORT.(Normal operation
* must be zero.)
...
* EN_HIF_PORT_ALLOC_BLOCKING[0] - (RW) Enable HIF/AMSDU port allocate operation
blocking.
...
* AMSDU_ERROR_INT[15] - (RO) HW AMSDU Error condition interrupt status, define
* by 0x1028
* DATA_TOGGLE[16] - (W1C) Interrupt status of data toggle of N9 toggle register
(0xf0)
* RESERVED17[17] - (RO) Reserved bits
...
* Q_CMD_ERR_P0[0] - (W1C) Queue command error interrupt status of port 0. Avoid
* unclear error flag, please clear flag when logic reset.
* Q_CMD_ERR_P1[1] - (W1C) Queue command error interrupt status of port 1. Avoid
* unclear error flag, please clear flag when logic reset.
* Q_CMD_ERR_P2[2] - (W1C) Queue command error interrupt status of port 2. Avoid
* unclear error flag, please clear flag when logic reset.
* PAGE_UDF_P0[3] - (W1C) Page underflow interrupt status of port 0. Avoid
* unclear error flag, please clear flag when logic reset.
* PAGE_UDF_P1[4] - (W1C) Page underflow interrupt status of port 1. Avoid
* unclear error flag, please clear flag when logic reset.
* PAGE_UDF_P2[5] - (W1C) Page underflow interrupt status of port 2. Avoid
* unclear error flag, please clear flag when logic reset.
* DOUBLE_RLS_ERR[6] - (W1C) Double release error interrupt. Avoid unclear error
* flag, please clear flag when logic reset.
* MDP_D_OPER_ERR[7] - (W1C) MDP data operation error interrupt. Avoid unclear
* error flag, please clear flag when logic reset.
* MDP_HANG_ERR[8] - (W1C) MDP FSM Hang error interrupt. Avoid unclear error
* flag, please clear flag when logic reset.
* RESERVED9[9] - (RO) Reserved bits
* DATA_OPER_ERR_P0[10] - (W1C) Data operation error of port 0. Avoid unclear
* error flag, please clear flag when logic reset.
* DATA_OPER_ERR_P1[11] - (W1C) Data operation error of port 1. Avoid unclear
* error flag, please clear flag when logic reset.
* DATA_OPER_ERR_P2[12] - (W1C) Data operation error of port 2. Avoid unclear
* error flag, please clear flag when logic reset.
* FL_HANG_ERR[13] - (W1C) Frame link FSM hang error interrupt. Avoid unclear
* error flag, please clear flag when logic reset.
* PL_HANG_ERR[14] - (W1C) Page link FSM hang error interrupt. Avoid unclear
* error flag, please clear flag when logic reset.
* HIF_HANG_ERR[15] - (W1C) HIF port FSM hang error interrupt. Avoid unclear
* error flag, please clear flag when logic reset.
* CPU_HANG_ERR[16] - (W1C) CPU port FSM hang error interrupt. Avoid unclear
* error flag, please clear flag when logic reset.
* LMAC_HANG_ERR[17] - (W1C) LMAC port FSM hang error interrupt. Avoid unclear
* error flag, please clear flag when logic reset.
* FREE_HEAD_TAIL_ERR[18] - (W1C) Free head/tail error interrupt. Avoid unclear
* error flag, please clear flag when logic reset.
* QSTRUCT_ERR[19] - (W1C) Queue struct data error interrupt. Avoid unclear error
* flag, please clear flag when logic reset.
* BN0_MACTX_HANG_ERR[20] - (W1C) BN0 MACTX Ctrl FSM Hang error interrupt. Avoid
* unclear error flag, please clear flag when logic reset.
* RESERVED21[21] - (RO) Reserved bits
* BN0_TXCMD_HANG_ERR[22] - (W1C) BN0 TXCMD Ctrl FSM Hang error interrupt. Avoid
* unclear error flag, please clear flag when logic reset.
* RESERVED23[23] - (RO) Reserved bits
* DRR_SRCH_DBDC0_ERR[24] - (W1C) DRR DBDC0 sta serach error interrupt. Avoid
* unclear error flag, please clear flag when logic reset.
* DRR_SRCH_DBDC1_ERR[25] - (W1C) DRR DBDC1 sta serach error interrupt. Avoid
* unclear error flag, please clear flag when logic reset.
* DRR_FL_ERR[26] - (W1C) DRR forward link access error interrupt. Avoid unclear
* error flag, please clear flag when logic reset.
* DRR_BL_ERR[27] - (W1C) DRR backward link access error interrupt. Avoid unclear
* error flag, please clear flag when logic reset.
* DRR_RL_ERR[28] - (W1C) DRR relay link access error interrupt. Avoid unclear
* error flag, please clear flag when logic reset.
* DRR_CHRG_STA_ERR[29] - (W1C) DRR charge wlanid error interrupt. Avoid unclear
* error flag, please clear flag when logic reset.
* DRR_STA_WLANID_ERR[30] - (W1C) DRR wlanid error interrupt. Avoid unclear error
* flag, please clear flag when logic reset.
* DRR_STA_WMMID_ERR[31] - (W1C) DRR wmmid error interrupt. Avoid unclear error
* flag, please clear flag when logic reset.
*/
...
* BN0_MDP_TDP_HANG_ERR[0] - (W1C) BN0 MDP TDP FSM hang error interrupt. Avoid
* unclear error flag, please clear flag when logic reset.
* MDP_RDP_HANG_ERR[1] - (W1C) MDP RDP FSM hang error interrupt. Avoid unclear
* error flag, please clear flag when logic reset.
* BN0_MDP_TIOC_HANG_ERR[2] - (W1C) BN0 MDP TIOC FSM hang error interrupt. Avoid
* unclear error flag, please clear flag when logic reset.
* BN0_MDP_RIOC_HANG_ERR[3] - (W1C) BN0 MDP RIOC FSM hang error interrupt. Avoid
* unclear error flag, please clear flag when logic reset.
* PF_HANG_ERR[4] - (W1C) PF FSM hang error interrupt. Avoid unclear error flag,
* please clear flag when logic reset.
* SEC0_HANG_ERR[5] - (W1C) SEC 0 FSM hang error interrupt. Avoid unclear error
* flag, please clear flag when logic reset.
* RESERVED6[9..6] - (RO) Reserved bits
* MDP_RDP_WB_HANG_ERR[10] - (W1C) MDP RDP wait buffer FSM hang error interrupt.
* Avoid unclear error flag, please clear flag when logic reset.
* UWTBL_HANG_ERR[11] - (W1C) UWTBL FSM hang error interrupt. Avoid unclear error
* flag, please clear flag when logic reset.
* BN0_RPEDL_ARB_HANG_ERR[12] - (W1C) BN0 PREDL ARB hang error interrupt. Avoid
* unclear error flag, please clear flag when logic reset.
* BN0_PREDL_TXCMD_HANG_ERR[13] - (W1C) BN0 PREDL TXCDM FSM hang error interrupt.
* Avoid unclear error flag, please clear flag when logic reset.
* BN1_RPEDL_ARB_HANG_ERR[14] - (W1C) BN1 PREDL ARB hang error interrupt. Avoid
* unclear error flag, please clear flag when logic reset.
* BN1_PREDL_TXCMD_HANG_ERR[15] - (W1C) BN1 PREDL TXCDM FSM hang error interrupt.
* Avoid unclear error flag, please clear flag when logic reset.
* RESERVED16[31..16] - (RO) Reserved bits
*/
...
#define WF_PLE_TOP_INT_N9_ERR_STS_1_MDP_RDP_WB_HANG_ERR_MASK \
	0x00000400 /* MDP_RDP_WB_HANG_ERR[10] */
...
#define WF_PLE_TOP_QUEUE_EMPTY_AMSDU_PNSN_EMPTY_MASK \
	0x00200000 /* AMSDU_PNSN_EMPTY[21] */
...
* PKT_LEN[11..1] - (RO) Length of the packet with head page being the relay
* buffer address
* Unit: 32 bytes
* PKT_TAIL_PAGE[23..12] - (RO) Tail page of the packet with head page being the
...
* QUEUE_HEAD_FID[11..0] - (RO) Head frame ID of the quest queue setting in
0x01b0[15:0]
* RESERVED12[15..12] - (RO) Reserved bits
* QUEUE_TAIL_FID[27..16] - (RO) Tail frame ID of the quest queue setting in
0x01b0[15:0]
* RESERVED28[31..28] - (RO) Reserved bits
*/
...
* QUEUE_PKT_NUM[11..0] - (RO) Total packet number of the queue setting in
0x1b0[15:0]
* RESERVED12[31..12] - (RO) Reserved bits
*/
...
* HIF_ENQ_CPU_PKT_NUM[15..0] - (RO) Packet number of HIF enqueue to CPU, just
* keep in 16bits.
* HIF_ENQ_LMAC_PKT_NUM[31..16] - (RO) Packet number of HIF enqueue to LMAC, just
* keep in 16 bits
*/
...
* CPU_ENQ_LMAC_PKT_NUM[15..0] - (RO) Packet number of CPU enqueue to LMAC, just
* keep in 16 bits.
...
* RSL_TXD_NUM[15..0] - (RO) All TXD number of release function, include the no
* host report(not CT) TXD packets.
* HOST_REPORT_NUM[31..16] - (RO) Host report number that be the PSE packets
* carry release MSDU_ID information
*/
...
* PLE_DBG_FLAG_A_BYTE0_SEL[7..0] - (RW) Debug flag selection of PLE debug A byte
0
...
* PLE_DBG_FLAG_B_BYTE0_SEL[7..0] - (RW) Debug flag selection of PLE debug B byte
0
...
* WRITE_MASK[15..12] - (RW) DRR table will not be updated if mask write bits are
enabled.
* MODE[23..16] - (RW) Operation mode for DRR table
* WRITE_MASK_2[27..24] - (RW) DRR table will not be updated if mask write bits
* are enabled.
* RESERVED28[30..28] - (RO) Reserved bits
...
* CMD_FULL_CHNL_DL[15..0] - (RW) Hardware search command full flag of 16 backoff
* channel of downlink
...
#define WF_PLE_TOP_AC0_QUEUE_EMPTY0_AC0_QUEUE_EMPTY_0_MASK \
	0x000000FF /* AC0_QUEUE_EMPTY_0[7..0] */
...
#define WF_PLE_TOP_AC1_QUEUE_EMPTY0_AC1_QUEUE_EMPTY_0_MASK \
	0x000000FF /* AC1_QUEUE_EMPTY_0[7..0] */
...
#define WF_PLE_TOP_AC2_QUEUE_EMPTY0_AC2_QUEUE_EMPTY_0_MASK \
	0x000000FF /* AC2_QUEUE_EMPTY_0[7..0] */
...
#define WF_PLE_TOP_AC3_QUEUE_EMPTY0_AC3_QUEUE_EMPTY_0_MASK \
	0x000000FF /* AC3_QUEUE_EMPTY_0[7..0] */
...
#define WF_PLE_TOP_AMSDU_GC_EN_AMSDU_PNSN_QUEUE_MASK_MASK \
	0x00000004 /* EN_AMSDU_PNSN_QUEUE_MASK[2] */
...
#define WF_PLE_TOP_AMSDU_GC_EN_AMSDU_PASTE_COMM_SN_MASK \
	0x00000002 /* EN_AMSDU_PASTE_COMM_SN[1] */
...
* AMSDU_DOP_PBUF_CS[2..0] - (RO) PLE AMSDU port - Data operation PBUF current
state.
* RESERVED3[3] - (RO) Reserved bits
* AMSDU_DOP_CACHE_CS[5..4] - (RO) PLE AMSDU port - Data operation CACHE current
state.
* RESERVED6[7..6] - (RO) Reserved bits
* AMSDU_QOP_Q_OPER_CS[11..8] - (RO) PLE AMSDU port - Queue operation current
state.
* AMSDU_QOP_RL_OCP_CS[13..12] - (RO) PLE AMSDU port - Queue operation RL current
state.
* RESERVED14[15..14] - (RO) Reserved bits
* AMSDU_QOP_PL_OCP_CS[17..16] - (RO) PLE AMSDU port - Queue operation PL current
state.
* RESERVED18[19..18] - (RO) Reserved bits
* AMSDU_QOP_ALLOCATE_CS[22..20] - (RO) PLE AMSDU port - Queue operation allocate
* current state.
* RESERVED23[31..23] - (RO) Reserved bits
*/
...
* SYSRAM_MBIST_DEBUG[15..0] - (RW) Control register for mbist_debug of SYSRAM
MBIST
* RESERVED16[31..16] - (RO) Reserved bits
*/
...
* SYSRAM_MBIST_MODE[15..0] - (RW) Control register for mbist_holdb of SYSRAM
MBIST
* RESERVED16[31..16] - (RO) Reserved bits
*/
...
* SYSRAM_MBIST_HOLDB[15..0] - (RW) Control register for mbist_holdb of sysram
MBIST
* RESERVED16[31..16] - (RO) Reserved bits
*/
...
* SYSRAM_MBIST_SLEEP_TEST[15..0] - (RW) Control register for sleep_test of group
* 3 MBIST
* RESERVED16[31..16] - (RO) Reserved bits
*/
...
* SYSRAM_MBIST_SLEEP_INV[15..0] - (RW) Control register for sleep_inv of group 3
MBIST
* RESERVED16[31..16] - (RO) Reserved bits
*/
...
* SYSRAM_MBIST_SLEEP_WRITE[15..0] - (RW) Control register for sleep_w of group 3
MBIST
* RESERVED16[31..16] - (RO) Reserved bits
*/
...
* SYSRAM_MBIST_SLEEP_READ[15..0] - (RW) Control register for sleep_r of group 3
MBIST
* RESERVED16[31..16] - (RO) Reserved bits
*/
