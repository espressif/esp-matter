...
#define mdnslogInfo(M, ...)    LogMsg("i " M, ##__VA_ARGS__)
#define mdnslogWarning(M, ...) LogMsg("w " M, ##__VA_ARGS__)
#define mdnslogError(M, ...)   LogMsg("e " M, ##__VA_ARGS__)
#define mdnslogDebug(M, ...)   LogMsg("d " M, ##__VA_ARGS__)

//#define mdnslogInfo(M, ...)    LogMsgWithLevelv(MDNS_LOG_INFO,  M "\n", ##__VA_ARGS__)
//#define mdnslogWarning(M, ...) LogMsgWithLevelv(MDNS_LOG_MSG,   M "\n", ##__VA_ARGS__)
//#define mdnslogError(M, ...)   LogMsgWithLevelv(MDNS_LOG_MSG,   M "\n", ##__VA_ARGS__)
//#define mdnslogDebug(M, ...)   LogMsgWithLevelv(MDNS_LOG_DEBUG, M "\n", ##__VA_ARGS__)
