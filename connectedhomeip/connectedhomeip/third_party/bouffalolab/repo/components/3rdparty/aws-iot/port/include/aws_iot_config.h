...
#define CONFIG_AWS_IOT_MQTT_HOST "ap3im43fimllm-ats.iot.us-east-1.amazonaws.com"
...
#define AWS_IOT_MQTT_HOST              "ap3im43fimllm-ats.iot.us-east-1.amazonaws.com" ///< Customer specific MQTT HOST. The same will be used for Thing Shadow
#define AWS_IOT_MQTT_PORT              443 ///< default port for MQTT/S
//#define AWS_IOT_MQTT_CLIENT_ID         "c-sdk-client-id-abc123" ///< MQTT client ID should be unique for every device
#define AWS_IOT_MQTT_CLIENT_ID 		   "bl60xDevRjwang" ///< Thing Name of the Shadow this device is associated with
#define AWS_IOT_MY_THING_NAME 		   "bl60xDevRjwang" ///< Thing Name of the Shadow this device is associated with
