 ...
 */
#ifndef BLCRYPTO_SUITE_BN_MUL_H
...
#if defined(BLCRYPTO_SUITE_HAVE_SSE2)
...
#define MULADDC_INIT                    \
{                                       \
    blcrypto_suite_t_udbl r;                           \
    blcrypto_suite_mpi_uint r0, r1;

#define MULADDC_CORE                    \
    r   = *(s++) * (blcrypto_suite_t_udbl) b;          \
    r0  = (blcrypto_suite_mpi_uint) r;                   \
    r1  = (blcrypto_suite_mpi_uint)( r >> biL );         \
    r0 += c;  r1 += (r0 <  c);          \
    r0 += *d; r1 += (r0 < *d);          \
    c = r1; *(d++) = r0;
...
#define MULADDC_INIT                    \
{                                       \
    blcrypto_suite_mpi_uint s0, s1, b0, b1;              \
    blcrypto_suite_mpi_uint r0, r1, rx, ry;              \
    b0 = ( b << biH ) >> biH;           \
    b1 = ( b >> biH );
