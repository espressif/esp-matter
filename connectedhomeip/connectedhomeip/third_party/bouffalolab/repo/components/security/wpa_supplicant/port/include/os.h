...
#ifndef os_malloc
#define os_malloc(s) wpa_supplicant_malloc((s))
#endif
#ifndef os_realloc
#define os_realloc(p, s) wpa_supplicant_realloc((p), (s))
#endif
#ifndef os_zalloc
#define os_zalloc(s) wpa_supplicant_zalloc(1, (s))
#endif
#ifndef os_calloc
#define os_calloc(p, s) wpa_supplicant_zalloc((p), (s))
#endif

#ifndef os_free
#define os_free(p) wpa_supplicant_free((p))
#endif

#ifndef os_bzero
#define os_bzero(s, n) wpa_supplicant_bzero(s, n)
#endif
