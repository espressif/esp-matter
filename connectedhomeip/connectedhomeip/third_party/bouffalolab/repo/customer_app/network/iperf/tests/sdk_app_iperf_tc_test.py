...
@TinyFW.test_method(app=BL602App.BL602App, dut=BL602DUT.BL602TyMbDUT, test_suite_name='sdk_app_iperf_tc')
def sdk_app_iperf_tc(env, extra_data):
    # first, flash dut
    # then, test
    ...
    try:
        dut.expect("Booting BL606p Chip...", timeout=1)
        print('BL602 booted')
        ...
        print('ENV_TEST_FAILURE: BL602 iperf test failed')
        raise
