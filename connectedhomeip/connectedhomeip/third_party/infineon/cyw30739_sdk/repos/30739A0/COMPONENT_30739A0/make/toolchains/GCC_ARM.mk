...
#
CY_TOOLCHAIN_DEPENDENCIES=-MMD -MP -MF "$(@:$(CY_TOOLCHAIN_SUFFIX_O)=$(CY_TOOLCHAIN_SUFFIX_D))" -MT "$@"
CY_TOOLCHAIN_EXPLICIT_DEPENDENCIES=-MMD -MP -MF "$$(@:$(CY_TOOLCHAIN_SUFFIX_O)=$(CY_TOOLCHAIN_SUFFIX_D))" -MT "$$@"
