...
#define IOT_PWM_CFG_LED0_PERIPHERAL              TIMER1
#define IOT_PWM_CFG_LED0_PERIPHERAL_NO           1


// TIMER1 CC1 on PD7
#define IOT_PWM_CFG_LED0_CC1_PORT                gpioPortD
#define IOT_PWM_CFG_LED0_CC1_PIN                 7
#define IOT_PWM_CFG_LED0_ROUTE_LOC               4
