...
#define IOT_UART_CFG_EXP_PERIPHERAL              UART0
#define IOT_UART_CFG_EXP_PERIPHERAL_NO           0

// UART0 TX on PC14
#define IOT_UART_CFG_EXP_TX_PORT                 gpioPortC
#define IOT_UART_CFG_EXP_TX_PIN                  14
#define IOT_UART_CFG_EXP_TX_LOC                  3

// UART0 RX on PC15
#define IOT_UART_CFG_EXP_RX_PORT                 gpioPortC
#define IOT_UART_CFG_EXP_RX_PIN                  15
#define IOT_UART_CFG_EXP_RX_LOC                  3
