 ...
 * @param tarrif pointer to  the scheduled tarrif struct
 *
 */
void emberAfPricePrintTariff(const EmberAfPriceCommonInfo *info,
                             const EmberAfScheduledTariff *tariff);

/** @brief print tarrig table
 *
 * @param endpoint relevant endpoint
 *
 */
 ...
 *
 * @param endpoint relevent endpoint
 *
 */
 ...
 * @param endpoint relevant endpoint
 *
 * @return unit32_t seconds until next tarrif info event
 *
 */
uint32_t emberAfPriceServerSecondsUntilTariffInfoEvent(uint8_t endpoint);

/** @brief Refresh tarrif information
 *
 * @param endpoint relevant endpoint
 *
 */
...
/** @brief Add a tarrif table entry
 *
 * @param endpoint relevant endpoint
 * @param info pointer to common info struct
 * @param curTariff pointer to scheduled tarrif struct
 *
