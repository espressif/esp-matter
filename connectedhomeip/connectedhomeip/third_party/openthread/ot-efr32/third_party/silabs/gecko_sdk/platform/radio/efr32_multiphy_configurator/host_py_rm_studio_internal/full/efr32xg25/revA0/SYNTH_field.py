...
class RM_Field_SYNTH_SFMIF_LOCKEDSFMIF(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_SYNTH_SFMIF_LOCKEDSFMIF, self).__init__(register,
            'LOCKEDSFMIF', 'SYNTH.SFMIF.LOCKEDSFMIF', 'read-write',
            u"",
            0, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_SYNTH_SFMIF_UNLOCKEDSFMIF(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_SYNTH_SFMIF_UNLOCKEDSFMIF, self).__init__(register,
            'UNLOCKEDSFMIF', 'SYNTH.SFMIF.UNLOCKEDSFMIF', 'read-write',
            u"",
            1, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_SYNTH_SFMIF_SYRDYSFMIF(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_SYNTH_SFMIF_SYRDYSFMIF, self).__init__(register,
            'SYRDYSFMIF', 'SYNTH.SFMIF.SYRDYSFMIF', 'read-write',
            u"",
            2, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_SYNTH_SFMIF_VCOHIGHSFMIF(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_SYNTH_SFMIF_VCOHIGHSFMIF, self).__init__(register,
            'VCOHIGHSFMIF', 'SYNTH.SFMIF.VCOHIGHSFMIF', 'read-write',
            u"",
            4, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_SYNTH_SFMIF_VCOLOWSFMIF(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_SYNTH_SFMIF_VCOLOWSFMIF, self).__init__(register,
            'VCOLOWSFMIF', 'SYNTH.SFMIF.VCOLOWSFMIF', 'read-write',
            u"",
            5, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_SYNTH_SFMIF_LOCNTDONESFMIF(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_SYNTH_SFMIF_LOCNTDONESFMIF, self).__init__(register,
            'LOCNTDONESFMIF', 'SYNTH.SFMIF.LOCNTDONESFMIF', 'read-write',
            u"",
            9, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_SYNTH_SFMIEN_LOCKEDSFMIEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_SYNTH_SFMIEN_LOCKEDSFMIEN, self).__init__(register,
            'LOCKEDSFMIEN', 'SYNTH.SFMIEN.LOCKEDSFMIEN', 'read-write',
            u"",
            0, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_SYNTH_SFMIEN_UNLOCKEDSFMIEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_SYNTH_SFMIEN_UNLOCKEDSFMIEN, self).__init__(register,
            'UNLOCKEDSFMIEN', 'SYNTH.SFMIEN.UNLOCKEDSFMIEN', 'read-write',
            u"",
            1, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_SYNTH_SFMIEN_SYRDYSFMIEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_SYNTH_SFMIEN_SYRDYSFMIEN, self).__init__(register,
            'SYRDYSFMIEN', 'SYNTH.SFMIEN.SYRDYSFMIEN', 'read-write',
            u"",
            2, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_SYNTH_SFMIEN_VCOHIGHSFMIEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_SYNTH_SFMIEN_VCOHIGHSFMIEN, self).__init__(register,
            'VCOHIGHSFMIEN', 'SYNTH.SFMIEN.VCOHIGHSFMIEN', 'read-write',
            u"",
            4, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_SYNTH_SFMIEN_VCOLOWSFMIEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_SYNTH_SFMIEN_VCOLOWSFMIEN, self).__init__(register,
            'VCOLOWSFMIEN', 'SYNTH.SFMIEN.VCOLOWSFMIEN', 'read-write',
            u"",
            5, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_SYNTH_SFMIEN_LOCNTDONESFMIEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_SYNTH_SFMIEN_LOCNTDONESFMIEN, self).__init__(register,
            'LOCNTDONESFMIEN', 'SYNTH.SFMIEN.LOCNTDONESFMIEN', 'read-write',
            u"",
            9, 1)
        self.__dict__['zz_frozen'] = True
