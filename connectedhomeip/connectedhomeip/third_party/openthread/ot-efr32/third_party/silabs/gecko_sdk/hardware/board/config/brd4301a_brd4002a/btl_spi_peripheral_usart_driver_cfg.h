...
// USART0 TX on PB11
#define SL_USART_SPINCP_TX_PORT                  gpioPortB
#define SL_USART_SPINCP_TX_PIN                   11
#define SL_USART_SPINCP_TX_LOC                   6

// USART0 RX on PB12
#define SL_USART_SPINCP_RX_PORT                  gpioPortB
#define SL_USART_SPINCP_RX_PIN                   12
#define SL_USART_SPINCP_RX_LOC                   6

// USART0 CS on PD13
#define SL_USART_SPINCP_CS_PORT                  gpioPortD
#define SL_USART_SPINCP_CS_PIN                   13
#define SL_USART_SPINCP_CS_LOC                   18

// USART0 CLK on PB13
#define SL_USART_SPINCP_CLK_PORT                 gpioPortB
#define SL_USART_SPINCP_CLK_PIN                  13
#define SL_USART_SPINCP_CLK_LOC                  6
