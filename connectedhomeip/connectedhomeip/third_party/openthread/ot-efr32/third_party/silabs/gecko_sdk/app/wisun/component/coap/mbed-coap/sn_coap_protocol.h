 ...
 *
 * \brief Initialize CoAP Protocol part. When using libNsdl, sn_nsdl_init() calls this function.
 *
 ...
 *
 * \brief Free all memory from CoAP protocol part.
 *
 ...
 *
 * \brief Build Packet data from given CoAP header structure to be sent.
 *
 ...
 *
 * \brief Parse received CoAP message from given Packet data.
 *
 * \param *src_addr_ptr is pointer to source address of received CoAP message
 *        (CoAP parser needs that information for Message acknowledgment)
 *
 * \param *handle Pointer to CoAP library handle
 *
 ...
 *
 * \brief Send CoAP messages from re-sending queue, if there is any.
 ...
 *
 * \brief If duplicate message detection is enabled, this function changes buffer size.
 *
 ...
 *
 * \param uint8_t resending_count max number of resent  messages
 * \param uint8_t resending_intervall message resending interval in seconds
 ...
 *
 * \param handle Pointer to CoAP library handle
 * \param source_address Address from where the block has been received.
 ...
 *
 * \brief Change the state whether CoAP library sends the block 2 response automatically or not.
 *
 * \param *handle Pointer to CoAP library handle
 ...
 *
 * \brief Clear all the sent blockwise messages from the linked list.
 *
 * \param *handle Pointer to CoAP library handle
 */
 ...
 *
 * \brief Clear all the received blockwise messages from the linked list.
 *
 * \param *handle Pointer to CoAP library handle
 */
 ...
 *
 * \brief Remove stored Duplication info from Linked list.
 *
 * \param *handle Pointer to CoAP library handle
