...
class z_wave_ANZ_validation_testing(IProtocol):

    def get_model(self):
        mphy_config = multi_phy_configuration(part_family="nerio",
                                                 part_revision="A0",
                                                 desc="z_wave_ANZ_validation_testing",
                                                 rail_adapter_version="rail_api_2.x",
                                                 xsd_version=MultiPHYConfig.xsd_version(),
                                                 status_code=ModelDiffCodes.OK.value,
                                                 readable_name="Z-wave ANZ validation testing")

        base_channel_configuration = base_channel_configurationType(name="Z-Wave ANZ validation testing with 3 Channels", profile=None)
        phy_name = ""
        ...
        channel_config_entry = channel_config_entryType(name="PHY_ZWave_100kbps_916MHz_ANZ_ch0",
                                            phy_name_override="PHY_ZWave_100kbps_916MHz",
                                            base_frequency=919.8e6,
                                            channel_spacing=0,
        ...
        channel_config_entry = channel_config_entryType(name="PHY_ZWave_40kbps_908MHz_ANZ_ch1",
                                            phy_name_override="PHY_ZWave_40kbps_908MHz",
                                            base_frequency=921.4e6,
                                            channel_spacing=0,
        ...
        channel_config_entry = channel_config_entryType(name="PHY_ZWave_9p6kbps_908MHz_ANZ_ch2",
                                            phy_name_override="PHY_ZWave_9p6kbps_908MHz",
                                            base_frequency=921.42e6,
                                            channel_spacing=0,
