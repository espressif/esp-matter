...
#define IOT_UART_CFG_LOOPBACK_PERIPHERAL         USART4
#define IOT_UART_CFG_LOOPBACK_PERIPHERAL_NO      4

// USART4 TX on PH4
#define IOT_UART_CFG_LOOPBACK_TX_PORT            gpioPortH
#define IOT_UART_CFG_LOOPBACK_TX_PIN             4
#define IOT_UART_CFG_LOOPBACK_TX_LOC             4

// USART4 RX on PH5
#define IOT_UART_CFG_LOOPBACK_RX_PORT            gpioPortH
#define IOT_UART_CFG_LOOPBACK_RX_PIN             5
#define IOT_UART_CFG_LOOPBACK_RX_LOC             4



// USART4 RTS on PH9
#define IOT_UART_CFG_LOOPBACK_RTS_PORT           gpioPortH
#define IOT_UART_CFG_LOOPBACK_RTS_PIN            9
#define IOT_UART_CFG_LOOPBACK_RTS_LOC            4

// USART4 CTS on PH8
#define IOT_UART_CFG_LOOPBACK_CTS_PORT           gpioPortH
#define IOT_UART_CFG_LOOPBACK_CTS_PIN            8
#define IOT_UART_CFG_LOOPBACK_CTS_LOC            4
