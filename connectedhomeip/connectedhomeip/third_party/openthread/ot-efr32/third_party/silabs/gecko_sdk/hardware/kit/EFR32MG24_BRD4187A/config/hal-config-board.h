...
// $[EUART1]
#define PORTIO_EUART1_RX_PIN                          (9U)
#define PORTIO_EUART1_RX_PORT                         (gpioPortA)

#define PORTIO_EUART1_TX_PIN                          (8U)
#define PORTIO_EUART1_TX_PORT                         (gpioPortA)

#define BSP_EUART1_TX_PIN                             (8U)
#define BSP_EUART1_TX_PORT                            (gpioPortA)

#define BSP_EUART1_RX_PIN                             (9U)
#define BSP_EUART1_RX_PORT                            (gpioPortA)
