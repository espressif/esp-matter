...
void emAfPluginDeviceDatabasePrintAll(sl_cli_command_arg_t *arguments)
{
  uint8_t i;
...
void emAfPluginDeviceDatabasePrintDevice(sl_cli_command_arg_t *arguments)
{
  EmberEUI64 eui64;
...
void emAfPluginDeviceDatabaseAddDummyDevice(sl_cli_command_arg_t *arguments)
{
...
void emAfPluginDeviceDatabaseErase(sl_cli_command_arg_t *arguments)
{
  EmberEUI64 eui64;
