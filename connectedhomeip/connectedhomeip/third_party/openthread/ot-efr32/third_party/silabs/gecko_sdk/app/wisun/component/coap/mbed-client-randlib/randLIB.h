...
/**
 * This library gets random numbers for Timing needs in protocols.
 *
 ...
 *
 * Call the platform's arm_random_seed_get() to seed the
 ...
 *
 * Add seed information to the existing generator to perturb the
 * sequence.
...
/**
 * \brief Randomize a base 32-bit number by a jitter factor.
 *
