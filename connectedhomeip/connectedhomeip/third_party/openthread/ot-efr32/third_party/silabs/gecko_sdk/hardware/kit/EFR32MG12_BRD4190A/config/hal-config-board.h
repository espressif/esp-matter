...
#define BSP_EZRADIOPRO_CS_PIN                         (10U)
#define BSP_EZRADIOPRO_CS_PORT                        (gpioPortD)

#define BSP_EZRADIOPRO_INT_PIN                        (11U)
#define BSP_EZRADIOPRO_INT_PORT                       (gpioPortD)

#define BSP_EZRADIOPRO_SDN_PIN                        (12U)
#define BSP_EZRADIOPRO_SDN_PORT                       (gpioPortD)

#define BSP_EZRADIOPRO_USART                          (HAL_SPI_PORT_USART1)
#define BSP_EZRADIOPRO_MOSI_PIN                       (6U)
#define BSP_EZRADIOPRO_MOSI_PORT                      (gpioPortC)
#define BSP_EZRADIOPRO_MOSI_LOC                       (11U)

#define BSP_EZRADIOPRO_MISO_PIN                       (7U)
#define BSP_EZRADIOPRO_MISO_PORT                      (gpioPortC)
#define BSP_EZRADIOPRO_MISO_LOC                       (11U)

#define BSP_EZRADIOPRO_CLK_PIN                        (8U)
#define BSP_EZRADIOPRO_CLK_PORT                       (gpioPortC)
#define BSP_EZRADIOPRO_CLK_LOC                        (11U)
