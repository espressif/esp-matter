...
// LEUART0 TX on PA0
#define SL_IOSTREAM_LEUART_EXP_TX_PORT           gpioPortA
#define SL_IOSTREAM_LEUART_EXP_TX_PIN            0
#define SL_IOSTREAM_LEUART_EXP_TX_LOC            0

// LEUART0 RX on PA1
#define SL_IOSTREAM_LEUART_EXP_RX_PORT           gpioPortA
#define SL_IOSTREAM_LEUART_EXP_RX_PIN            1
#define SL_IOSTREAM_LEUART_EXP_RX_LOC            0
