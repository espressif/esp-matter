...
// USART0 TX on PE7
#define IOT_UART_CFG_LOOPBACK_TX_PORT            gpioPortE
#define IOT_UART_CFG_LOOPBACK_TX_PIN             7
#define IOT_UART_CFG_LOOPBACK_TX_LOC             1

// USART0 RX on PE6
#define IOT_UART_CFG_LOOPBACK_RX_PORT            gpioPortE
#define IOT_UART_CFG_LOOPBACK_RX_PIN             6
#define IOT_UART_CFG_LOOPBACK_RX_LOC             1



// USART0 RTS on PB5
#define IOT_UART_CFG_LOOPBACK_RTS_PORT           gpioPortB
#define IOT_UART_CFG_LOOPBACK_RTS_PIN            5
