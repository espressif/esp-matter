...
// USART2 TX on PK0
#define SL_NCP_SPIDRV_USART_TX_PORT              gpioPortK
#define SL_NCP_SPIDRV_USART_TX_PIN               0
#define SL_NCP_SPIDRV_USART_TX_LOC               29

// USART2 RX on PK2
#define SL_NCP_SPIDRV_USART_RX_PORT              gpioPortK
#define SL_NCP_SPIDRV_USART_RX_PIN               2
#define SL_NCP_SPIDRV_USART_RX_LOC               30

// USART2 CLK on PF7
#define SL_NCP_SPIDRV_USART_CLK_PORT             gpioPortF
#define SL_NCP_SPIDRV_USART_CLK_PIN              7
#define SL_NCP_SPIDRV_USART_CLK_LOC              18

// USART2 CS on PA5
#define SL_NCP_SPIDRV_USART_CS_PORT              gpioPortA
#define SL_NCP_SPIDRV_USART_CS_PIN               5
#define SL_NCP_SPIDRV_USART_CS_LOC               29
