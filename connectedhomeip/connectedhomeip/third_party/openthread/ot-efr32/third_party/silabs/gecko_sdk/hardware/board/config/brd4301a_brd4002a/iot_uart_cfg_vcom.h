...
#define IOT_UART_CFG_VCOM_TX_LOC                 0

// USART0 RX on PA1
#define IOT_UART_CFG_VCOM_RX_PORT                gpioPortA
#define IOT_UART_CFG_VCOM_RX_PIN                 1
#define IOT_UART_CFG_VCOM_RX_LOC                 0



// USART0 RTS on PF3
#define IOT_UART_CFG_VCOM_RTS_PORT               gpioPortF
#define IOT_UART_CFG_VCOM_RTS_PIN                3
#define IOT_UART_CFG_VCOM_RTS_LOC                22

// USART0 CTS on PF2
#define IOT_UART_CFG_VCOM_CTS_PORT               gpioPortF
#define IOT_UART_CFG_VCOM_CTS_PIN                2
#define IOT_UART_CFG_VCOM_CTS_LOC                22
