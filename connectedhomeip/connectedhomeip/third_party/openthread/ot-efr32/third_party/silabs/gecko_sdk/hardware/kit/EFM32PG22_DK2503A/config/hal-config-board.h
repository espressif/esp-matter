...
#define BSP_I2CSENSOR_ENABLE_PIN             (6U)
...
// $[PDM]
#define PORTIO_PDM_CLK_PIN                   (0U)
#define PORTIO_PDM_CLK_PORT                  (gpioPortB)

#define PORTIO_PDM_DAT0_PIN                  (1U)
#define PORTIO_PDM_DAT0_PORT                 (gpioPortB)

#define BSP_PDM_CLK_PIN                      (0U)
#define BSP_PDM_CLK_PORT                     (gpioPortB)

#define BSP_PDM_DAT0_PIN                     (1U)
#define BSP_PDM_DAT0_PORT                    (gpioPortB)
...
// $[Custom pin names]
#define MIC_ENABLE_PIN                       (7U)
#define MIC_ENABLE_PORT                      (gpioPortC)

#define IMU_CS_PIN                           (2U)
#define IMU_CS_PORT                          (gpioPortB)

#define IMU_INT_PIN                          (0U)
#define IMU_INT_PORT                         (gpioPortA)

#define IMU_ENABLE_PIN                       (4U)
#define IMU_ENABLE_PORT                      (gpioPortB)

#define MIC_CLK_PIN                          (0U)
#define MIC_CLK_PORT                         (gpioPortB)

#define MIC_DATA_PIN                         (1U)
