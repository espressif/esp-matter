...
#define SL_IOSTREAM_USART_EXP_TX_PIN             14
#define SL_IOSTREAM_USART_EXP_TX_LOC             3

// UART0 RX on PC15
#define SL_IOSTREAM_USART_EXP_RX_PORT            gpioPortC
#define SL_IOSTREAM_USART_EXP_RX_PIN             15
#define SL_IOSTREAM_USART_EXP_RX_LOC             3
