...
#define SL_NCP_SPIDRV_USART_TX_LOC               2

// USART0 RX on PC10
#define SL_NCP_SPIDRV_USART_RX_PORT              gpioPortC
#define SL_NCP_SPIDRV_USART_RX_PIN               10
#define SL_NCP_SPIDRV_USART_RX_LOC               2

// USART0 CLK on PA12
#define SL_NCP_SPIDRV_USART_CLK_PORT             gpioPortA
#define SL_NCP_SPIDRV_USART_CLK_PIN              12
#define SL_NCP_SPIDRV_USART_CLK_LOC              5

// USART0 CS on PC8
#define SL_NCP_SPIDRV_USART_CS_PORT              gpioPortC
#define SL_NCP_SPIDRV_USART_CS_PIN               8
#define SL_NCP_SPIDRV_USART_CS_LOC               2
