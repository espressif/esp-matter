...
class RM_Field_MODEM_IRCALCOEFWR_CRVWD(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_IRCALCOEFWR_CRVWD, self).__init__(register,
            'CRVWD', 'MODEM.IRCALCOEFWR.CRVWD', 'read-write',
            u"",
            0, 15)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_IRCALCOEFWR_CRVWEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_IRCALCOEFWR_CRVWEN, self).__init__(register,
            'CRVWEN', 'MODEM.IRCALCOEFWR.CRVWEN', 'read-write',
            u"",
            15, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_IRCALCOEFWR_CIVWD(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_IRCALCOEFWR_CIVWD, self).__init__(register,
            'CIVWD', 'MODEM.IRCALCOEFWR.CIVWD', 'read-write',
            u"",
            16, 15)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_IRCALCOEFWR_CIVWEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_IRCALCOEFWR_CIVWEN, self).__init__(register,
            'CIVWEN', 'MODEM.IRCALCOEFWR.CIVWEN', 'read-write',
            u"",
            31, 1)
        self.__dict__['zz_frozen'] = True
