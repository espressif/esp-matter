...
#define LEGACY_NCP_SPI_TX_LOC                    2

// USART0 RX on PC10
#define LEGACY_NCP_SPI_RX_PORT                   gpioPortC
#define LEGACY_NCP_SPI_RX_PIN                    10
#define LEGACY_NCP_SPI_RX_LOC                    2

// USART0 CLK on PA12
#define LEGACY_NCP_SPI_CLK_PORT                  gpioPortA
#define LEGACY_NCP_SPI_CLK_PIN                   12
#define LEGACY_NCP_SPI_CLK_LOC                   5

// USART0 CS on PC8
#define LEGACY_NCP_SPI_CS_PORT                   gpioPortC
#define LEGACY_NCP_SPI_CS_PIN                    8
#define LEGACY_NCP_SPI_CS_LOC                    2
