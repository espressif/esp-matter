...
// LEUART0 TX on PF2
#define SL_IOSTREAM_LEUART_VCOM_TX_PORT          gpioPortF
#define SL_IOSTREAM_LEUART_VCOM_TX_PIN           2
#define SL_IOSTREAM_LEUART_VCOM_ROUTE_LOC        4

// LEUART0 RX on PA0
#define SL_IOSTREAM_LEUART_VCOM_RX_PORT          gpioPortA
#define SL_IOSTREAM_LEUART_VCOM_RX_PIN           0
