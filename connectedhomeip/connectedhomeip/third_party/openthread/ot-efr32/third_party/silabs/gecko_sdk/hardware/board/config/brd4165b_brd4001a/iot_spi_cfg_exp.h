...
#define IOT_SPI_CFG_EXP_TX_PIN                   6
#define IOT_SPI_CFG_EXP_TX_LOC                   11

// USART1 RX on PC7
#define IOT_SPI_CFG_EXP_RX_PORT                  gpioPortC
#define IOT_SPI_CFG_EXP_RX_PIN                   7
#define IOT_SPI_CFG_EXP_RX_LOC                   11

// USART1 CLK on PB11
#define IOT_SPI_CFG_EXP_CLK_PORT                 gpioPortB
#define IOT_SPI_CFG_EXP_CLK_PIN                  11
#define IOT_SPI_CFG_EXP_CLK_LOC                  4

// USART1 CS on PF7
#define IOT_SPI_CFG_EXP_CS_PORT                  gpioPortF
#define IOT_SPI_CFG_EXP_CS_PIN                   7
#define IOT_SPI_CFG_EXP_CS_LOC                   28
