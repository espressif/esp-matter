...
#define IOT_UART_CFG_EXP_PERIPHERAL              USART5
#define IOT_UART_CFG_EXP_PERIPHERAL_NO           5

// USART5 TX on PE8
#define IOT_UART_CFG_EXP_TX_PORT                 gpioPortE
#define IOT_UART_CFG_EXP_TX_PIN                  8
#define IOT_UART_CFG_EXP_TX_LOC                  0

// USART5 RX on PE9
#define IOT_UART_CFG_EXP_RX_PORT                 gpioPortE
#define IOT_UART_CFG_EXP_RX_PIN                  9
#define IOT_UART_CFG_EXP_RX_LOC                  0
