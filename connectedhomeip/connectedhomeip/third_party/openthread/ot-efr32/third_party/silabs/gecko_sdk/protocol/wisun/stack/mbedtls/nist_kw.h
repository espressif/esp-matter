...
/**
 * \brief           Initialize the specified key wrapping context
...
/**
 * \brief           Initialize the key wrapping context set in the
 *                  \p ctx parameter and set the encryption key.
 *
...
/**
 * \brief   Release and clear the specified key wrapping context
...
/**
 * \brief           Encrypt a buffer using key wrapping.
 *
...
/**
 * \brief           Decrypts a buffer using key wrapping.
 *
