...
#define SL_USART_SPINCP_TX_LOC                   11

// USART0 RX on PC7
#define SL_USART_SPINCP_RX_PORT                  gpioPortC
#define SL_USART_SPINCP_RX_PIN                   7
#define SL_USART_SPINCP_RX_LOC                   11

// USART0 CS on PF7
#define SL_USART_SPINCP_CS_PORT                  gpioPortF
#define SL_USART_SPINCP_CS_PIN                   7
#define SL_USART_SPINCP_CS_LOC                   28

// USART0 CLK on PB11
#define SL_USART_SPINCP_CLK_PORT                 gpioPortB
#define SL_USART_SPINCP_CLK_PIN                  11
