...
The [__SimpleLink CC2651P3 LaunchPad__][launchpad] contains a
[__CC2651P3F3RGZR__][device] device.
...
The [LP_CC2651P3.syscfg.json](../.meta/LP_CC2651P3.syscfg.json)
...
#### [__CC3200 Audio BoosterPack__][cc3200audboost]
  ...
  * Bend down the two pins below `DIO30`. Additionally bend down `DIO28-30`.
    ...
    Audio BoosterPack.
  * Attach the CC3200 Audio BoosterPack to the LP_CC2651P3
...
![CC3200 Audio BoosterPack Jumper Wire Diagram](images/cc3200audboost_cc26x1_jumpers_annotated.png)

[device]: http://www.ti.com/product/CC2651P3
[launchpad]: http://www.ti.com/tool/LP-CC2651P3
