...
/*! @name Driver version */
/*@{*/
/*! @brief FLEXSPI DMA driver version 2.0.0. */
...
typedef enum _flexspi_dma_ntransfer_size
{
    ...
    kFLEXPSI_DMAnSize8Bytes  = 0x8U,  /*!< Source/Destination data transfer size is 8 bytes every time */
    kFLEXPSI_DMAnSize32Bytes = 0x20U, /*!< Source/Destination data transfer size is 32 bytes every time */
