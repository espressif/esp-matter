/*******************************************************************************
* @file  rsi_ble_device_info_DEMO_57.h
* @brief 
*******************************************************************************
* # License
...
#ifndef SAPIS_EXAMPLES_RSI_DEMO_APPS_INC_RSI_BLE_DEVICE_INFO_COEX_MAX_APP_H
#define SAPIS_EXAMPLES_RSI_DEMO_APPS_INC_RSI_BLE_DEVICE_INFO_COEX_MAX_APP_H
...
#else
uint8_t rsi_get_ble_conn_id(uint8_t remote_dev_addr[RSI_REM_DEV_ADDR_LEN]);
uint8_t rsi_add_ble_conn_id(uint8_t remote_dev_addr[RSI_REM_DEV_ADDR_LEN]);
#endif
