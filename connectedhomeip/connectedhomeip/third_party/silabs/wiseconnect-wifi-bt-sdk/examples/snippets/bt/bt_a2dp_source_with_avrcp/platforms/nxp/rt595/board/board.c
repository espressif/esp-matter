...
void BOARD_SetFlexspiClock(FLEXSPI_Type *base, uint32_t src, uint32_t divider)
{
    if (base == FLEXSPI0)
    {
            ...
            (CLKCTL0->FLEXSPI0FCLKDIV & CLKCTL0_FLEXSPI0FCLKDIV_DIV_MASK) != (divider - 1))
        {
            ...
            CLKCTL0->PSCCTL0_CLR = CLKCTL0_PSCCTL0_CLR_FLEXSPI0_OTFAD_MASK;
            ...
            CLKCTL0->PSCCTL0_SET = CLKCTL0_PSCCTL0_CLR_FLEXSPI0_OTFAD_MASK;
    ...
    {
        if (CLKCTL0->FLEXSPI1FCLKSEL != CLKCTL0_FLEXSPI0FCLKSEL_SEL(src) ||
            (CLKCTL0->FLEXSPI1FCLKDIV & CLKCTL0_FLEXSPI1FCLKDIV_DIV_MASK) != (divider - 1))
        {
            ...
            base->MCR0 |= FLEXSPI_MCR0_MDIS_MASK;
            /* Disable clock before changing clock source */
            CLKCTL0->PSCCTL0_CLR = CLKCTL0_PSCCTL0_CLR_FLEXSPI1_MASK;
            /* Update flexspi clock. */
            CLKCTL0->FLEXSPI1FCLKSEL = CLKCTL0_FLEXSPI0FCLKSEL_SEL(src);
            ...
            /* Enable FLEXSPI clock again */
            CLKCTL0->PSCCTL0_SET = CLKCTL0_PSCCTL0_CLR_FLEXSPI1_MASK;
            /* Re-enable FLEXSPI module */
            base->MCR0 &= ~FLEXSPI_MCR0_MDIS_MASK;
...
{
    if ((((uint32_t)BOARD_FlexspiClockSafeConfig >= 0x08000000U) &&
         ((uint32_t)BOARD_FlexspiClockSafeConfig < 0x10000000U)) ||
        (((uint32_t)BOARD_FlexspiClockSafeConfig >= 0x18000000U) &&
         ((uint32_t)BOARD_FlexspiClockSafeConfig < 0x20000000U)))
    {
