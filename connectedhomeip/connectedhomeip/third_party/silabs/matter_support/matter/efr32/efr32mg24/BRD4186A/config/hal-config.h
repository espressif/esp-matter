...
// $[PRS]
#define PORTIO_PRS_ASYNCH4_PIN (6U)
#define PORTIO_PRS_ASYNCH4_PORT (gpioPortC)
...
#define BSP_SERIAL_APP_CTS_PIN (5U)
...
// $[USART0]
#define PORTIO_USART0_CTS_PIN (5U)
#define PORTIO_USART0_CTS_PORT (gpioPortB)

#define PORTIO_USART0_RTS_PIN (0U)
...
#define BSP_USART0_MOSI_PIN (1U)
#define BSP_USART0_MOSI_PORT (gpioPortC)

#define BSP_USART0_MISO_PIN (2U)
#define BSP_USART0_MISO_PORT (gpioPortC)

#define BSP_USART0_CLK_PIN (3U)
#define BSP_USART0_CLK_PORT gpioPortC)

#define BSP_USART0_CS_PIN (0U)
