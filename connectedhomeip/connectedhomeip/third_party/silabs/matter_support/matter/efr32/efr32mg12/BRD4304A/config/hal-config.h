...
#define BSP_PRS_CH5_PIN (10U)
#define BSP_PRS_CH5_PORT (gpioPortD)
#define BSP_PRS_CH5_LOC (0U)

#define BSP_PRS_FEM_RX_PIN (10U)
#define BSP_PRS_FEM_RX_PORT (gpioPortD)
#define BSP_PRS_FEM_RX_LOC (0U)

#define BSP_PRS_CH6_PIN (11U)
#define BSP_PRS_CH6_PORT (gpioPortD)
#define BSP_PRS_CH6_LOC (13U)

#define BSP_PRS_FEM_SLEEP_PIN (11U)
#define BSP_PRS_FEM_SLEEP_PORT (gpioPortD)
#define BSP_PRS_FEM_SLEEP_LOC (13U)
