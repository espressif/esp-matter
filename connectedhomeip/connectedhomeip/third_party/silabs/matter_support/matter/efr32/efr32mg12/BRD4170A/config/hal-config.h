...
#define PORTIO_USART3_RX_PIN (5U)
#define PORTIO_USART3_RX_PORT (gpioPortC)
#define PORTIO_USART3_RX_LOC (22U)

#define PORTIO_USART3_TX_PIN (4U)
#define PORTIO_USART3_TX_PORT (gpioPortC)
#define PORTIO_USART3_TX_LOC (22U)

#define BSP_USART3_TX_PIN (4U)
#define BSP_USART3_TX_PORT (gpioPortC)
#define BSP_USART3_TX_LOC (22U)

#define BSP_USART3_RX_PIN (5U)
#define BSP_USART3_RX_PORT (gpioPortC)
#define BSP_USART3_RX_LOC (22U)
