...
__attribute__((used)) uint8_t nvm3Storage[NVM3_DEFAULT_NVM_SIZE]
    __attribute__((section(__NVM3__)));
...
Ecode_t nvm3_deinitDefault(void) { return nvm3_close(nvm3_defaultHandle); }
