...
/// String for example
static uint8_t example_string[] = "SE Manager Tamper Example (TrustZone)";
...
static void issue_tamper_disable(void)
{
  ...
  printf("  + Use a tamper disable token to disable tamper signals... ");
  if (use_tamper_disable_token() == SL_STATUS_OK) {
