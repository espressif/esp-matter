...
class z_wave_HK_validation_testing(IProtocol):

    def get_model(self):
        mphy_config = multi_phy_configuration(part_family="nerio",
                                                 part_revision="A0",
                                                 desc="z_wave_HK_validation_testing",
                                                 rail_adapter_version="rail_api_2.x",
                                                 xsd_version=MultiPHYConfig.xsd_version(),
                                                 status_code=ModelDiffCodes.OK.value,
                                                 readable_name="Z-wave HK validation testing")

        base_channel_configuration = base_channel_configurationType(name="Z-Wave HK validation testing with 3 Channels", profile=None)
        phy_name = ""
        ...
        channel_config_entry = channel_config_entryType(name="PHY_ZWave_100kbps_916MHz_HK_ch0",
        ...
        channel_config_entry = channel_config_entryType(name="PHY_ZWave_40kbps_908MHz_HK_ch1",
        ...
        channel_config_entry = channel_config_entryType(name="PHY_ZWave_9p6kbps_908MHz_HK_ch2",
                                            phy_name_override="PHY_ZWave_9p6kbps_908MHz",
                                            base_frequency=919.82e6,
                                            channel_spacing=0,
