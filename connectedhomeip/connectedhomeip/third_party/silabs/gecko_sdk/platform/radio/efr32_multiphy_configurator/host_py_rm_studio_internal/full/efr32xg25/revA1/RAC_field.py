...
class RM_Field_RAC_SEQIF_RFTXPKD(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_SEQIF_RFTXPKD, self).__init__(register,
            'RFTXPKD', 'RAC.SEQIF.RFTXPKD', 'read-write',
            u"",
            31, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_SEQIEN_RFTXPKD(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_SEQIEN_RFTXPKD, self).__init__(register,
            'RFTXPKD', 'RAC.SEQIEN.RFTXPKD', 'read-write',
            u"",
            31, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_AUXADCCTRL1_AUXADCIN6SHIMEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_AUXADCCTRL1_AUXADCIN6SHIMEN, self).__init__(register,
            'AUXADCIN6SHIMEN', 'RAC.AUXADCCTRL1.AUXADCIN6SHIMEN', 'read-write',
            u"",
            13, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_AUXADCCTRL1_AUXADCIN8SHIMEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_AUXADCCTRL1_AUXADCIN8SHIMEN, self).__init__(register,
            'AUXADCIN8SHIMEN', 'RAC.AUXADCCTRL1.AUXADCIN8SHIMEN', 'read-write',
            u"",
            14, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_PATRIM1_TXTRIMHPAVMIDCURRENT(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_PATRIM1_TXTRIMHPAVMIDCURRENT, self).__init__(register,
            'TXTRIMHPAVMIDCURRENT', 'RAC.PATRIM1.TXTRIMHPAVMIDCURRENT', 'read-write',
            u"",
            22, 2)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_PATRIM3_TXTRIMRREGCN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_PATRIM3_TXTRIMRREGCN, self).__init__(register,
            'TXTRIMRREGCN', 'RAC.PATRIM3.TXTRIMRREGCN', 'read-write',
            u"",
            29, 2)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_PATRIM5_TXVCASRAIL(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_PATRIM5_TXVCASRAIL, self).__init__(register,
            'TXVCASRAIL', 'RAC.PATRIM5.TXVCASRAIL', 'read-write',
            u"",
            2, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_TXRAMP_TXBYPASSBBDIGREG(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_TXRAMP_TXBYPASSBBDIGREG, self).__init__(register,
            'TXBYPASSBBDIGREG', 'RAC.TXRAMP.TXBYPASSBBDIGREG', 'read-write',
            u"",
            11, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_TXRAMP_TXBYPASSBUFREG(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_TXRAMP_TXBYPASSBUFREG, self).__init__(register,
            'TXBYPASSBUFREG', 'RAC.TXRAMP.TXBYPASSBUFREG', 'read-write',
            u"",
            18, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_TXRAMP_TXSTARTUPITCCORE(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_TXRAMP_TXSTARTUPITCCORE, self).__init__(register,
            'TXSTARTUPITCCORE', 'RAC.TXRAMP.TXSTARTUPITCCORE', 'read-write',
            u"",
            19, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_RFPATHEN0_TXENFSKPA0(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_RFPATHEN0_TXENFSKPA0, self).__init__(register,
            'TXENFSKPA0', 'RAC.RFPATHEN0.TXENFSKPA0', 'read-write',
            u"",
            11, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_RFPATHEN0_TXENOFDMPA0(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_RFPATHEN0_TXENOFDMPA0, self).__init__(register,
            'TXENOFDMPA0', 'RAC.RFPATHEN0.TXENOFDMPA0', 'read-write',
            u"",
            12, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_RFPATHEN1_TXENFSKPA1(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_RFPATHEN1_TXENFSKPA1, self).__init__(register,
            'TXENFSKPA1', 'RAC.RFPATHEN1.TXENFSKPA1', 'read-write',
            u"",
            11, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_RFPATHEN1_TXENOFDMPA1(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_RFPATHEN1_TXENOFDMPA1, self).__init__(register,
            'TXENOFDMPA1', 'RAC.RFPATHEN1.TXENOFDMPA1', 'read-write',
            u"",
            12, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_RX_FEFILTOUTPUTSEL(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_RX_FEFILTOUTPUTSEL, self).__init__(register,
            'FEFILTOUTPUTSEL', 'RAC.RX.FEFILTOUTPUTSEL', 'read-write',
            u"",
            31, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_TX_TXENRFPKD0(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_TX_TXENRFPKD0, self).__init__(register,
            'TXENRFPKD0', 'RAC.TX.TXENRFPKD0', 'read-write',
            u"",
            14, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_TX_TXENRFPKD1(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_TX_TXENRFPKD1, self).__init__(register,
            'TXENRFPKD1', 'RAC.TX.TXENRFPKD1', 'read-write',
            u"",
            15, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_TX_TXENRREGBLEED(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_TX_TXENRREGBLEED, self).__init__(register,
            'TXENRREGBLEED', 'RAC.TX.TXENRREGBLEED', 'read-write',
            u"",
            16, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_TX_TXSWPENDACI(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_TX_TXSWPENDACI, self).__init__(register,
            'TXSWPENDACI', 'RAC.TX.TXSWPENDACI', 'read-write',
            u"",
            24, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_TX_TXSWPENDACQ(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_TX_TXSWPENDACQ, self).__init__(register,
            'TXSWPENDACQ', 'RAC.TX.TXSWPENDACQ', 'read-write',
            u"",
            25, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_TX_TXENITCDAC(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_TX_TXENITCDAC, self).__init__(register,
            'TXENITCDAC', 'RAC.TX.TXENITCDAC', 'read-write',
            u"",
            26, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_TX_TXENITCPA(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_TX_TXENITCPA, self).__init__(register,
            'TXENITCPA', 'RAC.TX.TXENITCPA', 'read-write',
            u"",
            27, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_TX_TXENITCCORE(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_TX_TXENITCCORE, self).__init__(register,
            'TXENITCCORE', 'RAC.TX.TXENITCCORE', 'read-write',
            u"",
            28, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_TXOGNDPKD_TXPKDOGNDATTEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_TXOGNDPKD_TXPKDOGNDATTEN, self).__init__(register,
            'TXPKDOGNDATTEN', 'RAC.TXOGNDPKD.TXPKDOGNDATTEN', 'read-write',
            u"",
            7, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_TXOGNDPKD_TXPKDOGNDCLKHIGH(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_TXOGNDPKD_TXPKDOGNDCLKHIGH, self).__init__(register,
            'TXPKDOGNDCLKHIGH', 'RAC.TXOGNDPKD.TXPKDOGNDCLKHIGH', 'read-write',
            u"",
            8, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_SPARE_SPARE0(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_SPARE_SPARE0, self).__init__(register,
            'SPARE0', 'RAC.SPARE.SPARE0', 'read-write',
            u"",
            20, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_GPPLLCLKRETIMECTRL_GPPLLCLKRETIMEENRETIME(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_GPPLLCLKRETIMECTRL_GPPLLCLKRETIMEENRETIME, self).__init__(register,
            'GPPLLCLKRETIMEENRETIME', 'RAC.GPPLLCLKRETIMECTRL.GPPLLCLKRETIMEENRETIME', 'read-write',
            u"",
            0, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_GPPLLCLKRETIMECTRL_GPPLLCLKRETIMEDISRETIME(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_GPPLLCLKRETIMECTRL_GPPLLCLKRETIMEDISRETIME, self).__init__(register,
            'GPPLLCLKRETIMEDISRETIME', 'RAC.GPPLLCLKRETIMECTRL.GPPLLCLKRETIMEDISRETIME', 'read-write',
            u"",
            1, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_GPPLLCLKRETIMECTRL_GPPLLCLKRETIMERESETN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_GPPLLCLKRETIMECTRL_GPPLLCLKRETIMERESETN, self).__init__(register,
            'GPPLLCLKRETIMERESETN', 'RAC.GPPLLCLKRETIMECTRL.GPPLLCLKRETIMERESETN', 'read-write',
            u"",
            2, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_GPPLLCLKRETIMECTRL_GPPLLCLKRETIMELIMITH(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_GPPLLCLKRETIMECTRL_GPPLLCLKRETIMELIMITH, self).__init__(register,
            'GPPLLCLKRETIMELIMITH', 'RAC.GPPLLCLKRETIMECTRL.GPPLLCLKRETIMELIMITH', 'read-write',
            u"",
            4, 3)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_GPPLLCLKRETIMECTRL_GPPLLCLKRETIMELIMITL(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_GPPLLCLKRETIMECTRL_GPPLLCLKRETIMELIMITL, self).__init__(register,
            'GPPLLCLKRETIMELIMITL', 'RAC.GPPLLCLKRETIMECTRL.GPPLLCLKRETIMELIMITL', 'read-write',
            u"",
            8, 3)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_GPPLLCLKRETIMESTATUS_GPPLLCLKRETIMECLKSEL(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_GPPLLCLKRETIMESTATUS_GPPLLCLKRETIMECLKSEL, self).__init__(register,
            'GPPLLCLKRETIMECLKSEL', 'RAC.GPPLLCLKRETIMESTATUS.GPPLLCLKRETIMECLKSEL', 'read-only',
            u"",
            0, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_GPPLLCLKRETIMESTATUS_GPPLLCLKRETIMERESETNLO(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_GPPLLCLKRETIMESTATUS_GPPLLCLKRETIMERESETNLO, self).__init__(register,
            'GPPLLCLKRETIMERESETNLO', 'RAC.GPPLLCLKRETIMESTATUS.GPPLLCLKRETIMERESETNLO', 'read-only',
            u"",
            1, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_PATRIM6_TXTRIMBBDIGREGIOUT(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_PATRIM6_TXTRIMBBDIGREGIOUT, self).__init__(register,
            'TXTRIMBBDIGREGIOUT', 'RAC.PATRIM6.TXTRIMBBDIGREGIOUT', 'read-write',
            u"",
            1, 2)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_PATRIM6_TXTRIMBIASNMAX(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_PATRIM6_TXTRIMBIASNMAX, self).__init__(register,
            'TXTRIMBIASNMAX', 'RAC.PATRIM6.TXTRIMBIASNMAX', 'read-write',
            u"",
            24, 4)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_PATRIM6_TXTRIMBIASPMAX(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_PATRIM6_TXTRIMBIASPMAX, self).__init__(register,
            'TXTRIMBIASPMAX', 'RAC.PATRIM6.TXTRIMBIASPMAX', 'read-write',
            u"",
            28, 4)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_PATRIM7_TXTRIMMIXINDSW(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_PATRIM7_TXTRIMMIXINDSW, self).__init__(register,
            'TXTRIMMIXINDSW', 'RAC.PATRIM7.TXTRIMMIXINDSW', 'read-write',
            u"",
            8, 3)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_PATRIM7_TXTRIMSHVDDREG(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_PATRIM7_TXTRIMSHVDDREG, self).__init__(register,
            'TXTRIMSHVDDREG', 'RAC.PATRIM7.TXTRIMSHVDDREG', 'read-write',
            u"",
            14, 2)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_PATRIM7_TXTRIMSHIBVCM(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_PATRIM7_TXTRIMSHIBVCM, self).__init__(register,
            'TXTRIMSHIBVCM', 'RAC.PATRIM7.TXTRIMSHIBVCM', 'read-write',
            u"",
            19, 3)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_PATRIM8_TXTRIMRFPKDVDDD(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_PATRIM8_TXTRIMRFPKDVDDD, self).__init__(register,
            'TXTRIMRFPKDVDDD', 'RAC.PATRIM8.TXTRIMRFPKDVDDD', 'read-write',
            u"",
            0, 2)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_PATRIM8_TXTRIMBUFBIAS(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_PATRIM8_TXTRIMBUFBIAS, self).__init__(register,
            'TXTRIMBUFBIAS', 'RAC.PATRIM8.TXTRIMBUFBIAS', 'read-write',
            u"",
            6, 4)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_PATRIM8_TXTRIMBUFSLICESN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_PATRIM8_TXTRIMBUFSLICESN, self).__init__(register,
            'TXTRIMBUFSLICESN', 'RAC.PATRIM8.TXTRIMBUFSLICESN', 'read-write',
            u"",
            10, 3)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_PATRIM8_TXTRIMBUFSLICESP(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_PATRIM8_TXTRIMBUFSLICESP, self).__init__(register,
            'TXTRIMBUFSLICESP', 'RAC.PATRIM8.TXTRIMBUFSLICESP', 'read-write',
            u"",
            13, 3)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_PATRIM8_TXTRIMBUFVMID(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_PATRIM8_TXTRIMBUFVMID, self).__init__(register,
            'TXTRIMBUFVMID', 'RAC.PATRIM8.TXTRIMBUFVMID', 'read-write',
            u"",
            16, 2)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_PATRIM8_TXTRIMBUFVREG(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_PATRIM8_TXTRIMBUFVREG, self).__init__(register,
            'TXTRIMBUFVREG', 'RAC.PATRIM8.TXTRIMBUFVREG', 'read-write',
            u"",
            18, 2)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_PATRIM9_TXTRIMDACSCALE(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_PATRIM9_TXTRIMDACSCALE, self).__init__(register,
            'TXTRIMDACSCALE', 'RAC.PATRIM9.TXTRIMDACSCALE', 'read-write',
            u"",
            1, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_PATRIM9_TXTRIMDACVDDD(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_PATRIM9_TXTRIMDACVDDD, self).__init__(register,
            'TXTRIMDACVDDD', 'RAC.PATRIM9.TXTRIMDACVDDD', 'read-write',
            u"",
            2, 2)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_PATRIM9_TXTRIMPASLICESN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_PATRIM9_TXTRIMPASLICESN, self).__init__(register,
            'TXTRIMPASLICESN', 'RAC.PATRIM9.TXTRIMPASLICESN', 'read-write',
            u"",
            16, 8)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_PATRIM9_TXTRIMPASLICESP(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_PATRIM9_TXTRIMPASLICESP, self).__init__(register,
            'TXTRIMPASLICESP', 'RAC.PATRIM9.TXTRIMPASLICESP', 'read-write',
            u"",
            24, 8)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_PATRIM10_TXTRIMPAMIRROR(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_PATRIM10_TXTRIMPAMIRROR, self).__init__(register,
            'TXTRIMPAMIRROR', 'RAC.PATRIM10.TXTRIMPAMIRROR', 'read-write',
            u"",
            0, 2)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_PATRIM10_TXTRIMPANBIAS(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_PATRIM10_TXTRIMPANBIAS, self).__init__(register,
            'TXTRIMPANBIAS', 'RAC.PATRIM10.TXTRIMPANBIAS', 'read-write',
            u"",
            2, 8)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_PATRIM10_TXTRIMPANCBIAS(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_PATRIM10_TXTRIMPANCBIAS, self).__init__(register,
            'TXTRIMPANCBIAS', 'RAC.PATRIM10.TXTRIMPANCBIAS', 'read-write',
            u"",
            10, 3)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_PATRIM10_TXTRIMPAPBIAS(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_PATRIM10_TXTRIMPAPBIAS, self).__init__(register,
            'TXTRIMPAPBIAS', 'RAC.PATRIM10.TXTRIMPAPBIAS', 'read-write',
            u"",
            16, 8)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_PATRIM10_TXTRIMPAPCBIAS(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_PATRIM10_TXTRIMPAPCBIAS, self).__init__(register,
            'TXTRIMPAPCBIAS', 'RAC.PATRIM10.TXTRIMPAPCBIAS', 'read-write',
            u"",
            24, 3)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_TXSTATUS_TXRFPKDOUT(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_TXSTATUS_TXRFPKDOUT, self).__init__(register,
            'TXRFPKDOUT', 'RAC.TXSTATUS.TXRFPKDOUT', 'read-only',
            u"",
            0, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_TXOFDM_TXENBBDIGREG(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_TXOFDM_TXENBBDIGREG, self).__init__(register,
            'TXENBBDIGREG', 'RAC.TXOFDM.TXENBBDIGREG', 'read-write',
            u"",
            0, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_TXOFDM_TXENBUF0(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_TXOFDM_TXENBUF0, self).__init__(register,
            'TXENBUF0', 'RAC.TXOFDM.TXENBUF0', 'read-write',
            u"",
            4, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_TXOFDM_TXENBUF1(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_TXOFDM_TXENBUF1, self).__init__(register,
            'TXENBUF1', 'RAC.TXOFDM.TXENBUF1', 'read-write',
            u"",
            5, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_TXOFDM_TXENBBDACI(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_TXOFDM_TXENBBDACI, self).__init__(register,
            'TXENBBDACI', 'RAC.TXOFDM.TXENBBDACI', 'read-write',
            u"",
            6, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_TXOFDM_TXENBBDACQ(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_TXOFDM_TXENBBDACQ, self).__init__(register,
            'TXENBBDACQ', 'RAC.TXOFDM.TXENBBDACQ', 'read-write',
            u"",
            7, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_TXOFDM_TXENBUFREG(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_TXOFDM_TXENBUFREG, self).__init__(register,
            'TXENBUFREG', 'RAC.TXOFDM.TXENBUFREG', 'read-write',
            u"",
            9, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_TXOFDM_TXENBUFREGBLEED(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_TXOFDM_TXENBUFREGBLEED, self).__init__(register,
            'TXENBUFREGBLEED', 'RAC.TXOFDM.TXENBUFREGBLEED', 'read-write',
            u"",
            10, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_TXOFDM_TXENSH(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_TXOFDM_TXENSH, self).__init__(register,
            'TXENSH', 'RAC.TXOFDM.TXENSH', 'read-write',
            u"",
            15, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_TXOFDM_TXENBBDATA(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_TXOFDM_TXENBBDATA, self).__init__(register,
            'TXENBBDATA', 'RAC.TXOFDM.TXENBBDATA', 'read-write',
            u"",
            20, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_TXOFDM_TXENPACMOS(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_TXOFDM_TXENPACMOS, self).__init__(register,
            'TXENPACMOS', 'RAC.TXOFDM.TXENPACMOS', 'read-write',
            u"",
            21, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_TXOFDM_TXENTXBIAS(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_TXOFDM_TXENTXBIAS, self).__init__(register,
            'TXENTXBIAS', 'RAC.TXOFDM.TXENTXBIAS', 'read-write',
            u"",
            23, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_TXOFDM_TXRESETSHCLKDIV(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_TXOFDM_TXRESETSHCLKDIV, self).__init__(register,
            'TXRESETSHCLKDIV', 'RAC.TXOFDM.TXRESETSHCLKDIV', 'read-write',
            u"",
            24, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_TXOFDM_TXSELPABIASMODE(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_TXOFDM_TXSELPABIASMODE, self).__init__(register,
            'TXSELPABIASMODE', 'RAC.TXOFDM.TXSELPABIASMODE', 'read-write',
            u"",
            25, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_TXMIX_TXSELMIXBAND(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_TXMIX_TXSELMIXBAND, self).__init__(register,
            'TXSELMIXBAND', 'RAC.TXMIX.TXSELMIXBAND', 'read-write',
            u"",
            17, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_TXMIX_TXSELMIXRDEG(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_TXMIX_TXSELMIXRDEG, self).__init__(register,
            'TXSELMIXRDEG', 'RAC.TXMIX.TXSELMIXRDEG', 'read-write',
            u"",
            18, 3)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_TXMIX_TXMIXCAPPULLDOWN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_TXMIX_TXMIXCAPPULLDOWN, self).__init__(register,
            'TXMIXCAPPULLDOWN', 'RAC.TXMIX.TXMIXCAPPULLDOWN', 'read-write',
            u"",
            21, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_TXMIX_TXSELSHCAPATTN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_TXMIX_TXSELSHCAPATTN, self).__init__(register,
            'TXSELSHCAPATTN', 'RAC.TXMIX.TXSELSHCAPATTN', 'read-write',
            u"",
            23, 3)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_TXMIX_TXSELSHCLKDIV(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_TXMIX_TXSELSHCLKDIV, self).__init__(register,
            'TXSELSHCLKDIV', 'RAC.TXMIX.TXSELSHCLKDIV', 'read-write',
            u"",
            26, 2)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_TXMIX_TXSELSHINBUFATTN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_TXMIX_TXSELSHINBUFATTN, self).__init__(register,
            'TXSELSHINBUFATTN', 'RAC.TXMIX.TXSELSHINBUFATTN', 'read-write',
            u"",
            28, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_TXITC_TXSELITCDAC(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_TXITC_TXSELITCDAC, self).__init__(register,
            'TXSELITCDAC', 'RAC.TXITC.TXSELITCDAC', 'read-write',
            u"",
            0, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_TXITC_TXSELITCPA(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_TXITC_TXSELITCPA, self).__init__(register,
            'TXSELITCPA', 'RAC.TXITC.TXSELITCPA', 'read-write',
            u"",
            1, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_TXITC_TXSELITCDACLEVEL(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_TXITC_TXSELITCDACLEVEL, self).__init__(register,
            'TXSELITCDACLEVEL', 'RAC.TXITC.TXSELITCDACLEVEL', 'read-write',
            u"",
            4, 2)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_TXITC_TXSELITCPALEVEL(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_TXITC_TXSELITCPALEVEL, self).__init__(register,
            'TXSELITCPALEVEL', 'RAC.TXITC.TXSELITCPALEVEL', 'read-write',
            u"",
            6, 2)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_TXCALITC_TXCALENITCDAC(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_TXCALITC_TXCALENITCDAC, self).__init__(register,
            'TXCALENITCDAC', 'RAC.TXCALITC.TXCALENITCDAC', 'read-write',
            u"",
            0, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_TXCALITC_TXCALENITCPA(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_TXCALITC_TXCALENITCPA, self).__init__(register,
            'TXCALENITCPA', 'RAC.TXCALITC.TXCALENITCPA', 'read-write',
            u"",
            1, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_TXCALITC_TXCALITCDACIB(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_TXCALITC_TXCALITCDACIB, self).__init__(register,
            'TXCALITCDACIB', 'RAC.TXCALITC.TXCALITCDACIB', 'read-write',
            u"",
            4, 5)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_TXCALITC_TXCALITCPAIB(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_TXCALITC_TXCALITCPAIB, self).__init__(register,
            'TXCALITCPAIB', 'RAC.TXCALITC.TXCALITCPAIB', 'read-write',
            u"",
            10, 5)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_TXCALITC_TXCALITCCOREIB(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_TXCALITC_TXCALITCCOREIB, self).__init__(register,
            'TXCALITCCOREIB', 'RAC.TXCALITC.TXCALITCCOREIB', 'read-write',
            u"",
            16, 4)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_TXCALITC_TXCALITCCORETC(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_TXCALITC_TXCALITCCORETC, self).__init__(register,
            'TXCALITCCORETC', 'RAC.TXCALITC.TXCALITCCORETC', 'read-write',
            u"",
            22, 5)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_SPACER_CLKMULTSPACER0(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_SPACER_CLKMULTSPACER0, self).__init__(register,
            'CLKMULTSPACER0', 'RAC.SPACER.CLKMULTSPACER0', 'read-write',
            u"",
            0, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_SPACER_RXSPACER2(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_SPACER_RXSPACER2, self).__init__(register,
            'RXSPACER2', 'RAC.SPACER.RXSPACER2', 'read-write',
            u"",
            5, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_TXPKDCTRL_TXPKDCLKDIV(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_TXPKDCTRL_TXPKDCLKDIV, self).__init__(register,
            'TXPKDCLKDIV', 'RAC.TXPKDCTRL.TXPKDCLKDIV', 'read-write',
            u"",
            0, 3)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_TXPKDCTRL_TXPKDCNTLEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_TXPKDCTRL_TXPKDCNTLEN, self).__init__(register,
            'TXPKDCNTLEN', 'RAC.TXPKDCTRL.TXPKDCNTLEN', 'read-write',
            u"",
            4, 13)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_TXPKDCMD_TXPKDSTART(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_TXPKDCMD_TXPKDSTART, self).__init__(register,
            'TXPKDSTART', 'RAC.TXPKDCMD.TXPKDSTART', 'write-only',
            u"",
            0, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_TXPKDCMD_TXPKDSTOP(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_TXPKDCMD_TXPKDSTOP, self).__init__(register,
            'TXPKDSTOP', 'RAC.TXPKDCMD.TXPKDSTOP', 'write-only',
            u"",
            1, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_TXPKDCMD_TXPKDCLR(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_TXPKDCMD_TXPKDCLR, self).__init__(register,
            'TXPKDCLR', 'RAC.TXPKDCMD.TXPKDCLR', 'write-only',
            u"",
            2, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_TXPKDSTATUS_TXPKDDONE(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_TXPKDSTATUS_TXPKDDONE, self).__init__(register,
            'TXPKDDONE', 'RAC.TXPKDSTATUS.TXPKDDONE', 'read-only',
            u"",
            0, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_TXPKDSTATUS_TXPKDCNT(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_TXPKDSTATUS_TXPKDCNT, self).__init__(register,
            'TXPKDCNT', 'RAC.TXPKDSTATUS.TXPKDCNT', 'read-only',
            u"",
            4, 13)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_SOFTMCTRL_FRCPATHEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_SOFTMCTRL_FRCPATHEN, self).__init__(register,
            'FRCPATHEN', 'RAC.SOFTMCTRL.FRCPATHEN', 'read-write',
            u"",
            2, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_SOFTMCTRL_TXMODSEL(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_SOFTMCTRL_TXMODSEL, self).__init__(register,
            'TXMODSEL', 'RAC.SOFTMCTRL.TXMODSEL', 'read-write',
            u"",
            5, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_SOFTMCTRL_ANTSELSRCSEL(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_SOFTMCTRL_ANTSELSRCSEL, self).__init__(register,
            'ANTSELSRCSEL', 'RAC.SOFTMCTRL.ANTSELSRCSEL', 'read-write',
            u"",
            6, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_SOFTMCTRL_FRCEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_SOFTMCTRL_FRCEN, self).__init__(register,
            'FRCEN', 'RAC.SOFTMCTRL.FRCEN', 'read-write',
            u"",
            7, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_SOFTMCTRL_DISLEGACYPATH(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_SOFTMCTRL_DISLEGACYPATH, self).__init__(register,
            'DISLEGACYPATH', 'RAC.SOFTMCTRL.DISLEGACYPATH', 'read-write',
            u"",
            8, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_SOFTMCTRL_TXDACDISABLECLK(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_SOFTMCTRL_TXDACDISABLECLK, self).__init__(register,
            'TXDACDISABLECLK', 'RAC.SOFTMCTRL.TXDACDISABLECLK', 'read-write',
            u"",
            10, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_SOFTMCTRL_TXDACINVERTCLK(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_SOFTMCTRL_TXDACINVERTCLK, self).__init__(register,
            'TXDACINVERTCLK', 'RAC.SOFTMCTRL.TXDACINVERTCLK', 'read-write',
            u"",
            11, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_RFLOCK0_TXIQENABLE(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_RFLOCK0_TXIQENABLE, self).__init__(register,
            'TXIQENABLE', 'RAC.RFLOCK0.TXIQENABLE', 'read-write',
            u"",
            13, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_RFLOCK0_FFTCORPRO(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_RFLOCK0_FFTCORPRO, self).__init__(register,
            'FFTCORPRO', 'RAC.RFLOCK0.FFTCORPRO', 'read-write',
            u"",
            14, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_RFLOCK0_OFDMMODE(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_RFLOCK0_OFDMMODE, self).__init__(register,
            'OFDMMODE', 'RAC.RFLOCK0.OFDMMODE', 'read-write',
            u"",
            15, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_RFLOCK0_RACTXENFSKPA(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_RFLOCK0_RACTXENFSKPA, self).__init__(register,
            'RACTXENFSKPA', 'RAC.RFLOCK0.RACTXENFSKPA', 'read-write',
            u"",
            17, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_RFLOCK0_RACTXENOFDMPA(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_RFLOCK0_RACTXENOFDMPA, self).__init__(register,
            'RACTXENOFDMPA', 'RAC.RFLOCK0.RACTXENOFDMPA', 'read-write',
            u"",
            18, 1)
        self.__dict__['zz_frozen'] = True
