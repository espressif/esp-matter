...
class RM_Field_AGC_CTRL0_DISRSSIANTDIVFIX(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_AGC_CTRL0_DISRSSIANTDIVFIX, self).__init__(register,
            'DISRSSIANTDIVFIX', 'AGC.CTRL0.DISRSSIANTDIVFIX', 'read-write',
            u"",
            24, 1)
        self.__dict__['zz_frozen'] = True
