...
class RM_Register_MODEM_CTRL6(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.IFADCDIGGAINCLKSEL = RM_Field_MODEM_CTRL6_IFADCDIGGAINCLKSEL(self)
        ...
        self.IFADCDIGGAIN = RM_Field_MODEM_CTRL6_IFADCDIGGAIN(self)
...
class RM_Register_MODEM_CHFCTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.CHFSWSEL = RM_Field_MODEM_CHFCTRL_CHFSWSEL(self)
...
class RM_Register_MODEM_ADQUAL8(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.ADBACORRTHR2 = RM_Field_MODEM_ADQUAL8_ADBACORRTHR2(self)
...
class RM_Register_MODEM_ADFSM21(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.ADAS = RM_Field_MODEM_ADFSM21_ADAS(self)
        self.zz_fdict['ADAS'] = self.ADAS
        self.ADBA = RM_Field_MODEM_ADFSM21_ADBA(self)
...
class RM_Register_MODEM_ADPC1(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MODEM_ADPC1, self).__init__(rmio, label,
            0xa8014000, 0x330,
            'ADPC1', 'MODEM.ADPC1', 'read-write',
            u"",
            0x01200040, 0xFFFF7FFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.ADPCEN = RM_Field_MODEM_ADPC1_ADPCEN(self)
        self.zz_fdict['ADPCEN'] = self.ADPCEN
        self.ADPCWNDSIZECHIP = RM_Field_MODEM_ADPC1_ADPCWNDSIZECHIP(self)
        self.zz_fdict['ADPCWNDSIZECHIP'] = self.ADPCWNDSIZECHIP
        self.ADPCCORROFFSETCHIP = RM_Field_MODEM_ADPC1_ADPCCORROFFSETCHIP(self)
        self.zz_fdict['ADPCCORROFFSETCHIP'] = self.ADPCCORROFFSETCHIP
        self.ADPCTIMINGBAUDS = RM_Field_MODEM_ADPC1_ADPCTIMINGBAUDS(self)
        self.zz_fdict['ADPCTIMINGBAUDS'] = self.ADPCTIMINGBAUDS
        self.ADPCWNDCNT = RM_Field_MODEM_ADPC1_ADPCWNDCNT(self)
        self.zz_fdict['ADPCWNDCNT'] = self.ADPCWNDCNT
        self.ADPCSKIPCHIPS = RM_Field_MODEM_ADPC1_ADPCSKIPCHIPS(self)
        self.zz_fdict['ADPCSKIPCHIPS'] = self.ADPCSKIPCHIPS
        self.__dict__['zz_frozen'] = True


class RM_Register_MODEM_ADPC2(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MODEM_ADPC2, self).__init__(rmio, label,
            0xa8014000, 0x334,
            'ADPC2', 'MODEM.ADPC2', 'read-write',
            u"",
            0x000000A0, 0x3FFFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.ADPCCORRSAMPLES = RM_Field_MODEM_ADPC2_ADPCCORRSAMPLES(self)
        self.zz_fdict['ADPCCORRSAMPLES'] = self.ADPCCORRSAMPLES
        self.ADPCPRETIMINGBAUDS = RM_Field_MODEM_ADPC2_ADPCPRETIMINGBAUDS(self)
        self.zz_fdict['ADPCPRETIMINGBAUDS'] = self.ADPCPRETIMINGBAUDS
        self.ADENCORR32 = RM_Field_MODEM_ADPC2_ADENCORR32(self)
        self.zz_fdict['ADENCORR32'] = self.ADENCORR32
        self.ADPCSIGAMPTHR = RM_Field_MODEM_ADPC2_ADPCSIGAMPTHR(self)
        self.zz_fdict['ADPCSIGAMPTHR'] = self.ADPCSIGAMPTHR
        self.ADPCWNDCNTRST = RM_Field_MODEM_ADPC2_ADPCWNDCNTRST(self)
        self.zz_fdict['ADPCWNDCNTRST'] = self.ADPCWNDCNTRST
        self.__dict__['zz_frozen'] = True


class RM_Register_MODEM_ADPC3(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MODEM_ADPC3, self).__init__(rmio, label,
            0xa8014000, 0x338,
            'ADPC3', 'MODEM.ADPC3', 'read-write',
            u"",
            0x01005008, 0x03FFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.ADBBSSEN = RM_Field_MODEM_ADPC3_ADBBSSEN(self)
        self.zz_fdict['ADBBSSEN'] = self.ADBBSSEN
        self.ADBBSSFILTLENGTH = RM_Field_MODEM_ADPC3_ADBBSSFILTLENGTH(self)
        self.zz_fdict['ADBBSSFILTLENGTH'] = self.ADBBSSFILTLENGTH
        self.ADBBSSAVGEN = RM_Field_MODEM_ADPC3_ADBBSSAVGEN(self)
        self.zz_fdict['ADBBSSAVGEN'] = self.ADBBSSAVGEN
        self.ADBBSSAVGPER = RM_Field_MODEM_ADPC3_ADBBSSAVGPER(self)
        self.zz_fdict['ADBBSSAVGPER'] = self.ADBBSSAVGPER
        self.ADBBSSAMPMANT = RM_Field_MODEM_ADPC3_ADBBSSAMPMANT(self)
        self.zz_fdict['ADBBSSAMPMANT'] = self.ADBBSSAMPMANT
        self.ADBBSSAMPEXP = RM_Field_MODEM_ADPC3_ADBBSSAMPEXP(self)
        self.zz_fdict['ADBBSSAMPEXP'] = self.ADBBSSAMPEXP
        self.ADBBSSAVGWAIT = RM_Field_MODEM_ADPC3_ADBBSSAVGWAIT(self)
        self.zz_fdict['ADBBSSAVGWAIT'] = self.ADBBSSAVGWAIT
        self.ADBBSSAVGFREEZE = RM_Field_MODEM_ADPC3_ADBBSSAVGFREEZE(self)
        self.zz_fdict['ADBBSSAVGFREEZE'] = self.ADBBSSAVGFREEZE
        self.ADBBSSSELWRDATA = RM_Field_MODEM_ADPC3_ADBBSSSELWRDATA(self)
        self.zz_fdict['ADBBSSSELWRDATA'] = self.ADBBSSSELWRDATA
        self.__dict__['zz_frozen'] = True


class RM_Register_MODEM_ADPC4(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MODEM_ADPC4, self).__init__(rmio, label,
            0xa8014000, 0x33C,
            'ADPC4', 'MODEM.ADPC4', 'read-write',
            u"",
            0x1F1F1F1F, 0x1F1F1F1F,
            0x00001000, 0x00002000,
            0x00003000)

        self.ADBBSSAMPLUT0 = RM_Field_MODEM_ADPC4_ADBBSSAMPLUT0(self)
        self.zz_fdict['ADBBSSAMPLUT0'] = self.ADBBSSAMPLUT0
        self.ADBBSSAMPLUT1 = RM_Field_MODEM_ADPC4_ADBBSSAMPLUT1(self)
        self.zz_fdict['ADBBSSAMPLUT1'] = self.ADBBSSAMPLUT1
        self.ADBBSSAMPLUT2 = RM_Field_MODEM_ADPC4_ADBBSSAMPLUT2(self)
        self.zz_fdict['ADBBSSAMPLUT2'] = self.ADBBSSAMPLUT2
        self.ADBBSSAMPLUT3 = RM_Field_MODEM_ADPC4_ADBBSSAMPLUT3(self)
        self.zz_fdict['ADBBSSAMPLUT3'] = self.ADBBSSAMPLUT3
        self.__dict__['zz_frozen'] = True


class RM_Register_MODEM_ADPC5(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MODEM_ADPC5, self).__init__(rmio, label,
            0xa8014000, 0x340,
            'ADPC5', 'MODEM.ADPC5', 'read-write',
            u"",
            0x1B1F1F1F, 0x1F1F1F1F,
            0x00001000, 0x00002000,
            0x00003000)

        self.ADBBSSAMPLUT4 = RM_Field_MODEM_ADPC5_ADBBSSAMPLUT4(self)
        self.zz_fdict['ADBBSSAMPLUT4'] = self.ADBBSSAMPLUT4
        self.ADBBSSAMPLUT5 = RM_Field_MODEM_ADPC5_ADBBSSAMPLUT5(self)
        self.zz_fdict['ADBBSSAMPLUT5'] = self.ADBBSSAMPLUT5
        self.ADBBSSAMPLUT6 = RM_Field_MODEM_ADPC5_ADBBSSAMPLUT6(self)
        self.zz_fdict['ADBBSSAMPLUT6'] = self.ADBBSSAMPLUT6
        self.ADBBSSAMPLUT7 = RM_Field_MODEM_ADPC5_ADBBSSAMPLUT7(self)
        self.zz_fdict['ADBBSSAMPLUT7'] = self.ADBBSSAMPLUT7
        self.__dict__['zz_frozen'] = True


class RM_Register_MODEM_ADPC6(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MODEM_ADPC6, self).__init__(rmio, label,
            0xa8014000, 0x344,
            'ADPC6', 'MODEM.ADPC6', 'read-write',
            u"",
            0x11131518, 0x1F1F1F1F,
            0x00001000, 0x00002000,
            0x00003000)

        self.ADBBSSAMPLUT8 = RM_Field_MODEM_ADPC6_ADBBSSAMPLUT8(self)
        self.zz_fdict['ADBBSSAMPLUT8'] = self.ADBBSSAMPLUT8
        self.ADBBSSAMPLUT9 = RM_Field_MODEM_ADPC6_ADBBSSAMPLUT9(self)
        self.zz_fdict['ADBBSSAMPLUT9'] = self.ADBBSSAMPLUT9
        self.ADBBSSAMPLUT10 = RM_Field_MODEM_ADPC6_ADBBSSAMPLUT10(self)
        self.zz_fdict['ADBBSSAMPLUT10'] = self.ADBBSSAMPLUT10
        self.ADBBSSAMPLUT11 = RM_Field_MODEM_ADPC6_ADBBSSAMPLUT11(self)
        self.zz_fdict['ADBBSSAMPLUT11'] = self.ADBBSSAMPLUT11
        self.__dict__['zz_frozen'] = True


class RM_Register_MODEM_ADPC7(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MODEM_ADPC7, self).__init__(rmio, label,
            0xa8014000, 0x348,
            'ADPC7', 'MODEM.ADPC7', 'read-write',
            u"",
            0x0C0D0E10, 0x1F1F1F1F,
            0x00001000, 0x00002000,
            0x00003000)

        self.ADBBSSAMPLUT12 = RM_Field_MODEM_ADPC7_ADBBSSAMPLUT12(self)
        self.zz_fdict['ADBBSSAMPLUT12'] = self.ADBBSSAMPLUT12
        self.ADBBSSAMPLUT13 = RM_Field_MODEM_ADPC7_ADBBSSAMPLUT13(self)
        self.zz_fdict['ADBBSSAMPLUT13'] = self.ADBBSSAMPLUT13
        self.ADBBSSAMPLUT14 = RM_Field_MODEM_ADPC7_ADBBSSAMPLUT14(self)
        self.zz_fdict['ADBBSSAMPLUT14'] = self.ADBBSSAMPLUT14
        self.ADBBSSAMPLUT15 = RM_Field_MODEM_ADPC7_ADBBSSAMPLUT15(self)
        self.zz_fdict['ADBBSSAMPLUT15'] = self.ADBBSSAMPLUT15
        self.__dict__['zz_frozen'] = True


class RM_Register_MODEM_ADPC8(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MODEM_ADPC8, self).__init__(rmio, label,
            0xa8014000, 0x34C,
            'ADPC8', 'MODEM.ADPC8', 'read-write',
            u"",
            0x2F87C145, 0xFFFFFF7F,
            0x00001000, 0x00002000,
            0x00003000)

        self.ADPCOSR = RM_Field_MODEM_ADPC8_ADPCOSR(self)
        self.zz_fdict['ADPCOSR'] = self.ADPCOSR
        self.ADPCANTSAMPOFFSET = RM_Field_MODEM_ADPC8_ADPCANTSAMPOFFSET(self)
        self.zz_fdict['ADPCANTSAMPOFFSET'] = self.ADPCANTSAMPOFFSET
        self.ADPCANTSAMPSWITCHWAIT = RM_Field_MODEM_ADPC8_ADPCANTSAMPSWITCHWAIT(self)
        self.zz_fdict['ADPCANTSAMPSWITCHWAIT'] = self.ADPCANTSAMPSWITCHWAIT
        self.ADPCANTSAMPBUF = RM_Field_MODEM_ADPC8_ADPCANTSAMPBUF(self)
        self.zz_fdict['ADPCANTSAMPBUF'] = self.ADPCANTSAMPBUF
        self.ADPCANTSAMPWRITE = RM_Field_MODEM_ADPC8_ADPCANTSAMPWRITE(self)
        self.zz_fdict['ADPCANTSAMPWRITE'] = self.ADPCANTSAMPWRITE
        self.ADPCANTSAMPSWITCH = RM_Field_MODEM_ADPC8_ADPCANTSAMPSWITCH(self)
        self.zz_fdict['ADPCANTSAMPSWITCH'] = self.ADPCANTSAMPSWITCH
        self.__dict__['zz_frozen'] = True


class RM_Register_MODEM_ADPC9(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MODEM_ADPC9, self).__init__(rmio, label,
            0xa8014000, 0x350,
            'ADPC9', 'MODEM.ADPC9', 'read-write',
            u"",
            0x00000000, 0x01FFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.ADBBSSAMPAVGLIM = RM_Field_MODEM_ADPC9_ADBBSSAMPAVGLIM(self)
        self.zz_fdict['ADBBSSAMPAVGLIM'] = self.ADBBSSAMPAVGLIM
        self.ADBBSSAMPTHR = RM_Field_MODEM_ADPC9_ADBBSSAMPTHR(self)
        self.zz_fdict['ADBBSSAMPTHR'] = self.ADBBSSAMPTHR
        self.ADBBSSSYNCEN = RM_Field_MODEM_ADPC9_ADBBSSSYNCEN(self)
        self.zz_fdict['ADBBSSSYNCEN'] = self.ADBBSSSYNCEN
        self.ADBBSSUPTHR = RM_Field_MODEM_ADPC9_ADBBSSUPTHR(self)
        self.zz_fdict['ADBBSSUPTHR'] = self.ADBBSSUPTHR
        self.ADBBSSDNTHR = RM_Field_MODEM_ADPC9_ADBBSSDNTHR(self)
        self.zz_fdict['ADBBSSDNTHR'] = self.ADBBSSDNTHR
        self.__dict__['zz_frozen'] = True


class RM_Register_MODEM_ADPC10(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MODEM_ADPC10, self).__init__(rmio, label,
            0xa8014000, 0x354,
            'ADPC10', 'MODEM.ADPC10', 'read-write',
            u"",
            0x00000000, 0x0001FFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.ADBBSSAMPJUMP = RM_Field_MODEM_ADPC10_ADBBSSAMPJUMP(self)
        self.zz_fdict['ADBBSSAMPJUMP'] = self.ADBBSSAMPJUMP
        self.ADBBSSCHANGEEN = RM_Field_MODEM_ADPC10_ADBBSSCHANGEEN(self)
        self.zz_fdict['ADBBSSCHANGEEN'] = self.ADBBSSCHANGEEN
        self.ADBBSSCHGUPTHR = RM_Field_MODEM_ADPC10_ADBBSSCHGUPTHR(self)
        self.zz_fdict['ADBBSSCHGUPTHR'] = self.ADBBSSCHGUPTHR
        self.ADBBSSCHGDNTHR = RM_Field_MODEM_ADPC10_ADBBSSCHGDNTHR(self)
...
class RM_Register_MODEM_SRC2NCOCTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MODEM_SRC2NCOCTRL, self).__init__(rmio, label,
            0xa8014000, 0x3E0,
            'SRC2NCOCTRL', 'MODEM.SRC2NCOCTRL', 'read-write',
            u"",
            0x00000000, 0x00007FFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.SRC2NCOEN = RM_Field_MODEM_SRC2NCOCTRL_SRC2NCOEN(self)
        self.zz_fdict['SRC2NCOEN'] = self.SRC2NCOEN
        self.PHASEPERCLK = RM_Field_MODEM_SRC2NCOCTRL_PHASEPERCLK(self)
