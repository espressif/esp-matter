...
class RM_Register_AGC_CTRL1(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.DISRSTONPREDET = RM_Field_AGC_CTRL1_DISRSTONPREDET(self)
        self.zz_fdict['DISRSTONPREDET'] = self.DISRSTONPREDET
        self.CFLOOPINCREQMODE = RM_Field_AGC_CTRL1_CFLOOPINCREQMODE(self)
...
class RM_Register_AGC_IF(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.PNATTEN = RM_Field_AGC_IF_PNATTEN(self)
        self.zz_fdict['PNATTEN'] = self.PNATTEN
        self.COLLDETRSSIMAPRE = RM_Field_AGC_IF_COLLDETRSSIMAPRE(self)
        self.zz_fdict['COLLDETRSSIMAPRE'] = self.COLLDETRSSIMAPRE
        self.COLLDETRSSIMASYNC = RM_Field_AGC_IF_COLLDETRSSIMASYNC(self)
...
class RM_Register_AGC_IEN(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.zz_fdict['GAINUPDATEFRZ'] = self.GAINUPDATEFRZ
        self.PNATTEN = RM_Field_AGC_IEN_PNATTEN(self)
        self.zz_fdict['PNATTEN'] = self.PNATTEN
        self.COLLDETRSSIMAPRE = RM_Field_AGC_IEN_COLLDETRSSIMAPRE(self)
        self.zz_fdict['COLLDETRSSIMAPRE'] = self.COLLDETRSSIMAPRE
        self.COLLDETRSSIMASYNC = RM_Field_AGC_IEN_COLLDETRSSIMASYNC(self)
        self.zz_fdict['COLLDETRSSIMASYNC'] = self.COLLDETRSSIMASYNC
        self.__dict__['zz_frozen'] = True
...
class RM_Register_AGC_SEQIF(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.zz_fdict['GAINUPDATEFRZ'] = self.GAINUPDATEFRZ
        self.PNATTEN = RM_Field_AGC_SEQIF_PNATTEN(self)
        self.zz_fdict['PNATTEN'] = self.PNATTEN
        self.COLLDETRSSIMAPRE = RM_Field_AGC_SEQIF_COLLDETRSSIMAPRE(self)
        self.zz_fdict['COLLDETRSSIMAPRE'] = self.COLLDETRSSIMAPRE
        self.COLLDETRSSIMASYNC = RM_Field_AGC_SEQIF_COLLDETRSSIMASYNC(self)
        self.zz_fdict['COLLDETRSSIMASYNC'] = self.COLLDETRSSIMASYNC
        self.__dict__['zz_frozen'] = True
...
class RM_Register_AGC_SEQIEN(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.zz_fdict['GAINUPDATEFRZ'] = self.GAINUPDATEFRZ
        self.PNATTEN = RM_Field_AGC_SEQIEN_PNATTEN(self)
        self.zz_fdict['PNATTEN'] = self.PNATTEN
        self.COLLDETRSSIMAPRE = RM_Field_AGC_SEQIEN_COLLDETRSSIMAPRE(self)
        self.zz_fdict['COLLDETRSSIMAPRE'] = self.COLLDETRSSIMAPRE
        self.COLLDETRSSIMASYNC = RM_Field_AGC_SEQIEN_COLLDETRSSIMASYNC(self)
        self.zz_fdict['COLLDETRSSIMASYNC'] = self.COLLDETRSSIMASYNC
        self.__dict__['zz_frozen'] = True
...
class RM_Register_AGC_FLARE(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_AGC_FLARE, self).__init__(rmio, label,
            0xa800c000, 0x0E0,
            'FLARE', 'AGC.FLARE', 'read-write',
            u"",
            0x00000004, 0x0000001F,
            0x00001000, 0x00002000,
            0x00003000)

        self.PNATTENTHD = RM_Field_AGC_FLARE_PNATTENTHD(self)
        self.zz_fdict['PNATTENTHD'] = self.PNATTENTHD
        self.__dict__['zz_frozen'] = True


class RM_Register_AGC_STEPDWNSAFE(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_AGC_STEPDWNSAFE, self).__init__(rmio, label,
            0xa800c000, 0x0E4,
            'STEPDWNSAFE', 'AGC.STEPDWNSAFE', 'read-write',
            u"",
            0x00036D11, 0x0007FFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.STEPDWNSAFE0 = RM_Field_AGC_STEPDWNSAFE_STEPDWNSAFE0(self)
        self.zz_fdict['STEPDWNSAFE0'] = self.STEPDWNSAFE0
        self.STEPDWNSAFE1 = RM_Field_AGC_STEPDWNSAFE_STEPDWNSAFE1(self)
        self.zz_fdict['STEPDWNSAFE1'] = self.STEPDWNSAFE1
        self.STEPDWNSAFE2 = RM_Field_AGC_STEPDWNSAFE_STEPDWNSAFE2(self)
        self.zz_fdict['STEPDWNSAFE2'] = self.STEPDWNSAFE2
        self.STEPDWNSAFE3 = RM_Field_AGC_STEPDWNSAFE_STEPDWNSAFE3(self)
        self.zz_fdict['STEPDWNSAFE3'] = self.STEPDWNSAFE3
        self.STEPDWNSAFE4 = RM_Field_AGC_STEPDWNSAFE_STEPDWNSAFE4(self)
        self.zz_fdict['STEPDWNSAFE4'] = self.STEPDWNSAFE4
        self.STEPDWNSAFE5 = RM_Field_AGC_STEPDWNSAFE_STEPDWNSAFE5(self)
        self.zz_fdict['STEPDWNSAFE5'] = self.STEPDWNSAFE5
        self.STEPDWNSAFEEN = RM_Field_AGC_STEPDWNSAFE_STEPDWNSAFEEN(self)
        self.zz_fdict['STEPDWNSAFEEN'] = self.STEPDWNSAFEEN
        self.__dict__['zz_frozen'] = True


class RM_Register_AGC_COLLDETCTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_AGC_COLLDETCTRL, self).__init__(rmio, label,
            0xa800c000, 0x100,
            'COLLDETCTRL', 'AGC.COLLDETCTRL', 'read-write',
            u"",
            0x00002800, 0x03007F8F,
            0x00001000, 0x00002000,
            0x00003000)

        self.UPONMARSSI = RM_Field_AGC_COLLDETCTRL_UPONMARSSI(self)
        self.zz_fdict['UPONMARSSI'] = self.UPONMARSSI
        self.INPUTSEL = RM_Field_AGC_COLLDETCTRL_INPUTSEL(self)
        self.zz_fdict['INPUTSEL'] = self.INPUTSEL
        self.RSSIINSEL = RM_Field_AGC_COLLDETCTRL_RSSIINSEL(self)
        self.zz_fdict['RSSIINSEL'] = self.RSSIINSEL
        self.OVRTHDSEL = RM_Field_AGC_COLLDETCTRL_OVRTHDSEL(self)
        self.zz_fdict['OVRTHDSEL'] = self.OVRTHDSEL
        self.MALATCHSEL = RM_Field_AGC_COLLDETCTRL_MALATCHSEL(self)
        self.zz_fdict['MALATCHSEL'] = self.MALATCHSEL
        self.MACOMPENSEL = RM_Field_AGC_COLLDETCTRL_MACOMPENSEL(self)
        self.zz_fdict['MACOMPENSEL'] = self.MACOMPENSEL
        self.MATAP = RM_Field_AGC_COLLDETCTRL_MATAP(self)
        self.zz_fdict['MATAP'] = self.MATAP
        self.FLTBYP = RM_Field_AGC_COLLDETCTRL_FLTBYP(self)
        self.zz_fdict['FLTBYP'] = self.FLTBYP
        self.LATCHRSSIEN = RM_Field_AGC_COLLDETCTRL_LATCHRSSIEN(self)
        self.zz_fdict['LATCHRSSIEN'] = self.LATCHRSSIEN
        self.LATCHRSSI = RM_Field_AGC_COLLDETCTRL_LATCHRSSI(self)
        self.zz_fdict['LATCHRSSI'] = self.LATCHRSSI
        self.__dict__['zz_frozen'] = True


class RM_Register_AGC_COLLDETTHD(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_AGC_COLLDETTHD, self).__init__(rmio, label,
            0xa800c000, 0x104,
            'COLLDETTHD', 'AGC.COLLDETTHD', 'read-write',
            u"",
            0x00281606, 0x07FDFF0F,
            0x00001000, 0x00002000,
            0x00003000)

        self.MATHRESHOLD = RM_Field_AGC_COLLDETTHD_MATHRESHOLD(self)
        self.zz_fdict['MATHRESHOLD'] = self.MATHRESHOLD
        self.MINTHRESHOLD = RM_Field_AGC_COLLDETTHD_MINTHRESHOLD(self)
        self.zz_fdict['MINTHRESHOLD'] = self.MINTHRESHOLD
        self.OVRTHRESHOLD = RM_Field_AGC_COLLDETTHD_OVRTHRESHOLD(self)
        self.zz_fdict['OVRTHRESHOLD'] = self.OVRTHRESHOLD
        self.__dict__['zz_frozen'] = True


class RM_Register_AGC_COLLDETSTATUS(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_AGC_COLLDETSTATUS, self).__init__(rmio, label,
            0xa800c000, 0x108,
            'COLLDETSTATUS', 'AGC.COLLDETSTATUS', 'read-only',
            u"",
            0x00000000, 0x000001FF,
            0x00001000, 0x00002000,
            0x00003000)

        self.MAFLTDOUT = RM_Field_AGC_COLLDETSTATUS_MAFLTDOUT(self)
        self.zz_fdict['MAFLTDOUT'] = self.MAFLTDOUT
        self.__dict__['zz_frozen'] = True


class RM_Register_AGC_SETTLINGINDCTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_AGC_SETTLINGINDCTRL, self).__init__(rmio, label,
            0xa800c000, 0x110,
            'SETTLINGINDCTRL', 'AGC.SETTLINGINDCTRL', 'read-write',
            u"",
            0x00010100, 0x003F3F01,
            0x00001000, 0x00002000,
            0x00003000)

        self.EN = RM_Field_AGC_SETTLINGINDCTRL_EN(self)
        self.zz_fdict['EN'] = self.EN
        self.POSTHD = RM_Field_AGC_SETTLINGINDCTRL_POSTHD(self)
        self.zz_fdict['POSTHD'] = self.POSTHD
        self.NEGTHD = RM_Field_AGC_SETTLINGINDCTRL_NEGTHD(self)
        self.zz_fdict['NEGTHD'] = self.NEGTHD
        self.__dict__['zz_frozen'] = True


class RM_Register_AGC_SETTLINGINDPER(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_AGC_SETTLINGINDPER, self).__init__(rmio, label,
            0xa800c000, 0x114,
            'SETTLINGINDPER', 'AGC.SETTLINGINDPER', 'read-write',
            u"",
            0x02000100, 0xFFFFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.SETTLEDPERIOD = RM_Field_AGC_SETTLINGINDPER_SETTLEDPERIOD(self)
        self.zz_fdict['SETTLEDPERIOD'] = self.SETTLEDPERIOD
        self.DELAYPERIOD = RM_Field_AGC_SETTLINGINDPER_DELAYPERIOD(self)
        self.zz_fdict['DELAYPERIOD'] = self.DELAYPERIOD
        self.__dict__['zz_frozen'] = True


class RM_Register_AGC_SMFIF(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_AGC_SMFIF, self).__init__(rmio, label,
            0xa800c000, 0x120,
            'SMFIF', 'AGC.SMFIF', 'read-write',
            u"",
            0x00000000, 0x0003FF7D,
            0x00001000, 0x00002000,
            0x00003000)

        self.RSSIVALIDSFMIF = RM_Field_AGC_SMFIF_RSSIVALIDSFMIF(self)
        self.zz_fdict['RSSIVALIDSFMIF'] = self.RSSIVALIDSFMIF
        self.CCASFMIF = RM_Field_AGC_SMFIF_CCASFMIF(self)
        self.zz_fdict['CCASFMIF'] = self.CCASFMIF
        self.RSSIPOSSTEPSFMIF = RM_Field_AGC_SMFIF_RSSIPOSSTEPSFMIF(self)
        self.zz_fdict['RSSIPOSSTEPSFMIF'] = self.RSSIPOSSTEPSFMIF
        self.RSSINEGSTEPSFMIF = RM_Field_AGC_SMFIF_RSSINEGSTEPSFMIF(self)
        self.zz_fdict['RSSINEGSTEPSFMIF'] = self.RSSINEGSTEPSFMIF
        self.RSSIDONESFMIF = RM_Field_AGC_SMFIF_RSSIDONESFMIF(self)
        self.zz_fdict['RSSIDONESFMIF'] = self.RSSIDONESFMIF
        self.SHORTRSSIPOSSTEPSFMIF = RM_Field_AGC_SMFIF_SHORTRSSIPOSSTEPSFMIF(self)
        self.zz_fdict['SHORTRSSIPOSSTEPSFMIF'] = self.SHORTRSSIPOSSTEPSFMIF
        self.RFPKDPRDDONESFMIF = RM_Field_AGC_SMFIF_RFPKDPRDDONESFMIF(self)
        self.zz_fdict['RFPKDPRDDONESFMIF'] = self.RFPKDPRDDONESFMIF
        self.RFPKDCNTDONESFMIF = RM_Field_AGC_SMFIF_RFPKDCNTDONESFMIF(self)
        self.zz_fdict['RFPKDCNTDONESFMIF'] = self.RFPKDCNTDONESFMIF
        self.RSSIHIGHSFMIF = RM_Field_AGC_SMFIF_RSSIHIGHSFMIF(self)
        self.zz_fdict['RSSIHIGHSFMIF'] = self.RSSIHIGHSFMIF
        self.RSSILOWSFMIF = RM_Field_AGC_SMFIF_RSSILOWSFMIF(self)
        self.zz_fdict['RSSILOWSFMIF'] = self.RSSILOWSFMIF
        self.CCANODETSFMIF = RM_Field_AGC_SMFIF_CCANODETSFMIF(self)
        self.zz_fdict['CCANODETSFMIF'] = self.CCANODETSFMIF
        self.GAINBELOWGAINTHDSFMIF = RM_Field_AGC_SMFIF_GAINBELOWGAINTHDSFMIF(self)
        self.zz_fdict['GAINBELOWGAINTHDSFMIF'] = self.GAINBELOWGAINTHDSFMIF
        self.GAINUPDATEFRZSFMIF = RM_Field_AGC_SMFIF_GAINUPDATEFRZSFMIF(self)
        self.zz_fdict['GAINUPDATEFRZSFMIF'] = self.GAINUPDATEFRZSFMIF
        self.PNATTENSFMIF = RM_Field_AGC_SMFIF_PNATTENSFMIF(self)
        self.zz_fdict['PNATTENSFMIF'] = self.PNATTENSFMIF
        self.COLLDETRSSIMAPRESFMIF = RM_Field_AGC_SMFIF_COLLDETRSSIMAPRESFMIF(self)
        self.zz_fdict['COLLDETRSSIMAPRESFMIF'] = self.COLLDETRSSIMAPRESFMIF
        self.COLLDETRSSIMASYNCSFMIF = RM_Field_AGC_SMFIF_COLLDETRSSIMASYNCSFMIF(self)
        self.zz_fdict['COLLDETRSSIMASYNCSFMIF'] = self.COLLDETRSSIMASYNCSFMIF
        self.__dict__['zz_frozen'] = True


class RM_Register_AGC_SFMIEN(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_AGC_SFMIEN, self).__init__(rmio, label,
            0xa800c000, 0x124,
            'SFMIEN', 'AGC.SFMIEN', 'read-write',
            u"",
            0x00000000, 0x0003FF7D,
            0x00001000, 0x00002000,
            0x00003000)

        self.RSSIVALIDSFMIEN = RM_Field_AGC_SFMIEN_RSSIVALIDSFMIEN(self)
        self.zz_fdict['RSSIVALIDSFMIEN'] = self.RSSIVALIDSFMIEN
        self.CCASFMIEN = RM_Field_AGC_SFMIEN_CCASFMIEN(self)
        self.zz_fdict['CCASFMIEN'] = self.CCASFMIEN
        self.RSSIPOSSTEPSFMIEN = RM_Field_AGC_SFMIEN_RSSIPOSSTEPSFMIEN(self)
        self.zz_fdict['RSSIPOSSTEPSFMIEN'] = self.RSSIPOSSTEPSFMIEN
        self.RSSINEGSTEPSFMIEN = RM_Field_AGC_SFMIEN_RSSINEGSTEPSFMIEN(self)
        self.zz_fdict['RSSINEGSTEPSFMIEN'] = self.RSSINEGSTEPSFMIEN
        self.RSSIDONESFMIEN = RM_Field_AGC_SFMIEN_RSSIDONESFMIEN(self)
        self.zz_fdict['RSSIDONESFMIEN'] = self.RSSIDONESFMIEN
        self.SHORTRSSIPOSSTEPSFMIEN = RM_Field_AGC_SFMIEN_SHORTRSSIPOSSTEPSFMIEN(self)
        self.zz_fdict['SHORTRSSIPOSSTEPSFMIEN'] = self.SHORTRSSIPOSSTEPSFMIEN
        self.RFPKDPRDDONESFMIEN = RM_Field_AGC_SFMIEN_RFPKDPRDDONESFMIEN(self)
        self.zz_fdict['RFPKDPRDDONESFMIEN'] = self.RFPKDPRDDONESFMIEN
        self.RFPKDCNTDONESFMIEN = RM_Field_AGC_SFMIEN_RFPKDCNTDONESFMIEN(self)
        self.zz_fdict['RFPKDCNTDONESFMIEN'] = self.RFPKDCNTDONESFMIEN
        self.RSSIHIGHSFMIEN = RM_Field_AGC_SFMIEN_RSSIHIGHSFMIEN(self)
        self.zz_fdict['RSSIHIGHSFMIEN'] = self.RSSIHIGHSFMIEN
        self.RSSILOWSFMIEN = RM_Field_AGC_SFMIEN_RSSILOWSFMIEN(self)
        self.zz_fdict['RSSILOWSFMIEN'] = self.RSSILOWSFMIEN
        self.CCANODETSFMIEN = RM_Field_AGC_SFMIEN_CCANODETSFMIEN(self)
        self.zz_fdict['CCANODETSFMIEN'] = self.CCANODETSFMIEN
        self.GAINBELOWGAINTHDSFMIEN = RM_Field_AGC_SFMIEN_GAINBELOWGAINTHDSFMIEN(self)
        self.zz_fdict['GAINBELOWGAINTHDSFMIEN'] = self.GAINBELOWGAINTHDSFMIEN
        self.GAINUPDATEFRZSFMIEN = RM_Field_AGC_SFMIEN_GAINUPDATEFRZSFMIEN(self)
        self.zz_fdict['GAINUPDATEFRZSFMIEN'] = self.GAINUPDATEFRZSFMIEN
        self.PNATTENSFMIEN = RM_Field_AGC_SFMIEN_PNATTENSFMIEN(self)
        self.zz_fdict['PNATTENSFMIEN'] = self.PNATTENSFMIEN
        self.COLLDETRSSIMAPRESFMIEN = RM_Field_AGC_SFMIEN_COLLDETRSSIMAPRESFMIEN(self)
        self.zz_fdict['COLLDETRSSIMAPRESFMIEN'] = self.COLLDETRSSIMAPRESFMIEN
        self.COLLDETRSSIMASYNCSFMIEN = RM_Field_AGC_SFMIEN_COLLDETRSSIMASYNCSFMIEN(self)
