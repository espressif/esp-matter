...
class RM_Register_MODEM_CTRL5(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.INTOSR = RM_Field_MODEM_CTRL5_INTOSR(self)
...
class RM_Register_MODEM_PHDMODANTDIV(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.SKIPTHDSEL = RM_Field_MODEM_PHDMODANTDIV_SKIPTHDSEL(self)
        self.zz_fdict['SKIPTHDSEL'] = self.SKIPTHDSEL
        self.RECHKCORREN = RM_Field_MODEM_PHDMODANTDIV_RECHKCORREN(self)
        ...
        self.ANTDECRSTBYP = RM_Field_MODEM_PHDMODANTDIV_ANTDECRSTBYP(self)
