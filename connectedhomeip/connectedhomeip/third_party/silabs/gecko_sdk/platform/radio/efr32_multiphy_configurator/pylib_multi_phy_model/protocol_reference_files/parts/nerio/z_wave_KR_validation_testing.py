...
class z_wave_KR_validation_testing(IProtocol):

    def get_model(self):
        mphy_config = multi_phy_configuration(part_family="nerio",
                                                 part_revision="A0",
                                                 desc="z_wave_KR_validation_testing",
                                                 rail_adapter_version="rail_api_2.x",
                                                 xsd_version=MultiPHYConfig.xsd_version(),
                                                 status_code=ModelDiffCodes.OK.value,
                                                 readable_name="Z-wave KR validation testing")

        base_channel_configuration = base_channel_configurationType(name="Z-Wave KR validation testing with 3 Channels", profile=None)
        phy_name = ""
        ...
        channel_config_entry = channel_config_entryType(name="PHY_ZWave_100kbps_916MHz_KR_ch0",
                                            phy_name_override="PHY_ZWave_100kbps_916MHz",
                                            base_frequency=920.9e6,
                                            channel_spacing=0,
        ...
        # input_override = overrideType("rx_ch_hopping_delay_usec", 250)
        # channel_config_entry.profile_input_overrides.add_override(input_override)
        input_override = overrideType("rx_ch_hopping_order_num", 0)
        channel_config_entry.profile_input_overrides.add_override(input_override)

        base_channel_configuration.channel_config_entries.add_channel_config_entry(channel_config_entry)

        channel_config_entry = channel_config_entryType(name="PHY_ZWave_100kbps_916MHz_KR_ch1",
                                            phy_name_override="PHY_ZWave_100kbps_916MHz",
                                            base_frequency=921.7e6,
                                            channel_spacing=0,
        ...
        # input_override = overrideType("rx_ch_hopping_delay_usec", 1000)
        # channel_config_entry.profile_input_overrides.add_override(input_override)
        input_override = overrideType("rx_ch_hopping_order_num", 1)
        channel_config_entry.profile_input_overrides.add_override(input_override)

        base_channel_configuration.channel_config_entries.add_channel_config_entry(channel_config_entry)


        channel_config_entry = channel_config_entryType(name="PHY_ZWave_100kbps_916MHz_KR_ch2",
                                            phy_name_override="PHY_ZWave_100kbps_916MHz",
                                            base_frequency=923.1e6,
                                            channel_spacing=0,
        ...
        # input_override = overrideType("rx_ch_hopping_delay_usec", 250)
        # channel_config_entry.profile_input_overrides.add_override(input_override)
        input_override = overrideType("rx_ch_hopping_order_num", 2)
        channel_config_entry.profile_input_overrides.add_override(input_override)
