...
__all__ = ['IllegalArgumentException', 'Properties']
...
class Properties(object):
    ...
    def _isFileType(self, arg):
        if self._isPy3():
            return type(arg) is io.TextIOWrapper
        else:
            return type(arg) is file  
    ...
    def load(self, stream):
        ...
        if not self._isFileType(stream):
