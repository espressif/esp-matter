...
// <i> Default: 256
#define SL_SIMPLE_RGB_PWM_LED_LED_RESOLUTION     100
...
#define SL_SIMPLE_RGB_PWM_LED_LED_RED_PORT       gpioPortB
#define SL_SIMPLE_RGB_PWM_LED_LED_RED_PIN        4

#define SL_SIMPLE_RGB_PWM_LED_LED_GREEN_CHANNEL  1
#define SL_SIMPLE_RGB_PWM_LED_LED_GREEN_PORT     gpioPortB
#define SL_SIMPLE_RGB_PWM_LED_LED_GREEN_PIN      5

#define SL_SIMPLE_RGB_PWM_LED_LED_BLUE_CHANNEL   2
#define SL_SIMPLE_RGB_PWM_LED_LED_BLUE_PORT      gpioPortB
#define SL_SIMPLE_RGB_PWM_LED_LED_BLUE_PIN       6
// [TIMER_SL_SIMPLE_RGB_PWM_LED_LED]$
