...
// Prototypes
void emAfPluginGasProxyFunctionCliSimulateGbzMsg(sl_cli_command_arg_t *arguments);
void emAfPluginGasProxyFunctionCliPrintSupportedUseCases(sl_cli_command_arg_t *arguments);
...
void emAfPluginGasProxyFunctionCliSimulateGbzMsgCreation(sl_cli_command_arg_t *arguments)
{
...
void emAfPluginGasProxyFunctionCliSimulateFutureDatedMsg(sl_cli_command_arg_t *arguments)
{
...
void emAfPluginGasProxyFunctionCliSimulateGbzMsg(sl_cli_command_arg_t *arguments)
{
  ...
  if (index >= GBCS_NUM_USE_CASES) {
    ...
    emAfPluginGasProxyFunctionCliPrintSupportedUseCases(arguments);
    return;
  }
