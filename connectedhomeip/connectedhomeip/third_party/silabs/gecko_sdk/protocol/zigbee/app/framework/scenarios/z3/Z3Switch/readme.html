...
<div id='write'  class=''><h1><a name="z3---sample-apps" class="md-header-anchor"></a><span>Zigbee 3.0 Gateway, Light and Switch</span></h1>
<p><span>
...
1. Z3Gateway, the gateway can form a centralized network, and the light and the switch can join the centralized network by performing network steering.
2. Z3Light, acting as a router, can form a distributed network, and the Z3Switch, acting as an end device, can join the distributed network.
3. Z3Light, acting as a Touchlink target, can Touchlink with the switch, acting as a Touchlink initiator.
