...
#define BOARD_LED_PORT            gpioPortB       /**< LED port                         */
#define BOARD_LED0_PORT           gpioPortB       /**< Red LED port                     */
#define BOARD_LED0_PIN            0               /**< Red LED pin                      */

#define BOARD_IMU_ENABLE_PORT       gpioPortB     /**< IMU enable port                  */
#define BOARD_IMU_ENABLE_PIN        4             /**< IMU enable pin                   */
#define BOARD_IMU_INT_PORT          gpioPortB     /**< IMU interrupt port               */
#define BOARD_IMU_INT_PIN           3             /**< IMU interrupt pin                */
...
#define BOARD_MIC_ENABLE_PORT       gpioPortA     /**< Microphone enable port           */
#define BOARD_MIC_ENABLE_PIN        0             /**< Microphone enable pin            */
#define BOARD_MIC_PDM_DATA_PORT     gpioPortC     /**< Microphone PDM data port         */
#define BOARD_MIC_PDM_DATA_PIN      7             /**< Microphone PDM data pin          */
#define BOARD_MIC_PDM_CLK_PORT      gpioPortC     /**< Microphone PDM clock port        */
#define BOARD_MIC_PDM_CLK_PIN       6             /**< Microphone PDM clock pin         */

#define BOARD_SENSOR_ENABLE_PORT       gpioPortA     /**< Environmental sensor enable port    */
#define BOARD_SENSOR_ENABLE_PIN        4             /**< Environmental sensor enable pin     */
...
#define BOARD_BUTTON0_PIN          1               /**< Left pushbutton pin              */
