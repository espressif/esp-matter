...
#define BSP_EXTFLASH_MISO_PIN                         (9U)
#define BSP_EXTFLASH_MISO_PORT                        (gpioPortC)
#define BSP_EXTFLASH_MISO_LOC                         (13U)
#define BSP_EXTFLASH_MOSI_PIN                         (5U)
#define BSP_EXTFLASH_MOSI_PORT                        (gpioPortF)
#define BSP_EXTFLASH_MOSI_LOC                         (29U)
#define BSP_EXTFLASH_CLK_PIN                          (4U)
#define BSP_EXTFLASH_CLK_PORT                         (gpioPortF)
#define BSP_EXTFLASH_CLK_LOC                          (26U)
#define BSP_EXTFLASH_CS_PIN                           (8U)
#define BSP_EXTFLASH_CS_PORT                          (gpioPortC)
#define BSP_EXTFLASH_WP_PIN                           (6U)
#define BSP_EXTFLASH_WP_PORT                          (gpioPortF)
#define BSP_EXTFLASH_HOLD_PIN                         (5U)
