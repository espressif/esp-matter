...
// $[PTI]
#define PORTIO_PTI_DFRAME_PIN                (3U)
#define PORTIO_PTI_DFRAME_PORT               (gpioPortD

#define PORTIO_PTI_DOUT_PIN                  (2U)
#define PORTIO_PTI_DOUT_PORT                 (gpioPortD)

#define BSP_PTI_DFRAME_PIN                   (3U)
#define BSP_PTI_DFRAME_PORT                  (gpioPortD)

#define BSP_PTI_DOUT_PIN                     (2U)
...
#define BSP_UARTNCP_CTS_PIN                  (7U)
#define BSP_UARTNCP_CTS_PORT                 (gpioPortA)

#define BSP_UARTNCP_RTS_PIN                  (8U)
...
// $[USART1]
#define PORTIO_USART1_CTS_PIN                (7U)
#define PORTIO_USART1_CTS_PORT               (gpioPortA)

#define PORTIO_USART1_RTS_PIN                (8U)
...
#define BSP_USART1_CTS_PIN                   (7U)
#define BSP_USART1_CTS_PORT                  (gpioPortA)

#define BSP_USART1_RTS_PIN                   (8U)
