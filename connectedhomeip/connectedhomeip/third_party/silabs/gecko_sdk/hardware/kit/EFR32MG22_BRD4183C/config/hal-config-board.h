...
#define BSP_CLK_HFXO_CTUNE                   (112)
#define BSP_CLK_LFXO_PRESENT                 (1)
#define BSP_CLK_LFXO_INIT                     CMU_LFXOINIT_DEFAULT
#define BSP_CLK_LFXO_FREQ                    (32768U)
#define BSP_CLK_LFXO_CTUNE                   (38U)
// [CMU]$
...
#define PORTIO_USART0_CS_PIN                 (2U)
...
#define BSP_USART0_MOSI_PORT                 (gpioPortB)

#define BSP_USART0_MISO_PIN                  (1U)
#define BSP_USART0_MISO_PORT                 (gpioPortB)

#define BSP_USART0_CLK_PIN                   (2U)
#define BSP_USART0_CLK_PORT                  (gpioPortB)

#define BSP_USART0_CS_PIN                    (2U)
#define BSP_USART0_CS_PORT                   (gpioPortC)

// [USART0]$

// $[USART1]
#define PORTIO_USART1_CTS_PIN                (4U)
