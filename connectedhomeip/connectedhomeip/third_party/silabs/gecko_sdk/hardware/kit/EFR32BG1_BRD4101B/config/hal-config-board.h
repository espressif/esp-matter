...
#define BSP_EXTFLASH_MOSI_PORT                        (gpioPortA)
#define BSP_EXTFLASH_MOSI_LOC                         (0U)

#define BSP_EXTFLASH_MISO_PIN                         (1U)
#define BSP_EXTFLASH_MISO_PORT                        (gpioPortA)
#define BSP_EXTFLASH_MISO_LOC                         (0U)

#define BSP_EXTFLASH_CLK_PIN                          (11U)
#define BSP_EXTFLASH_CLK_PORT                         (gpioPortB)
#define BSP_EXTFLASH_CLK_LOC                          (4U)
...
#define BSP_SERIAL_APP_RTS_PIN                        (6U)
#define BSP_SERIAL_APP_RTS_PORT                       (gpioPortC)
#define BSP_SERIAL_APP_RTS_LOC                        (6U)
...
#define BSP_UARTNCP_CTS_PIN                           (11U)
#define BSP_UARTNCP_CTS_PORT                          (gpioPortB)
#define BSP_UARTNCP_CTS_LOC                           (2U)

#define BSP_UARTNCP_RTS_PIN                           (6U)
#define BSP_UARTNCP_RTS_PORT                          (gpioPortC)
#define BSP_UARTNCP_RTS_LOC                           (6U)

// [UARTNCP]$

// $[USART0]
#define PORTIO_USART0_CLK_PIN                         (11U)
#define PORTIO_USART0_CLK_PORT                        (gpioPortB)
#define PORTIO_USART0_CLK_LOC                         (4U)

#define PORTIO_USART0_CS_PIN                          (6U)
#define PORTIO_USART0_CS_PORT                         (gpioPortC)
#define PORTIO_USART0_CS_LOC                          (8U)

#define PORTIO_USART0_CTS_PIN                         (11U)
#define PORTIO_USART0_CTS_PORT                        (gpioPortB)
#define PORTIO_USART0_CTS_LOC                         (2U)

#define PORTIO_USART0_RTS_PIN                         (6U)
#define PORTIO_USART0_RTS_PORT                        (gpioPortC)
#define PORTIO_USART0_RTS_LOC                         (6U)
...
#define BSP_USART0_RTS_PIN                            (6U)
#define BSP_USART0_RTS_PORT                           (gpioPortC)
#define BSP_USART0_RTS_LOC                            (6U)
