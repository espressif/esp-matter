...
#define IOT_PWM_CFG_LED0_PERIPHERAL              TIMER3
#define IOT_PWM_CFG_LED0_PERIPHERAL_NO           3



// TIMER3 CC2 on PE2
#define IOT_PWM_CFG_LED0_CC2_PORT                gpioPortE
#define IOT_PWM_CFG_LED0_CC2_PIN                 2
#define IOT_PWM_CFG_LED0_ROUTE_LOC               1
