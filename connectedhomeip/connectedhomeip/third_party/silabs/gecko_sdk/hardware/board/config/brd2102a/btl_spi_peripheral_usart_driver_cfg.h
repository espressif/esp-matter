...
#define SL_USART_SPINCP_TX_LOC                   2

// USART0 RX on PC10
#define SL_USART_SPINCP_RX_PORT                  gpioPortC
#define SL_USART_SPINCP_RX_PIN                   10
#define SL_USART_SPINCP_RX_LOC                   2

// USART0 CS on PC8
#define SL_USART_SPINCP_CS_PORT                  gpioPortC
#define SL_USART_SPINCP_CS_PIN                   8
#define SL_USART_SPINCP_CS_LOC                   2

// USART0 CLK on PA12
#define SL_USART_SPINCP_CLK_PORT                 gpioPortA
#define SL_USART_SPINCP_CLK_PIN                  12
#define SL_USART_SPINCP_CLK_LOC                  5
