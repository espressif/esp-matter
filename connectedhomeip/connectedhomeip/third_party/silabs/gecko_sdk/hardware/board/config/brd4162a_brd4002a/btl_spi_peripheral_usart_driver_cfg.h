...
#define SL_USART_SPINCP_TX_PIN                   6
#define SL_USART_SPINCP_TX_LOC                   1

// USART2 RX on PA7
#define SL_USART_SPINCP_RX_PORT                  gpioPortA
#define SL_USART_SPINCP_RX_PIN                   7
#define SL_USART_SPINCP_RX_LOC                   1
...
#define SL_USART_SPINCP_CLK_PIN                  8
#define SL_USART_SPINCP_CLK_LOC                  1
