...
#define SL_NCP_SPIDRV_USART_PERIPHERAL           USART3
#define SL_NCP_SPIDRV_USART_PERIPHERAL_NO        3

// USART3 TX on PA0
#define SL_NCP_SPIDRV_USART_TX_PORT              gpioPortA
#define SL_NCP_SPIDRV_USART_TX_PIN               0
#define SL_NCP_SPIDRV_USART_TX_LOC               0

// USART3 RX on PA1
#define SL_NCP_SPIDRV_USART_RX_PORT              gpioPortA
#define SL_NCP_SPIDRV_USART_RX_PIN               1
#define SL_NCP_SPIDRV_USART_RX_LOC               0

// USART3 CLK on PA2
#define SL_NCP_SPIDRV_USART_CLK_PORT             gpioPortA
#define SL_NCP_SPIDRV_USART_CLK_PIN              2
#define SL_NCP_SPIDRV_USART_CLK_LOC              0

// USART3 CS on PA3
#define SL_NCP_SPIDRV_USART_CS_PORT              gpioPortA
