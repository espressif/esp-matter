...
#define SL_IOSTREAM_LEUART_EXP_TX_PIN            8
#define SL_IOSTREAM_LEUART_EXP_TX_LOC            13

// LEUART0 RX on PC9
#define SL_IOSTREAM_LEUART_EXP_RX_PORT           gpioPortC
#define SL_IOSTREAM_LEUART_EXP_RX_PIN            9
#define SL_IOSTREAM_LEUART_EXP_RX_LOC            13
