...
// <o SL_IOSTREAM_LEUART_EXP_FLOW_CONTROL_TYPE> Flow control
// <uartFlowControlNone=> None
// <uartFlowControlSoftware=> Software Flow control (XON/XOFF)
// <i> Default: uartFlowControlNone
#define SL_IOSTREAM_LEUART_EXP_FLOW_CONTROL_TYPE     uartFlowControlNone
...
// LEUART0 TX on PF3
#define SL_IOSTREAM_LEUART_EXP_TX_PORT           gpioPortF
#define SL_IOSTREAM_LEUART_EXP_TX_PIN            3
#define SL_IOSTREAM_LEUART_EXP_TX_LOC            27

// LEUART0 RX on PF4
#define SL_IOSTREAM_LEUART_EXP_RX_PORT           gpioPortF
#define SL_IOSTREAM_LEUART_EXP_RX_PIN            4
#define SL_IOSTREAM_LEUART_EXP_RX_LOC            27
