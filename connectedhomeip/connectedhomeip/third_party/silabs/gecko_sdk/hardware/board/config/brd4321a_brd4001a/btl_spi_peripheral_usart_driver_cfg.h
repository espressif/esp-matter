...
#define SL_USART_SPINCP_PERIPHERAL               USART3
#define SL_USART_SPINCP_PERIPHERAL_NO            3

// USART3 TX on PA0
#define SL_USART_SPINCP_TX_PORT                  gpioPortA
#define SL_USART_SPINCP_TX_PIN                   0
#define SL_USART_SPINCP_TX_LOC                   0

// USART3 RX on PA1
#define SL_USART_SPINCP_RX_PORT                  gpioPortA
...
#define SL_USART_SPINCP_CS_LOC                   0

// USART3 CLK on PA2
#define SL_USART_SPINCP_CLK_PORT                 gpioPortA
#define SL_USART_SPINCP_CLK_PIN                  2
#define SL_USART_SPINCP_CLK_LOC                  0
