...
// USART0 TX on PF3
#define IOT_UART_CFG_EXP_TX_PORT                 gpioPortF
#define IOT_UART_CFG_EXP_TX_PIN                  3
#define IOT_UART_CFG_EXP_TX_LOC                  27

// USART0 RX on PF4
#define IOT_UART_CFG_EXP_RX_PORT                 gpioPortF
#define IOT_UART_CFG_EXP_RX_PIN                  4
#define IOT_UART_CFG_EXP_RX_LOC                  27
