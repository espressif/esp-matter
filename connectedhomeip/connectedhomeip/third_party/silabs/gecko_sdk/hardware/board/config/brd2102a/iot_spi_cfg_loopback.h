...
#define IOT_SPI_CFG_LOOPBACK_TX_LOC              2

// USART0 RX on PC10
#define IOT_SPI_CFG_LOOPBACK_RX_PORT             gpioPortC
#define IOT_SPI_CFG_LOOPBACK_RX_PIN              10
#define IOT_SPI_CFG_LOOPBACK_RX_LOC              2

// USART0 CLK on PA12
#define IOT_SPI_CFG_LOOPBACK_CLK_PORT            gpioPortA
#define IOT_SPI_CFG_LOOPBACK_CLK_PIN             12
#define IOT_SPI_CFG_LOOPBACK_CLK_LOC             5

// USART0 CS on PC8
#define IOT_SPI_CFG_LOOPBACK_CS_PORT             gpioPortC
#define IOT_SPI_CFG_LOOPBACK_CS_PIN              8
#define IOT_SPI_CFG_LOOPBACK_CS_LOC              2
