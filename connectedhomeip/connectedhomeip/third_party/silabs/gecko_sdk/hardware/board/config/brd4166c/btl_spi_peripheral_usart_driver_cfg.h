...
// USART2 TX on PK0
#define SL_USART_SPINCP_TX_PORT                  gpioPortK
#define SL_USART_SPINCP_TX_PIN                   0
#define SL_USART_SPINCP_TX_LOC                   29

// USART2 RX on PK2
#define SL_USART_SPINCP_RX_PORT                  gpioPortK
#define SL_USART_SPINCP_RX_PIN                   2
#define SL_USART_SPINCP_RX_LOC                   30

// USART2 CS on PA5
#define SL_USART_SPINCP_CS_PORT                  gpioPortA
#define SL_USART_SPINCP_CS_PIN                   5
#define SL_USART_SPINCP_CS_LOC                   29

// USART2 CLK on PF7
#define SL_USART_SPINCP_CLK_PORT                 gpioPortF
#define SL_USART_SPINCP_CLK_PIN                  7
#define SL_USART_SPINCP_CLK_LOC                  18
