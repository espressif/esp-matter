  ...
  {                                                                            \
    ...
    {0x00000000, ZAP_TYPE(ARRAY), 0, ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE),     \
     ZAP_EMPTY_DEFAULT()}, /* device list */                                   \
        ...
        {0x00000001, ZAP_TYPE(INT16U), 2, 0,                                   \
        ...
        {0x00000005, ZAP_TYPE(FABRIC_IDX), 1, 0,                               \
...
#define ZAP_GENERATED_COMMANDS_INDEX(index)                                    \
  ((chip::CommandId *)(&generatedCommands[index]))
