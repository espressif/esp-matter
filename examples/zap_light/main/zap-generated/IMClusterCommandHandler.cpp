...
void DispatchServerCommand(CommandHandler *apCommandObj,
  ...
  // CHIP_END_OF_TLV When TLVError is CHIP_END_OF_TLV, it means we have iterated
  // all of the items, which is not a real error. Any error value TLVUnpackError
  // means we have received an illegal value. The following variables are used
  // for all commands to save code size.
...
void DispatchServerCommand(CommandHandler *apCommandObj,
  ...
  bool wasHandled = false;
  {
    ...
    case Commands::ReorderNetwork::Id: {
      ...
      TLVError = DataModel::Decode(aDataTlv, commandData);
      if (TLVError == CHIP_NO_ERROR) {
        wasHandled = emberAfNetworkCommissioningClusterReorderNetworkCallback(
            apCommandObj, aCommandPath, commandData);
      }
      break;
    }
...
void DispatchClientCommand(CommandSender *apCommandObj,
                           const ConcreteCommandPath &aCommandPath,
                           TLV::TLVReader &aDataTlv) {
  // We are using TLVUnpackError and TLVError here since both of them can be
  // CHIP_END_OF_TLV When TLVError is CHIP_END_OF_TLV, it means we have iterated
  ...
  bool wasHandled = false;
  {
    ...
    case Commands::ApplyUpdateResponse::Id: {
      ...
      while ((TLVError = aDataTlv.Next()) == CHIP_NO_ERROR) {
        // Since call to aDataTlv.Next() is CHIP_NO_ERROR, the read head always
        // points to an element. Skip this element if it is not a ContextTag,
        // not consider it as an error if other values are valid.
        ...
        if (currentDecodeTagId < 2) {
          if (argExists[currentDecodeTagId]) {
            ChipLogProgress(Zcl, "Duplicate TLV tag %" PRIx32,
                            TLV::TagNumFromTag(aDataTlv.GetTag()));
      ...
      if (CHIP_END_OF_TLV == TLVError) {
        // CHIP_END_OF_TLV means we have iterated all items in the structure,
        // which is not a real error.
        TLVError = CHIP_NO_ERROR;
      }

      if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError &&
          2 == validArgumentCount) {
        wasHandled =
            emberAfOtaSoftwareUpdateProviderClusterApplyUpdateResponseCallback(
                aCommandPath.mEndpointId, apCommandObj, action,
                delayedActionTime);
      }
      break;
    }
    case Commands::QueryImageResponse::Id: {
      ...
      if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError &&
          8 == validArgumentCount) {
        wasHandled =
            emberAfOtaSoftwareUpdateProviderClusterQueryImageResponseCallback(
                aCommandPath.mEndpointId, apCommandObj, status,
                delayedActionTime, imageURI, softwareVersion,
                softwareVersionString, updateToken, userConsentNeeded,
  ...
  if (CHIP_NO_ERROR != TLVError || CHIP_NO_ERROR != TLVUnpackError ||
      expectArgumentCount != validArgumentCount || !wasHandled) {
    ChipLogProgress(Zcl,
                    "Failed to dispatch command, %" PRIu32 "/%" PRIu32
                    " arguments parsed, TLVError=%" CHIP_ERROR_FORMAT
                    ", UnpackError=%" CHIP_ERROR_FORMAT
                    " (last decoded tag = %" PRIu32,
                    validArgumentCount, expectArgumentCount, TLVError.Format(),
                    TLVUnpackError.Format(), currentDecodeTagId);
...
void DispatchSingleClusterCommand(const ConcreteCommandPath &aCommandPath,
  ...
  case Clusters::ColorControl::Id:
    Clusters::ColorControl::DispatchServerCommand(apCommandObj, aCommandPath,
                                                  aReader);
    break;
  ...
  case Clusters::Groups::Id:
    Clusters::Groups::DispatchServerCommand(apCommandObj, aCommandPath,
                                            aReader);
    break;
  ...
  case Clusters::NetworkCommissioning::Id:
    Clusters::NetworkCommissioning::DispatchServerCommand(
        apCommandObj, aCommandPath, aReader);
    break;
  ...
  case Clusters::Scenes::Id:
    Clusters::Scenes::DispatchServerCommand(apCommandObj, aCommandPath,
                                            aReader);
    break;
  default:
...
void DispatchSingleClusterResponseCommand(
    const ConcreteCommandPath &aCommandPath, TLV::TLVReader &aReader,
  ...
  case Clusters::OtaSoftwareUpdateProvider::Id:
    Clusters::OtaSoftwareUpdateProvider::DispatchClientCommand(
        apCommandObj, aCommandPath, aReader);
    break;
  default:
    ChipLogError(Zcl, "Unknown cluster " ChipLogFormatMEI,
