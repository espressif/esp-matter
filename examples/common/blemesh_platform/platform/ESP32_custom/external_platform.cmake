...
if((NOT CONFIG_OPENTHREAD_ENABLED) OR (NOT CONFIG_ENABLE_MATTER_OVER_THREAD))
    list(APPEND EXPLANT_EXCLUDE_SRCS_LIST "${CMAKE_CURRENT_LIST_DIR}/OpenthreadLauncher.cpp"
                                          "${CMAKE_CURRENT_LIST_DIR}/OpenthreadLauncher_LwIP.cpp"
                                          "${CMAKE_CURRENT_LIST_DIR}/OpenthreadLauncher_NoLwIP.cpp"
                                          "${CMAKE_CURRENT_LIST_DIR}/ThreadStackManagerImpl.cpp")
elseif(CONFIG_CHIP_USE_OT_ENDPOINT)
    list(APPEND EXPLANT_EXCLUDE_SRCS_LIST "${CMAKE_CURRENT_LIST_DIR}/OpenthreadLauncher_LwIP.cpp")
else()
    list(APPEND EXPLANT_EXCLUDE_SRCS_LIST "${CMAKE_CURRENT_LIST_DIR}/OpenthreadLauncher_NoLwIP.cpp")
endif()

if(CONFIG_CHIP_USE_OT_ENDPOINT)
    list(APPEND EXPLANT_EXCLUDE_SRCS_LIST
        "${CMAKE_CURRENT_LIST_DIR}/DiagnosticDataProviderImpl_LwIP.cpp"
        "${CMAKE_CURRENT_LIST_DIR}/ESP32Utils_LwIP.cpp"
        "${CMAKE_CURRENT_LIST_DIR}/PlatformManagerImpl_LwIP.cpp")
else()
    list(APPEND EXPLANT_EXCLUDE_SRCS_LIST
        "${CMAKE_CURRENT_LIST_DIR}/DiagnosticDataProviderImpl_OT.cpp"
        "${CMAKE_CURRENT_LIST_DIR}/ESP32Utils_NoLwIP.cpp"
        "${CMAKE_CURRENT_LIST_DIR}/PlatformManagerImpl_NoLwIP.cpp")
endif()
...
if(NOT CONFIG_ENABLE_ESP32_DEVICE_INFO_PROVIDER)
    list(APPEND EXPLANT_EXCLUDE_SRCS_LIST "${CMAKE_CURRENT_LIST_DIR}/ESP32DeviceInfoProvider.cpp"
                                          "${CMAKE_CURRENT_LIST_DIR}/StaticESP32DeviceInfoProvider.cpp")
endif()

if(NOT CONFIG_SEC_CERT_DAC_PROVIDER)
    list(APPEND EXPLANT_EXCLUDE_SRCS_LIST "${CMAKE_CURRENT_LIST_DIR}/ESP32SecureCertDataProvider.cpp"
                                          "${CMAKE_CURRENT_LIST_DIR}/ESP32SecureCertDACProvider.cpp")
endif()
...
if(CONFIG_CHIP_MEM_ALLOC_MODE_INTERNAL)
    list(APPEND EXPLANT_EXCLUDE_SRCS_LIST "${CMAKE_CURRENT_LIST_DIR}/src/platform/ESP32/CHIPMem-PlatformExternal.cpp"
                                          "${CMAKE_CURRENT_LIST_DIR}/src/platform/ESP32/CHIPMem-PlatformDefault.cpp")
elseif(CONFIG_CHIP_MEM_ALLOC_MODE_EXTERNAL)
    list(APPEND EXPLANT_EXCLUDE_SRCS_LIST "${CMAKE_CURRENT_LIST_DIR}/src/platform/ESP32/CHIPMem-PlatformInternal.cpp"
                                          "${CMAKE_CURRENT_LIST_DIR}/src/platform/ESP32/CHIPMem-PlatformDefault.cpp")
